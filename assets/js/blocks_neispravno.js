...
if (document.querySelector(".gallery")) {
  ...
  galleryWrap.forEach((elem) => {
    let tabBtn = elem.querySelectorAll(".tab__btn");
    let tabSliders = elem.querySelectorAll(".gallery__slider");
    tabBtn.forEach((elem, index) => {
      elem.addEventListener("click", () => {
        tabBtn.forEach((elem) => {
          elem.classList.remove("active");
        });
        tabSliders.forEach((elem) => {
          elem.classList.remove("active");
        });
        elem.classList.add("active");
  ...
  galleryItems.forEach((elem) => {
    elem.addEventListener("click", () => {
      ...
      galleryBigImg.src = elem.querySelector("img").src;
    });
  });

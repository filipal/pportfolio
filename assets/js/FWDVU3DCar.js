(function(e) {
    var t = function() {
        ...
        o.init = function() {
            o.setupScreen(),
            e.onerror = o.showError,
            o.screen.style.zIndex = 100000009,
            setTimeout(o.addConsoleToDom, 100),
            setInterval(o.position, 100)
        }
        ,
        o.position = function() {
            var e = FWDVU3DCarUtils.getScrollOffsets();
            o.setX(e.x),
            o.setY(e.y)
        }
        ,
        ...
        o.setupScreen = function() {
            o.main_do = new FWDVU3DCarDO("div","absolute"),
        ...
        o.showError = function(e, t, r) {
            ...
            o.main_do.setInnerHTML(s),
            o.main_do.screen.scrollTop = o.main_do.screen.scrollHeight
        }
        ,
        o.log = function(e) {
            var t = o.main_do.getInnerHTML() + "<br>" + e;
            o.main_do.setInnerHTML(t),
            o.main_do.getScreen().scrollTop = 1e4
        }
        ,
        o.init()
    };
    t.setPrototype = function() {
        t.prototype = new FWDVU3DCarDO("div","absolute")
    }
    ,
    t.prototype = null,
    e.FWDConsole = t
...
function(t) {
    var o = function(e) {
        ...
        r.isMobile = FWDVU3DCarUtils.isMobile,
        ...
        r.init = function() {
            return (FWDVU3DCarUtils.checkIfHasTransofrms(),
            FWDTweenLite.ticker.useRAF(!0),
            r.props = e,
            !r.props) ? void alert("Ultimate 3D Carousel properties object is undefined!") : (r.instName = r.props.instanceName,
            !r.instName) ? void alert("Ultimate 3D Carousel instance name is required in the settings parameters!") : (t[r.instName] = r,
            !r.props.displayType) ? void alert("Display type is not specified!") : (r.displayType = e.displayType.toLowerCase(),
            r.body = document.getElementsByTagName("body")[0],
            !r.props.carouselHolderDivId) ? void alert("Property carouselHolderDivId is not defined in the Ultimate 3D Carousel object settings!") : FWDVU3DCarUtils.getChildById(r.props.carouselHolderDivId) ? r.props.carouselHeight ? (r.stageContainer = FWDVU3DCarUtils.getChildById(r.props.carouselHolderDivId),
            r.originalHeight = r.props.carouselHeight,
            r.carouselYRadius = r.props.carouselYRadius || 0,
            r.carouselOffsetWidth = r.props.carouselOffsetWidth || 0,
            r.carouselOffsetHeight = r.props.carouselOffsetHeight || 0,
            ...
            r.originalWidth = r.thumbWidth + 2 * r.carouselOffsetWidth,
            r.preloaderBackgroundColor = r.props.preloaderBackgroundColor || "#000000",
            r.preloaderFillColor = r.props.preloaderFillColor || "#FFFFFF",
            r.rootElement = FWDVU3DCarUtils.getChildById(r.props.carouselDataListDivId),
            !r.rootElement) ? void alert("Please make sure that the div with the id " + r.props.carouselDataListDivId + " exists, this represents the carousel categories markup.") : (r.dataListAr = FWDVU3DCarUtils.getChildrenFromAttribute(r.rootElement, "data-cat"),
            r.dataListAr ? void (r.totalDataLists = r.dataListAr.length,
            ...
            r.setupMainDO(),
            r.initializeOnlyWhenVisible_bl ? (t.addEventListener("scroll", r.onInitlalizeScrollHandler),
            setTimeout(r.onInitlalizeScrollHandler, 200)) : r.setupCarousel()) : void alert("At least one datalist ul tag with the attribute <font color='#FF0000'>data-cat</font> must be defined.")) : void alert("The carousel width is not defined, plese make sure that the carouselHeight property is definded in the Ultimate 3D Carousel settings!") : void alert("Ultimate 3D Carousel holder div is not found, please make sure that the div exists and the id is correct! " + r.props.carouselHolderDivId)
        }
        ,
        r.onInitlalizeScrollHandler = function() {
            ...
            r.pageXOffset = e.x,
            r.pageYOffset = e.y,
            r.ws = r.vwSize = FWDVU3DCarUtils.getViewportSize(),
            r.stageContainer.getBoundingClientRect().top < r.ws.h && (t.removeEventListener("scroll", r.onInitlalizeScrollHandler),
            r.setupCarousel())
        }
        ,
        ...
        r.setupMainDO = function() {
            if (r.mainDO = new FWDVU3DCarDO("div","relative"),
            r.stageHeight = 100,
            r.mainDO.screen.className = "fwdvu3dcar",
            r.isMobile || r.mainDO.setSelectable(!1),
            r.mainDO.hasT3D = !1,
            r.mainDO.hasT2D = !1,
            r.bkImage) {
                r.bkDO = new FWDVU3DCarDO("div"),
            ...
            r.displayType == o.FLUID_WIDTH ? (r.mainDO.style().position = "absolute",
            document.body.appendChild(r.mainDO.screen),
            r.props.zIndex && (r.mainDO.screen.style.zIndex = r.props.zIndex),
            r.mainDO.screen.id = r.props.carouselHolderDivId + "-fluidwidth") : r.stageContainer.appendChild(r.mainDO.screen)
        }
        ,
        r.getCaptionHeight = function() {
            var e;
            if (r.captionH = 0,
            r.textDO || (r.textDO = new FWDVU3DCarDO("div"),
            r.textDO.style().width = "100%",
            r.textDO.setVisible(!1),
            r.textDO.setX(-1e4),
            r.textDO.screen.className = "fwdvu3dcar-caption out",
            r.mainDO.addChild(r.textDO)),
            r.thumbsManagerDO)
                r.curDataListAr = r.thumbsManagerDO.curDataListAr,
                e = r.thumbsManagerDO.curId;
            else {
                if (r.curDataListAr = r._d.dataListAr[r.startAtCategory],
                r.totalThumbs = r.curDataListAr.length,
                r.startPos = r._d.carouselStartPosition,
                "number" == typeof r.startPos)
            ...
            r.curDataListAr[e] && r.curDataListAr[e].thumbText && (r.caption = r.curDataListAr[e].thumbText,
            r.textDO.setInnerHTML(r.caption),
            r.captionH = r.textDO.getHeight() - 5)
        }
        ,
        r.setupInfo = function() {
            FWDVU3DCarInfo.setPrototype(),
            r.infoDO = new FWDVU3DCarInfo(r,r.warningIconPath_str)
        }
        ,
        ...
        r.startResizeHandler = function() {
            ...
            r.displayType == o.FLUID_WIDTH && (r.ctY = Math.round(r.stageContainer.getBoundingClientRect().top + r.pageYOffset),
            r.mainDO.setY(r.ctY),
            setTimeout(function() {
        ...
        r.stopResizeHandler = function() {
            t.removeEventListener("resize", r.onResizeHandler),
            t.removeEventListener("scroll", r.onScrollHandler),
            t.removeEventListener("orientationchange", r.orientationChange)
        }
        ,
        ...
        r.onScrollHandler = function() {
            r.displayType == o.FLUID_WIDTH && r.scrollHandler(),
            r.rect = r.mainDO.screen.getBoundingClientRect()
        }
        ,
        r.orientationChange = function() {
            r.displayType == o.FLUID_WIDTH && (r.orientationChangeComplete = !1,
        ...
        r.scrollHandler = function() {
            if (r.orientationChangeComplete) {
                ...
                r.pageXOffset = e.x,
                r.pageYOffset = e.y,
                r.displayType == o.FLUID_WIDTH && (r.isMobile ? (clearTimeout(r.scrollEndId),
                r.scrollEndId = setTimeout(r.resizeHandler, 200)) : r.mainDO.setX(r.pageXOffset),
        ...
        r.resizeHandler = function(e) {
            if (r.orientationChangeComplete) {
                var t = FWDVU3DCarUtils.getScrollOffsets()
                  , s = r.vwSize = FWDVU3DCarUtils.getViewportSize();
                r.ws = s,
                r.dW = 0,
                r.dH = 0,
                ...
                r.displayType == o.FLUID_WIDTH ? (r.stageWidth = s.w,
                ...
                r.stageHeight = Math.round(r.scale * r.originalHeight) + 2 * r.carouselOffsetHeight,
                r.stageContainer.style.height = r.stageHeight + "px",
                r.scrollHandler()) : r.displayType == o.RESPONSIVE && (r.stageContainer.style.width = "100%",
                r.stageWidth = r.stageContainer.offsetWidth,
                r.stageWidth > r.originalWidth && (r.stageWidth = r.originalWidth,
                ...
                r.rect = r.mainDO.screen.getBoundingClientRect(),
                r.positionPreloader(),
                r.thumbsManagerDO && (r.thumbsManagerDO.resizeHandler(e),
                !r.thumbsManagerDO.allowToSwitchCat && (r.disableDO.setWidth(r.stageWidth),
        ...
        r.setupData = function() {
            ...
            r._d = new FWDVU3DCarData(r.props,r),
            r._d.addListener(FWDVU3DCarData.PRELOADER_LOAD_DONE, r.onPreloaderLoadDone),
            r._d.addListener(FWDVU3DCarData.LOAD_ERROR, r.dataLoadError),
            r._d.addListener(FWDVU3DCarData.LOAD_DONE, r.dataLoadComplete),
        ...
        r.dataLoadComplete = function() {
            r._d.showDisplay2DAlways && (FWDVU3DCarUtils.hasTransform3d = !1),
        ...
        r.setupPreloader = function() {
            ...
            r.preloaderDO = new FWDVU3DCarPreloader(r,"center",10,r.preloaderBackgroundColor,r.preloaderFillColor,3,.8),
        ...
        r.positionPreloader = function() {
            if (r.preloaderDO) {
                ...
                r.thumbsManagerDO && (e = Math.round(r.thumbsManagerDO.centerThumbX + (r.thumbsManagerDO.centerThumbW - r.preloaderDO.w) / 2),
        ...
        r.setupThumbsManager = function() {
            ...
            r.thumbsManagerDO = new FWDVU3DCarThumbsManager(r._d,r),
            r.thumbsManagerDO.addListener(FWDVU3DCarThumbsManager.THUMB_CLICK, r.onThumbsManagerThumbClick),
            r.thumbsManagerDO.addListener(FWDVU3DCarThumbsManager.LOAD_ERROR, r.onThumbsManagerLoadError),
            r.thumbsManagerDO.addListener(FWDVU3DCarThumbsManager.THUMBS_INTRO_FINISH, r.onThumbsManagerIntroFinish),
            r.thumbsManagerDO.addListener(FWDVU3DCarThumbsManager.THUMB_CHANGE, r.onThumbsManagerThumbChange),
        ...
        r.onThumbsManagerThumbClick = function(o) {
            if (r.rl) {
                var e = "fwdvu3dcar" + o.playlistId + "_";
                t[e] = r._d.lightboxAr[o.playlistId],
                r.rl.show(e, o.thumbId)
            }
        }
        ,
        ...
        r.onThumbsManagerIntroFinish = function() {
            ...
            r.apiReady = !0,
            r.apiReadyFirstTime || (r.apiReadyFirstTime = !0,
            r.dispatchEvent(o.IS_API_READY)),
            r.dispatchEvent(o.CATEGORY_CHANGE, {
                id: r.thumbsManagerDO.dataListId
            })
        }
        ,
        r.onThumbsManagerThumbChange = function(t) {
            r.dispatchEvent(o.THUMB_CHANGE, {
                id: t.id
            })
        }
        ,
        ...
        r.setupMenu = function() {
            ...
            r.menuDO.addListener(FWDVU3DCarMenu.BUTTON_PRESSED, r.onComboboxButtonPressHandler),
            r.mainDO.addChild(r.menuDO)
        }
        ,
        r.onComboboxButtonPressHandler = function(t) {
            r.thumbsManagerDO.allowToSwitchCat && (r.disableAll(),
            r.thumbsManagerDO.showCurrentCat(t.id),
            r.dispatchEvent(o.INTRO_START),
            r.apiReady = !1)
        }
        ,
        r.setupLightBox = function() {
            if (r._d.useLightbox) {
                var e = FWDVU3DCarUtils.getHashParam("rlinst")
                  , s = !!e && e.match(/fwdvu3dcar/);
                e && (e = e.match(/\d+/g)[1]);
                var n = FWDVU3DCarUtils.getHashParam("rlguid")
                  , i = !!n && n.match(/fwdvu3dcar/);
                if (e ? n && e == r.instCountId && s && (r.startAtCategory = n.match(/\d+/g)[1],
                t["fwdvu3dcar" + r.startAtCategory + "_"] = r._d.lightboxAr[r.startAtCategory]) : n && i && (r.startAtCategory = n.match(/\d+/g)[1],
                t["fwdvu3dcar" + r.startAtCategory + "_"] = r._d.lightboxAr[r.startAtCategory]),
                !o.hasLoadRL && !t.FWDRL) {
                    var a = document.createElement("script");
                    a.src = r._d.mainFolderPath + "rl/java/FWDRL.js",
                    document.head.appendChild(a),
                    a.onerror = r.rlLoadError,
                    a.onload = r.rlLoadDone
                }
                r.rl_it = setInterval(function() {
                    (o.hasRL || t.FWDRL) && (r.initializeRL(),
                    clearInterval(r.rl_it))
                }, 5),
                o.hasLoadRL = !0
            }
        }
        ...
        r.rlLoadError = function() {
            clearInterval(r.rl_it),
            r.showInfo("Error loading Revolution Lightbox!")
        }
        ,
        ...
        r.initializeRL = function() {
            new FWDRL({
                ...
                mainFolderPath: r.mainFolderPath + "/rl/content",
                cls: "fwdvu3dcar-rl",
            ...
            r.rl.addListener(FWDRL.SHOW_START, function() {
                o.rlShowed = !0,
                r.dispatchEvent(o.RL_SHOW_START)
            }),
            r.rl.addListener(FWDRL.HIDE_COMPLETE, function() {
                o.rlShowed = !1,
                r.dispatchEvent(o.RL_HIDE_COMPLETE)
            })
        }
        ,
        r.setupDisable = function() {
            r.disableDO = new FWDVU3DCarDO3D("div"),
            r.disableDO.setZ(3e5),
            FWDVU3DCarUtils.isIE && (r.disableDO.setBkColor("#000000"),
        ...
        r.switchCategory = function(e) {
            r.apiReady && 0 <= e && e < r._d.dataListAr.length && (r.disableAll(),
            r.thumbsManagerDO.showCurrentCat(e),
            r.dispatchEvent(o.INTRO_START),
            r.menuDO && r.menuDO.setValue(e),
            r.apiReady = !1)
        }
        ,
        ...
        r.goToThumb = function(e) {
            r.apiReady && e != r.thumbsManagerDO.curId && (0 > e && (e = r.thumbsManagerDO.totalThumbs - 1),
            e > r.thumbsManagerDO.totalThumbs - 1 && (e = 0),
...
function(e) {
    var t = function(e, o, r, s, n) {
        ...
        i.isShowed_bl = !0,
        i.isMobile_bl = FWDVU3DCarUtils.isMobile,
        i.init = function() {
            i.setupMainContainers(),
            i.setWidth(i.totalWidthAndHeight),
            i.setHeight(i.totalWidthAndHeight),
            i.setButtonMode(!0),
            i.setNormalState()
        }
        ,
        i.setupMainContainers = function() {
            i.screen.id = "fwdvu3dcar_bullet_" + i.id,
            i.screen.className = "fwdvu3dcar-bullet",
            i.n_sdo = new FWDVU3DCarDO("div"),
            ...
            i.addChild(i.s_sdo),
            i.dumy_do = new FWDVU3DCarDO("div"),
            ...
            i.isMobile_bl ? i.hasPointerEvent_bl ? (i.screen.addEventListener("pointerup", i.onMouseUp),
            i.screen.addEventListener("pointerover", i.onMouseOver),
            i.screen.addEventListener("pointerout", i.onMouseOut)) : i.screen.addEventListener("touchend", i.onMouseUp) : (i.screen.addEventListener("mouseover", i.onMouseOver),
            i.screen.addEventListener("mouseout", i.onMouseOut),
            i.screen.addEventListener("mouseup", i.onMouseUp))
        }
        ,
        i.onMouseOver = function(o) {
            if ((i.dispatchEvent(t.SHOW_TOOLTIP, {
                e: o
            }),
            !i.isDisabledForGood_bl) && (!o.pointerType || o.pointerType == o.MSPOINTER_TYPE_MOUSE || "mouse" == o.pointerType)) {
                if (i.isDisabled_bl || i.isSelectedFinal_bl)
                    return;
        ...
        i.onMouseUp = function(o) {
            i.isDisabledForGood_bl || (o.preventDefault && o.preventDefault(),
            i.isDisabled_bl || 2 == o.button || i.dispatchEvent(t.MOUSE_UP, {
                id: i.id
            }))
        }
        ,
        i.setSelected = function() {
            ...
            i.s_sdo && (FWDAnimation.killTweensOf(i.s_sdo),
            FWDAnimation.to(i.s_sdo, .8, {
                alpha: 1,
                ease: Expo.easeOut
            }))
        }
        ...
        i.setUnselected = function() {
            ...
            i.s_sdo && FWDAnimation.to(i.s_sdo, .8, {
                alpha: 0,
                delay: .1,
                ease: Expo.easeOut
            })
        ...
        i.setNormalState = function() {
            ...
            FWDAnimation.to(i.n_sdo.screen, .6, {
                css: {
                    backgroundColor: i.normalColor
                },
                ease: Expo.easeOut
            }),
            FWDAnimation.to(i.s_sdo, .6, {
                alpha: 0,
                ease: Expo.easeOut
            }))
        }
        ...
        i.setSelectedState = function() {
            ...
            FWDAnimation.to(i.n_sdo.screen, .6, {
                css: {
                    backgroundColor: i.selectedColor
                },
                ease: Expo.easeOut
            }),
            FWDAnimation.to(i.s_sdo, .6, {
        ...
        i.setDisabledState = function() {
            i.isSetToDisabledState_bl || (i.isSetToDisabledState_bl = !0,
            i.d_sdo && i.d_sdo.setX(0))
        }
        ,
        i.setEnabledState = function() {
            i.isSetToDisabledState_bl && (i.isSetToDisabledState_bl = !1,
            i.d_sdo && i.d_sdo.setX(-100))
        }
        ,
        i.disable = function(e) {
            i.isDisabledForGood_bl || i.isDisabled_bl || (i.isDisabled_bl = !0,
            i.setButtonMode(!1),
            !e && i.setNormalState())
        }
        ,
        i.enable = function() {
            i.isDisabledForGood_bl || !i.isDisabled_bl || (i.isDisabled_bl = !1,
            i.setButtonMode(!0))
        }
        ,
        i.disableForGood = function() {
            i.isDisabledForGood_bl = !0,
            i.setButtonMode(!1)
        }
        ,
        ...
        ,
        i.show = function(e) {
            i.isShowed_bl || (i.isShowed_bl = !0,
            FWDAnimation.killTweensOf(i),
            FWDVU3DCarUtils.isIEAndLessThen9 ? FWDVU3DCarUtils.isIEAndLessThen9 && i.setVisible(!0) : (i.setAlpha(0),
            FWDAnimation.to(i, .8, {
                alpha: 1,
                delay: e,
                onStart: function() {
        ...
        ,
        i.hide = function(e) {
            i.isShowed_bl && (i.isShowed_bl = !1,
            FWDAnimation.killTweensOf(i),
            FWDAnimation.killTweensOf(i.n_sdo),
            e ? FWDVU3DCarUtils.isIEAndLessThen9 ? FWDVU3DCarUtils.isIEAndLessThen9 && i.setVisible(!1) : FWDAnimation.to(i, .8, {
                alpha: 0,
                ease: Expo.easeOut
            }) : i.setVisible(!1))
        }
    ...
    t.setPrototype = function(e) {
        t.prototype = null,
        t.prototype = e ? new FWDVU3DCarTransformDisplayObject("div") : new FWDVU3DCarDO("div")
    }
    ,
    t.CLICK = "onClick",
...
function(e) {
    var t = function(o, r, s) {
        ...
        n.bullets_ar,
        n.isPressed = !1,
        n.isMobile = FWDVU3DCarUtils.isMobile,
        n.hasPointerEvent = FWDVU3DCarUtils.hasPointerEvent,
        n.init = function() {
            n.mainHolder_do = new FWDVU3DCarDO("div","absolute","visible"),
        ...
        n.updateBullets = function(e) {
            ...
            var t;
            if (!o.infiniteLoop) {
                for (var r = 0; r < n.totalItems; r++)
                    t = n.bullets_ar[r],
                    r == n.curItemId ? (t.disable(),
                    t.setSelectedState(!0)) : (t.enable(),
                    t.setNormalState(!0));
        ...
        n.updateInininteBullets = function(e) {
            n.curItemId = Math.round(n.totalItems / 2) - 1,
            e === void 0 && (e = n.curItemId);
            for (var t = 0; t < n.totalItems; t++)
                bullet = n.bullets_ar[t],
                t == e ? bullet.setSelectedState(!0) : bullet.setNormalState(!0)
        }
        ,
        n.createBullets = function() {
            ...
            n.bullets_ar = [],
            n.totalWidth = 0,
            o.infiniteLoop && (n.totalItems = 2 * o.nrThumbsToDisplay + 1);
            for (var t = 0; t < n.totalItems; t++)
                FWDVU3DCarBullet.setPrototype(),
                e = new FWDVU3DCarBullet(t,o.bulletsNormalColor,o.bulletsSelectedColor,o.bulletsNormalRadius,o.bulletsSelectedRadius),
                e.addListener(FWDVU3DCarBullet.MOUSE_UP, n.bulletMouseUpHanlder),
                o.infiniteLoop && (e.addListener(FWDVU3DCarBullet.MOUSE_OVER, n.bulletMouseOverHanlder),
                e.addListener(FWDVU3DCarBullet.MOUSE_OUT, n.bulletMouseOutHanlder)),
        ...
        n.bulletMouseUpHanlder = function(r) {
            var e = r.id;
            o.infiniteLoop && (n.curItemId = Math.round(n.totalItems / 2) - 1,
            e -= n.curItemId),
            n.dispatchEvent(t.BULLET_CLICK, {
                id: e
            })
        }
        ,
        n.bulletMouseOverHanlder = function(t) {
            clearTimeout(n.upd),
            n.updateInininteBullets(t.id)
        }
        ,
        n.bulletMouseOutHanlder = function() {
            clearTimeout(n.upd),
            n.upd = setTimeout(n.updateInininteBullets, 500)
        }
        ,
        n.hideBullets = function() {
            clearTimeout(n.showBulletsId_to);
            for (var e = 0, t; e < n.totalItems; e++)
                t = n.bullets_ar[e],
                t.hide(!0);
            clearTimeout(n.hideBulletsId_to),
            n.hideBulletsId_to = setTimeout(n.destroyBullets, 800)
        }
        ,
        n.destroyBullets = function() {
            ...
            for (var e = 0, t; e < n.totalItems; e++)
                t = n.bullets_ar[e],
                n.mainHolder_do.removeChild(t),
                t.destroy()
        }
        ,
        n.show = function() {
            var e = .1, t = n.curItemId / 10, r;
            o.infiniteLoop && (n.curItemId = Math.round(n.totalItems / 2) - 1,
            t = n.curItemId / 10);
            var r = n.bullets_ar[n.curItemId];
            r && r.show(0);
            for (var s = n.curItemId; s < n.totalItems; s++)
                r = n.bullets_ar[s],
                r.show(e),
                e += .1;
            for (var s = 0; s < n.totalItems; s++)
                r = n.bullets_ar[s],
                r.show(t),
                t -= .1
        }
    ...
    t.setPrototype = function() {
        t.prototype = new FWDVU3DCarDO("div")
    }
    ,
    t.BULLET_CLICK = "bulletClick",
    t.prototype = null,
    e.FWDVU3DCarBulletsNavigation = t
}(window),
function() {
    var e = function(t, o) {
        'use strict';
        ...
        r.contextMenuHandler = function(t) {
            if (!r.isDisabled_bl)
                return "disabled" == o ? !!t.preventDefault && void t.preventDefault() : "default" == o || -1 == r.url.indexOf("sh.r") ? void 0 : (r.setupMenus(),
                r.prt.addChild(r.menu_do),
                r.menu_do.setVisible(!0),
                r.positionButtons(t),
                window.addEventListener ? window.addEventListener("mousedown", r.contextMenuWindowOnMouseDownHandler) : document.documentElement.attachEvent("onclick", r.contextMenuWindowOnMouseDownHandler),
                !!t.preventDefault && void t.preventDefault())
        }
        ,
        r.contextMenuWindowOnMouseDownHandler = function(t) {
            var e = FWDVU3DCarUtils.getViewportMouseCoordinates(t)
              , o = e.screenX
              , s = e.screenY;
            FWDVU3DCarUtils.hitTest(r.menu_do.screen, o, s) || (window.removeEventListener ? window.removeEventListener("mousedown", r.contextMenuWindowOnMouseDownHandler) : document.documentElement.detachEvent("onclick", r.contextMenuWindowOnMouseDownHandler),
            r.menu_do.setX(-500))
        }
        ,
        r.setupMenus = function() {
            r.menu_do || (r.menu_do = new FWDVU3DCarDO("div"),
            r.menu_do.setX(-500),
            r.menu_do.style().width = "100%",
            r.normalMenu_do = new FWDVU3DCarDO("div"),
            ...
            r.selectedMenu_do = new FWDVU3DCarDO("div"),
            ...
            r.over_do = new FWDVU3DCarDO("div"),
...
function(t) {
    var o = function(e, r) {
        ...
        s.parseProperties = function() {
            var e;
            if (!s.props.carouselDataListDivId)
                return e = "Carousel _d list id is not defined in FWDVU3DCar constructor function!",
                void s.dispatchEvent(o.LOAD_ERROR, {
                    text: e
                });
            if (s.rootElement = r.rootElement,
            s.mainFolderPath = s.props.mainFolderPath,
            !s.mainFolderPath)
                return void setTimeout(function() {
                    null == s || (errorMessage_str = "The <font color='#FF0000'>mainFolderPath</font> property is not defined in the constructor function!",
                    s.dispatchEvent(o.LOAD_ERROR, {
                        text: errorMessage_str
                    }))
                }, 50);
            if (s.mainFolderPath.lastIndexOf("/") + 1 != s.mainFolderPath.length && (s.mainFolderPath += "/"),
            s.skinPath_str = s.props.skinPath,
            !s.skinPath_str)
                return void setTimeout(function() {
                    null == s || (errorMessage_str = "The <font color='#FF0000'>skinPath</font> property is not defined in the constructor function!",
                    s.dispatchEvent(o.LOAD_ERROR, {
                        text: errorMessage_str
                    }))
                }, 50);
            ...
            s.useDragAndSwipeOnMobile = s.props.useDragAndSwipeOnMobile,
            s.useDragAndSwipeOnMobile = "yes" == s.useDragAndSwipeOnMobile,
            ...
            s.carouselYRotation = s.props.carouselYRotation,
            s.carouselXOffset = s.props.carouselXOffset || 0,
            ...
            s.centerImgXOffset = s.props.centerImageXOffset || 0,
            ...
            null == s.thumbMinAlpha && (s.thumbMinAlpha = .3),
            ...
            s.captionPosition = s.props.captionPosition || "in",
            ...
            s.showBulletsNavigation && (s.showNextAndPrevButtons = !1,
            s.showScrollbar = !1,
            s.showNextAndPrevButtons = !1,
            s.showSlideshowButton = !1),
            ...
            s.reflAlpha = s.props.reflectionOpacity || .5,
            ...
            s.menuPosition = "topleft" == s.props.menuPosition || "topright" == s.props.menuPosition ? FWDVU3DCarUtils.trim(s.props.menuPosition).toLowerCase() : "topleft",
            ...
            for (var a = [], l = 0, d, u, c, h, p, m, g, b, _, f, O, y; l < s.totalDataLists; l++) {
                y = [],
                h = n[l],
                u = [],
                d = [],
                g = FWDVU3DCarUtils.getChildren(h),
                p = g.length;
                for (var v = 0; v < p; v++) {
                    var D = {}
                      , w = g[v]
                      , c = FWDVU3DCarUtils.getChildren(w);
                    f = l + 1,
                    O = v + 1,
                    m = c.length;
                    for (var T = !0, C = 0; C < m; C++)
                        if (_ = "data-thumb-src",
                        FWDVU3DCarUtils.hasAttribute(c[C], "data-thumb-src")) {
                            T = !1,
                            D.thumbSrc = FWDVU3DCarUtils.trim(FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-src"));
                            break
                        }
                    if (D.thumbVideoSrc = FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-video-src"),
                    D.password = FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-password"),
                    D.subtitleSrc = FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-subtitle-src"),
                    D.thumbPreviewSrc = FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-preview-src"),
                    D.thumbVastSrc = FWDVU3DCarUtils.getAttributeValue(c[C], "data-thumb-vast-src"),
                    T)
                        return e = "Element with attribute <font color='#FF0000'>" + _ + "</font> is not defined in the datalist number - <font color='#FF0000'>" + f + "</font> at position - <font color='#FF0000'>" + O + "</font> in the datalist ul element.",
                        void s.dispatchEvent(o.LOAD_ERROR, {
                            text: e
                        });
                    if (s.showCaption) {
                        for (var C = 0; C < m; C++)
                            if (FWDVU3DCarUtils.hasAttribute(c[C], "data-thumb-caption")) {
                                D.thumbText = c[C].innerHTML,
                                b = c[C];
                                break
                            }
                        D.captionOffset = 0,
                        b && FWDVU3DCarUtils.getAttributeValue(b, "data-thumb-caption-offset") && (D.captionOffset = parseInt(FWDVU3DCarUtils.trim(FWDVU3DCarUtils.getAttributeValue(b, "data-thumb-caption-offset"))))
                    }
                    D.type = "none";
                    for (var C = 0, S; C < m; C++)
                        if (S = void 0,
                        FWDVU3DCarUtils.hasAttribute(c[C], "data-rl-src")) {
                            S = c[C];
                            break
                        }
                    var x = void 0;
                    if (S) {
                        x = {},
                        x.type = "none",
                        x.src = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-src") + "",
                        x.thumbSrc = D.thumbSrc;
                        var I = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-target");
                        x.target = I ? I : "_blank";
                        var P = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-poster-src");
                        P && (x.posterSrc = P);
                        var H = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-password");
                        H && (x.password = H);
                        var B = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-subtitle-src");
                        B && (x.subtitleSrc = B);
                        var L = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-preview-src");
                        L && (x.thumbnailsPreviewSrc = L);
                        var A = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-vast-src");
                        A && (x.vastSrc = A);
                        var M = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-width");
                        M && (x.width = M);
                        var E = FWDVU3DCarUtils.getAttributeValue(S, "data-rl-height");
                        E && (x.height = E);
                        for (var C = 0; C < m; C++)
                            if (FWDVU3DCarUtils.hasAttribute(c[C], "data-rl-caption")) {
                                x.caption = c[C].innerHTML;
                                break
                            }
                        /link:/i.test(x.src) ? (x.src = x.src.substr(5),
                        x.type = "link",
                        D.type = "link") : /none/i.test(x.src) && (x.src = x.src.substr(5),
                        x.type = "none",
                        D.type = "none"),
                        D.secondObj = x
                    }
                    s.setItemType(D, D.thumbVideoSrc),
                    x && "link" != x.type && (s.setItemType(x, x.src),
                    D.type = x.type),
                    D.thumbVideoSrc && (D.type = "none"),
                    x && "link" != x.type && "none" != x.type && !D.thumbVideoSrc && y.push(x),
                    u[v] = D,
                    a.push(D)
                }
                s.categoriesAr[l] = FWDVU3DCarUtils.getAttributeValue(h, "data-cat") || "not defined!",
                s.dataListAr[l] = u,
                s.lightboxAr[l] = {
                    playlistItems: y
                }
            }
            return s.showAllCategories && (s.categoriesAr.unshift(s.allCategoriesLabel),
            s.dataListAr.unshift(a),
            s.totalDataLists++),
            1 >= s.totalDataLists && (s.showMenu = !1),
            s.skinPath_str ? void (s.skinPaths_ar = [{
                img: s.largePlayNImg = new Image,
                src: s.skinPath_str + "large-play.png"
            }, {
                img: s.prevButtonNImg = new Image,
                src: s.skinPath_str + "prev-button.png"
            }, {
                img: s.comboboxArrowIconN_img = new Image,
                src: s.skinPath_str + "menuIcon.png"
            }, {
                img: s.nextButtonNImg = new Image,
                src: s.skinPath_str + "next-button.png"
            }, {
                img: s.pauseButtonImg = new Image,
                src: s.skinPath_str + "pause-button.png"
            }, {
                img: s.playButtonNImg = new Image,
                src: s.skinPath_str + "play-button.png"
            }, {
                img: s.handlerLeftNImg = new Image,
                src: s.skinPath_str + "handler-left-normal.png"
            }, {
                img: s.handlerLeftSImg = new Image,
                src: s.skinPath_str + "handler-left-selected.png"
            }, {
                img: s.handlerRightNImg = new Image,
                src: s.skinPath_str + "handler-right-normal.png"
            }, {
                img: s.handlerRightSImg = new Image,
                src: s.skinPath_str + "handler-right-selected.png"
            }, {
                img: s.trackLeftImg = new Image,
                src: s.skinPath_str + "trackLeft.png"
            }, {
                img: s.trackCenterImg = new Image,
                src: s.skinPath_str + "trackCenter.png"
            }, {
                img: s.trackRightImg = new Image,
                src: s.skinPath_str + "trackRight.png"
            }],
            ...
            setTimeout(function() {
                s.dispatchEvent(o.PRELOADER_LOAD_DONE),
                s.useVectorIcons ? s.useVideo ? s.loadVideoPlayer() : s.doneLoading() : s.loadSkin()
            }, 50)) : void s.dispatchEvent(o.LOAD_ERROR, {
                text: "Carousel graphics skin path is not defined in FWDVU3DCar constructor function!"
            })
        }
        ,
        s.setItemType = function(e, t) {
            /\.jpg|\.jpeg|\.webp|\.png|\.bmp|\.gif|\.tif|\.tiff|\.jfi|\.jfif|\.exif|\.svg/i.test(t) ? e.type = FWDVU3DCar.IMAGE : /\.mp4|\.m3u8|\.mpd/i.test(t) ? e.type = FWDVU3DCar.VIDEO : /youtube\./i.test(t) ? e.type = FWDVU3DCar.YOUTUBE : /vimeo\./i.test(t) ? e.type = FWDVU3DCar.VIMEO : /\.mp3/i.test(t) ? e.type = FWDVU3DCar.AUDIO : /https:|http:|\.pdf/i.test(t) ? e.type = FWDVU3DCar.IFRAME : document.getElementById(t) && (e.type = FWDVU3DCar.HTML)
        }
        ,
        s.loadSkin = function() {
            for (var e = 0, t, o; e < s.totalGraphics; e++)
                t = s.skinPaths_ar[e].img,
                o = s.skinPaths_ar[e].src,
                t.onload = s.onSkinLoadHandler,
                t.onerror = s.onSkinLoadErrorHandler,
                t.src = o
        }
        ,
        s.onSkinLoadHandler = function() {
            s.countLoadedSkinImages++,
            s.countLoadedSkinImages == s.totalGraphics && (s.useVideo ? s.loadVideoPlayer() : s.doneLoading())
        }
        ,
        ...
        s.onSkinLoadErrorHandler = function(r) {
            if (FWDVU3DCarUtils.isIEAndLessThen9)
                var e = "Graphics image not found!";
            else
                var e = "The skin icon with label <font color='#ff0000'>" + r.target.src + "</font> can't be loaded, check path!";
        ...
        s.loadVideoPlayer = function() {
            if (!FWDVU3DCar.hasLoadEVP && !t.FWDEVPlayer) {
                var e = document.createElement("script");
                e.src = s.mainFolderPath + "rl/content/evp/java/FWDEVPlayer.js",
                document.head.appendChild(e),
                e.onload = s.videoLoadDone,
                e.onerror = s.onVidLoadError
            }
            s.evp_it = setInterval(function() {
                (FWDVU3DCar.hasEVP || t.FWDEVPlayer) && (s.doneLoading(),
                clearInterval(s.evp_it))
            }, 5),
            FWDVU3DCar.hasLoadEVP = !0
        }
        ,
        ...
        s.checkForAttribute = function(t, e) {
            var r = FWDVU3DCarUtils.getChildFromNodeListFromAttribute(t, e);
            return r = r ? FWDVU3DCarUtils.trim(FWDVU3DCarUtils.getAttributeValue(r, e)) : void 0,
            r ? r : void s.dispatchEvent(o.LOAD_ERROR, {
    ...
    o.setPrototype = function() {
        o.prototype = new FWDVU3DCarEventDispatcher
    }
    ,
    o.prototype = null,
...
function(e) {
    e.FWDVU3DCarDO = function(e, t, o, r) {
        'use strict';
        var s = this;
        if (s.listeners = {
            events_ar: []
        },
        "div" == e || "img" == e || "canvas" == e)
            s.type = e;
        else
        ...
        s.rect,
        s.alpha = 1,
        s.hasT3D = FWDVU3DCarUtils.hasTransform3d,
        s.hasT2D = FWDVU3DCarUtils.hasTransform2d,
        (FWDVU3DCarUtils.isIE || FWDVU3DCarUtils.isIE11 && !FWDVU3DCarUtils.isMobile) && (s.hasT3D = !1,
        s.hasT2D = !1),
        ...
        s.getTransform = function() {
            for (var e = ["transform", "msTransform", "WebkitTransform", "MozTransform", "OTransform"], t; t = e.shift(); )
                if ("undefined" != typeof s.screen.style[t])
                    return t;
            return !1
        }
        ,
        s.setScreen = function(e) {
            "img" == s.type && e ? (s.screen = e,
            s.setMainProperties()) : (s.screen = document.createElement(s.type),
            s.setMainProperties())
        }
        ,
        s.setMainProperties = function() {
            ...
            "img" == e && (s.setWidth(s.screen.width),
            s.setHeight(s.screen.height))
        }
        ,
        s.setBackfaceVisibility = function() {
            s.screen.style.backfaceVisibility = "visible",
            s.screen.style.webkitBackfaceVisibility = "visible",
            s.screen.style.MozBackfaceVisibility = "visible"
        }
        ,
        ...
        s.setSelectable = function(e) {
            e || (s.screen.style.userSelect = "none",
        ...
        s.setVisible = function(e) {
            s.visible = e,
            s.screen.style.visibility = !0 == s.visible ? "visible" : "hidden"
        }
        ,
        ...
        s.setOverflow = function(e) {
            s.overflow = e,
            s.screen.style.overflow = s.overflow
        }
        ,
        s.setPosition = function(e) {
            s.position = e,
            s.screen.style.position = s.position
        }
        ,
        s.setDisplay = function(e) {
            s.display = e,
            s.screen.style.display = s.display
        }
        ,
        s.setButtonMode = function(e) {
            s.buttonMode = e,
            s.screen.style.cursor = !0 == s.buttonMode ? "pointer" : "default"
        }
        ,
        ...
        s.setInnerHTML = function(e) {
            s.innerHTML = e,
            s.screen.innerHTML = s.innerHTML
        }
        ,
        ...
        s.setAlpha = function(e) {
            s.alpha = e,
            s.screen.style.opacity = s.alpha
        }
        ,
        s.getAlpha = function() {
            return s.alpha
        ...
        s.setX = function(e) {
            s.x = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px,0)" : s.hasT2D ? s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px)" : s.screen.style.left = s.x + "px"
        }
        ,
        s.getX = function() {
            return s.x
        ...
        s.setY = function(e) {
            s.y = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px,0)" : s.hasT2D ? s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px)" : s.screen.style.top = s.y + "px"
        }
        ,
        s.getY = function() {
            return s.y
        ...
        s.setWidth = function(e) {
            s.w = e,
            "img" == s.type && (s.screen.width = s.w),
            s.screen.style.width = s.w + "px"
        }
        ,
        s.getWidth = function() {
            return "div" == s.type ? 0 == s.screen.offsetWidth ? s.w : s.screen.offsetWidth : "img" == s.type ? 0 == s.screen.offsetWidth ? 0 == s.screen.width ? s._w : s.screen.width : s.screen.offsetWidth : "canvas" == s.type ? 0 == s.screen.offsetWidth ? s.w : s.screen.offsetWidth : void 0
        }
        ,
        s.setHeight = function(e) {
            s.h = e,
            "img" == s.type && (s.screen.height = s.h),
            s.screen.style.height = s.h + "px"
        }
        ,
        s.getHeight = function() {
            return "div" == s.type ? 0 == s.screen.offsetHeight ? s.h : s.screen.offsetHeight : "img" == s.type ? 0 == s.screen.offsetHeight ? 0 == s.screen.height ? s.h : s.screen.height : s.screen.offsetHeight : "canvas" == s.type ? 0 == s.screen.offsetHeight ? s.h : s.screen.offsetHeight : void 0
        }
        ,
        s.setCSSGradient = function(e, t) {
            FWDVU3DCarUtils.isIEAndLessThen10 ? s.setBkColor(e) : (s.screen.style.backgroundImage = "-webkit-linear-gradient(top, " + e + ", " + t + ")",
        ...
        s.addChild = function(t) {
            s.contains(t) ? (s.children_ar.splice(FWDVU3DCarUtils.indexOfArray(s.children_ar, t), 1),
            s.children_ar.push(t),
            s.screen.appendChild(t.screen)) : (s.children_ar.push(t),
            s.screen.appendChild(t.screen))
        }
        ,
        s.removeChild = function(t) {
            if (s.contains(t))
                s.children_ar.splice(FWDVU3DCarUtils.indexOfArray(s.children_ar, t), 1),
                s.screen.removeChild(t.screen);
            else
                throw Error("##removeChild()## Child dose't exist, it can't be removed!")
        }
        ,
        s.contains = function(t) {
            return -1 != FWDVU3DCarUtils.indexOfArray(s.children_ar, t)
        }
        ,
        s.addChildAt = function(t, e) {
            if (0 == s.getNumChildren())
                s.children_ar.push(t),
                s.screen.appendChild(t.screen);
            else if (1 == e)
                s.screen.insertBefore(t.screen, s.children_ar[0].screen),
                s.screen.insertBefore(s.children_ar[0].screen, t.screen),
                s.contains(t) ? s.children_ar.splice(FWDVU3DCarUtils.indexOfArray(s.children_ar, t), 1, t) : s.children_ar.splice(FWDVU3DCarUtils.indexOfArray(s.children_ar, t), 0, t);
            else {
                if (0 > e || e > s.getNumChildren() - 1)
        ...
        s.removeChildAtZero = function() {
            s.screen.removeChild(s.children_ar[0].screen),
            s.children_ar.shift()
        }
        ,
            ...
            if (null != this.listeners) {
                ...
                for (var o = 0, r = this.listeners.events_ar.length; o < r; o++)
                    if (this.listeners.events_ar[o].target === this && this.listeners.events_ar[o].type === e) {
                        if (t)
                            for (var s in t)
                                this.listeners.events_ar[o][s] = t[s];
        ...
        s.destroy = function() {
            ...
            s.hasBeenSetSelectable_bl && (s.screen.ondragstart = null,
...
function(e) {
    e.FWDVU3DCarDO3D = function(e, t, o, r) {
        'use strict';
        var s = this;
        if (s.listeners = {
            events_ar: []
        ...
        s.setX = function(e) {
            s.x = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px," + s.z + "px) rotateX(" + s.angleX + "deg) rotateY(" + s.angleY + "deg) rotateZ(" + s.angleZ + "deg) scale3d(" + s.scale + ", " + s.scale + ", " + s.scale + ")" : s.hasT2D ? s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px) scale(" + s.scale + ", " + s.scale + ")" : s.screen.style.left = s.x + "px"
        }
        ,
        s.getX = function() {
            return s.x
        ...
        s.setY = function(e) {
            s.y = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px," + s.z + "px) rotateX(" + s.angleX + "deg) rotateY(" + s.angleY + "deg) rotateZ(" + s.angleZ + "deg) scale3d(" + s.scale + ", " + s.scale + ", " + s.scale + ")" : s.hasT2D ? s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px) scale(" + s.scale + ", " + s.scale + ")" : s.screen.style.top = s.y + "px"
        }
        ,
        s.getY = function() {
            return s.y
        ...
        s.setZ = function(e) {
            s.z = e,
            s.hasT3D && (s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px," + s.z + "px) rotateX(" + s.angleX + "deg) rotateY(" + s.angleY + "deg) rotateZ(" + s.angleZ + "deg) scale3d(" + s.scale + ", " + s.scale + ", " + s.scale + ")")
        }
        ,
        s.getZ = function() {
            return s.z
        ...
        s.setScale2 = function(e) {
            s.scale = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px," + s.z + "px) scale(" + s.scale + ", " + s.scale + ")" : s.hasT2D && (s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px) scale(" + s.scale + ", " + s.scale + ")")
        }
        ,
        s.setScale3D = function(e) {
            s.scale = e,
            s.hasT3D ? s.screen.style[s.transform] = "translate3d(" + s.x + "px," + s.y + "px," + s.z + "px) rotateX(" + s.angleX + "deg) rotateY(" + s.angleY + "deg) rotateZ(" + s.angleZ + "deg) scale3d(" + s.scale + ", " + s.scale + ", " + s.scale + ")" : s.hasT2D && (s.screen.style[s.transform] = "translate(" + s.x + "px," + s.y + "px) scale(" + s.scale + ", " + s.scale + ")")
        }
        ,
        s.getScale = function() {
            return s.scale
        ...
        s.setZIndex = function(e) {
            s.zIndex = e,
            s.screen.style.zIndex = s.zIndex
        }
        ,
        ...
        s.addChildAtZero = function(t) {
            0 == s.numChildren ? (s.children_ar.push(t),
            s.screen.appendChild(t.screen)) : (s.screen.insertBefore(t.screen, s.children_ar[0].screen),
            s.contains(t) && s.children_ar.splice(FWDVU3DCarUtils.indexOfArray(s.children_ar, t), 1),
            s.children_ar.unshift(t))
        }
        ,
        s.getChildAt = function(e) {
            if (0 > e || e > s.numChildren - 1)
                throw Error("##getChildAt()## Index out of bounds!");
            if (0 == s.numChildren)
                throw Errror("##getChildAt## Child dose not exist!");
            return s.children_ar[e]
...
function() {
    window.FWDVU3DCarEventDispatcher = function() {
        'use strict';
        this.listeners = {
            events_ar: []
        },
...
function(e) {
    var t = function(e, t) {
        ...
        o.init = function() {
            ...
            o.style().width = "80%",
            o.screen.className = "fwdvu3dcar-info-window",
            o.textHolder_do = new FWDVU3DCarDO("div"),
            FWDVU3DCarUtils.isIEAndLessThen9 || (o.textHolder_do.style().font = "Arial"),
        ...
        o.showText = function(e) {
            o.isShowedOnce_bl || (o.screen.addEventListener("mousedown", o.closeWindow),
            o.isShowedOnce_bl = !0),
    ...
    t.setPrototype = function() {
        t.prototype = new FWDVU3DCarDO("div","relative")
    }
    ,
    t.prototype = null,
    e.FWDVU3DCarInfo = t
...
function(t) {
    var o = function(e, r) {
        ...
        s.isShowed_bl = !1,
        s.isOpened_bl = !1,
        s.hasPointerEvent_bl = FWDVU3DCarUtils.hasPointerEvent,
        s.isMobile_bl = FWDVU3DCarUtils.isMobile,
        s.init = function() {
            s.setVisible(!1),
            s.setZ(9999999999),
            ...
            s.screen.className = "fwdvu3dcar-menu"
        }
        ,
        s.setupMainContainers = function() {
            var t;
            s.mainHolder_do = new FWDVU3DCarDO("div"),
            s.mainHolder_do.setOverflow("visible"),
            s.addChild(s.mainHolder_do),
            s.mainButtonsHolder_do = new FWDVU3DCarDO("div"),
            s.mainButtonsHolder_do.setBkColor(s.itemBkColorN_str1),
            s.mainHolder_do.addChild(s.mainButtonsHolder_do),
            s.buttonsHolder_do = new FWDVU3DCarDO("div"),
            s.buttonsHolder_do.setBkColor(s.itemBkColorN_str1),
            s.mainButtonsHolder_do.addChild(s.buttonsHolder_do);
            var o = s.categories_ar[s.curId], r;
            e._d.useVectorIcons && (r = "<span class=\"fwdvu3dcar-icon fwdvu3dcar-icon-menu-icon\"></span>"),
            FWDVU3DCarMenuSelector.setPrototype(),
            s.selector_do = new FWDVU3DCarMenuSelector(s.arrowNImg,s.arrowN_str,s.selectorLineColor,o,s.selectorBkColorN_str1,s.selectorTextColorN_str,s.selectorTextColorS_str,r,e._d.isSkinWhite),
            s.mainHolder_do.addChild(s.selector_do),
            s.selector_do.setNormalState(!1),
            s.selector_do.addListener(FWDVU3DCarMenuSelector.CLICK, s.openMenuHandler);
            for (var n = 0; n < s.tt; n++)
                FWDVU3DCarMenuButton.setPrototype(),
                t = new FWDVU3DCarMenuButton(s.categories_ar[n],s.itemBkColorN_str1,s.itemTextColorN_str,s.itemTextColorS_str,n,s.buttonH),
                s.buttons_ar[n] = t,
                t.addListener(FWDVU3DCarMenuButton.CLICK, s.buttonOnMouseDownHandler),
                s.buttonsHolder_do.addChild(t);
            0 != s.borderRadius && (t.bk_sdo.style().borderBottomLeftRadius = s.borderRadius + "px",
            t.bk_sdo.style().borderBottomRightRadius = s.borderRadius + "px"),
            s.grabbed_do = new FWDVU3DCarDO("div"),
        ...
        s.buttonOnMouseDownHandler = function(r) {
            ...
            s.setValue(s.curId),
            s.isMobile_bl ? s.hasPointerEvent_bl ? t.removeEventListener("MSPointerDown", s.checkOpenedMenu) : t.removeEventListener("touchstart", s.checkOpenedMenu) : t.removeEventListener("mousemove", s.checkOpenedMenu),
            s.dispatchEvent(o.BUTTON_PRESSED, {
                id: s.curId
            })
        }
        ,
        s.openMenuHandler = function() {
            s.isShowed_bl || (s.selector_do.disable(),
            s.show(!0),
            s.startToCheckOpenedMenu(),
            s.dispatchEvent(o.OPEN))
        }
        ,
        s.setValue = function(e) {
            s.curId = e,
            s.selector_do.setText(s.categories_ar[s.curId]),
            s.setButtonsState()
        }
        ,
        s.startToCheckOpenedMenu = function() {
            s.isMobile_bl ? s.hasPointerEvent_bl ? t.addEventListener("MSPointerDown", s.checkOpenedMenu) : t.addEventListener("touchstart", s.checkOpenedMenu) : (t.addEventListener("mousemove", s.checkOpenedMenu),
            t.addEventListener("mousedown", s.checkOpenedMenuOnMD))
        }
        ,
        ...
        s.checkOpenedMenu = function(o, e) {
            if (!s.isDragging) {
                var r = FWDVU3DCarUtils.getViewportMouseCoordinates(o);
                FWDVU3DCarUtils.hitTest(s.screen, r.screenX, r.screenY) ? clearTimeout(s.hideMenuTimeOutId_to) : (s.isMobile_bl || e ? (s.hide(!0),
                s.selector_do.enable(),
                t.removeEventListener("mousedown", s.checkOpenedMenuOnMD)) : (clearTimeout(s.hideMenuTimeOutId_to),
        ...
        s.getMaxWidthResizeAndPosition = function() {
            var e;
            s.selectorH = s.selector_do.getMaxHeight(),
            s.totalWidth = 0,
            s.totalButtonsHeight = 0,
            s.totalButtonsScroll = 0,
            s.totalWidth = s.selector_do.getMaxWidth();
            for (var t = 0; t < s.tt; t++)
                e = s.buttons_ar[t],
                e.getMaxWidth() > s.totalWidth && (s.totalWidth = e.getMaxWidth());
            s.buttons_ar[0].text_sdo.screen.className = "fwdvu3dcar-menu-button first-button",
            s.buttons_ar[s.tt - 1].text_sdo.screen.className = "fwdvu3dcar-menu-button last-button";
            for (var t = 0; t < s.tt; t++)
                e = s.buttons_ar[t],
                ...
                s.prevButton = e,
                s.hasScroll ? 5 > t && (4 > t ? s.totalButtonsHeight += e.h : (e = s.buttons_ar[s.tt - 1],
                e.setHeight(e.getMaxHeight()),
                s.totalButtonsHeight += e.h)) : s.totalButtonsHeight += e.h,
                s.hasScroll && s.activateScroll(),
                s.hasScroll ? t == s.tt - 1 ? (e = s.buttons_ar[1],
                s.totalButtonsScroll += e.h) : s.totalButtonsScroll += e.h : s.totalButtonsScroll += e.h;
        ...
        s.onMaxScrollStart = function(o) {
            if (!(o.button && 2 == o.button)) {
                s.setButtonsState(!0);
                var e = FWDVU3DCarUtils.getViewportMouseCoordinates(o);
                t.addEventListener("mousemove", s.onMaxScrollMove),
                t.addEventListener("touchmove", s.onMaxScrollMove, {
                    passive: !1
                }),
                s.isDragging = !0,
        ...
        s.onMaxScrollMove = function(t) {
            ...
            1 <= Math.abs(o) && (s.grabbed_do.style().height = "100%",
            s.isGrabbed = !0)
        }
        ,
        ...
        s.updateMax = function() {
            ...
            s.isDragging ? (s.vy = s.maxItemY - s.lastFinalY,
            s.lastFinalY = s.maxItemY) : (s.vy *= s.friction,
            s.maxItemY += s.vy,
            s.stageH <= s.buttonsHolder_do.h ? 0 <= s.maxItemY ? (s.vy2 = .3 * (0 - s.maxItemY),
            s.vy *= s.friction,
            s.maxItemY += s.vy2) : s.maxItemY <= s.stageH - s.buttonsHolder_do.h && (s.vy2 = .3 * (s.stageH - s.buttonsHolder_do.h - s.maxItemY),
            s.vy *= s.friction,
            s.maxItemY += s.vy2) : (s.vy2 = .3 * ((s.stageH - s.buttonsHolder_do.h) / 2 - s.maxItemY),
            s.vy *= s.friction,
            s.maxItemY += s.vy2),
            s.maxItemY = parseFloat(s.maxItemY.toFixed(2)),
            s.prevMaxItemY == s.maxItemY && (s.stopToUpdateDrag(),
            s.maxItemY = Math.round(s.maxItemY)),
            s.buttonsHolder_do.setY(s.maxItemY),
        ...
        s.setButtonsState = function(e) {
            for (var t = 0, o; t < s.tt; t++)
                o = s.buttons_ar[t],
                t == s.curId ? (o.isDisabled_bl = !0,
                o.setButtonMode(!1),
                o.setSelectedState(!0)) : (o.isDisabled_bl = !1,
                o.setButtonMode(!0),
                o.setNormalState(!0)),
        ...
        ,
        s.position = function() {
            "topleft" == s.position_str ? (s.finalX = Math.max((e.stageWidth - e.originalWidth) / 2 + s.horizontalMargins, s.horizontalMargins),
            s.finalY = s.verticalMargins + 1) : "topright" == s.position_str && (s.finalX = Math.min((e.originalWidth - e.stageWidth) / 2 + e.stageWidth - s.totalWidth - s.horizontalMargins, e.stageWidth - s.totalWidth - s.horizontalMargins),
        ...
        s.showFirstTime = function() {
            s.showFirstTimeDone || (s.showFirstTimeDone = !0,
            s.setVisible(!0),
            s.setAlpha(0),
        ...
        ,
        s.hide = function(e, t) {
            (s.isShowed_bl || t) && (s.isShowed_bl = !1,
            e ? (FWDAnimation.to(s.mainButtonsHolder_do, .6, {
                h: 0,
                ease: Expo.easeInOut
            }),
            FWDAnimation.to(s, .6, {
        ...
        ,
        s.show = function(e, t) {
            s.isShowed_bl && !t || (s.isShowed_bl = !0,
            clearTimeout(s.hideMenuTimeOutId_to),
            e ? (!FWDAnimation.isTweening(s) && s.buttonsHolder_do.setY(-s.selectorH),
            FWDAnimation.to(s.buttonsHolder_do, .6, {
                y: 0,
                ease: Expo.easeInOut
            }),
            FWDAnimation.to(s.mainButtonsHolder_do, .6, {
                h: s.totalButtonsHeight + s.selectorH,
                ease: Expo.easeInOut
            }),
            FWDAnimation.to(s, .6, {
                h: s.totalButtonsHeight + s.selectorH,
    ...
    o.setPrototype = function() {
        o.prototype = new FWDVU3DCarDO3D("div")
    }
    ,
    o.OPEN = "open",
...
function() {
    var t = function(e, o, r, s, n) {
        ...
        i.totalWidth = 400,
        i.id = n,
        i.hasPointerEvent_bl = FWDVU3DCarUtils.hasPointerEvent,
        i.isMobile_bl = FWDVU3DCarUtils.isMobile,
        i.isDisabled_bl = !1,
        i.init = function() {
        ...
        ,
        i.setupMainContainers = function() {
            i.bk_sdo = new FWDVU3DCarDO("div"),
            i.bk_sdo.style().width = "100%",
            i.bk_sdo.style().height = "100%",
            i.bk_sdo.setBkColor(i.backgroundNormalColor_str1),
            i.addChild(i.bk_sdo),
            i.text_sdo = new FWDVU3DCarDO("div"),
            i.text_sdo.screen.className = "fwdvu3dcar-menu-button",
            ...
            i.dumy_sdo = new FWDVU3DCarDO("div"),
            FWDVU3DCarUtils.isIE && (i.dumy_sdo.setBkColor("#FF0000"),
            i.dumy_sdo.setAlpha(0));
            i.dumy_sdo.style().width = "100%",
            i.dumy_sdo.style().height = "100%",
            i.addChild(i.dumy_sdo),
            i.isMobile_bl ? i.hasPointerEvent_bl ? (i.screen.addEventListener("MSPointerOver", i.onMouseOver),
            i.screen.addEventListener("MSPointerOut", i.onMouseOut),
            i.screen.addEventListener("MSPointerDown", i.onMouseDown),
            i.screen.addEventListener("MSPointerUp", i.onClick)) : i.screen.addEventListener("click", i.onClick) : i.screen.addEventListener && (i.screen.addEventListener("mouseover", i.onMouseOver),
            i.screen.addEventListener("mouseout", i.onMouseOut),
            i.screen.addEventListener("click", i.onClick))
        }
        ,
        i.onMouseOver = function(o) {
            i.isDisabled_bl || (!o.pointerType || o.pointerType == o.MSPOINTER_TYPE_MOUSE) && (FWDAnimation.killTweensOf(i.text_sdo),
        ...
        i.onClick = function(o) {
            i.isDisabled_bl || (o.preventDefault && o.preventDefault(),
        ...
        i.setSelectedState = function(e) {
            e ? FWDAnimation.to(i.text_sdo.screen, .6, {
                css: {
                    color: i.textSelectedColor_str
                },
                ease: Quart.easeOut
            }) : (i.bk_sdo.setCSSGradient(i.backgroundSelectedColor_str, i.backgroundNormalColor_str),
            i.text_sdo.style().color = i.textSelectedColor_str)
        }
        ,
        i.setNormalState = function(e) {
            e ? FWDAnimation.to(i.text_sdo.screen, .6, {
                css: {
                    color: i.textNormalColor_str
                },
                ease: Quart.easeOut
            }) : (i.bk_sdo.setCSSGradient(i.backgroundNormalColor_str, i.backgroundSelectedColor_str),
            i.text_sdo.style().color = i.textNormalColor_str)
        }
        ,
...
function() {
    var t = function(e, o, r, s, n, i, a, l, d) {
        ...
        u.totalWidth = 400,
        l || (u.arrowWidth = e.width,
        u.arrowHeight = e.height),
        u.hasPointerEvent_bl = FWDVU3DCarUtils.hasPointerEvent,
        u.isMobile_bl = FWDVU3DCarUtils.isMobile,
        u.isDisabled_bl = !1,
        u.init = function() {
        ...
        u.setupMainContainers = function() {
            u.bk_sdo = new FWDVU3DCarDO("div"),
            u.bk_sdo.setBkColor(u.backgroundNormalColor_str1),
            u.bk_sdo.style().width = "100%",
            u.bk_sdo.style().height = "100%",
            u.addChild(u.bk_sdo),
            u.text_sdo = new FWDVU3DCarDO("div"),
            u.text_sdo.screen.className = "fwdvu3dcar-menu-selector",
            ...
            u.arrowN_sdo = new FWDVU3DCarDO("div"),
            u.addChild(u.arrowN_sdo),
            u.arrowN_sdo.setAlpha(.5),
            l ? (u.arrowN_sdo.screen.className = "fwdvu3dcar-menu-icon vector",
            d && (u.arrowN_sdo.screen.className = "fwdvu3dcar-menu-icon white vector"),
            ...
            }, 5)) : (u.arrowN_sdo.screen.className = "fwdvu3dcar-menu-icon",
            d && (u.arrowN_sdo.screen.className = "fwdvu3dcar-menu-icon white"),
            u.arrowN_sdo.screen.style.backgroundImage = "url(" + u.arrowN_str + ")"),
            setTimeout(function() {
                u.arrowN_sdo.setWidth(u.arrowWidth),
                u.arrowN_sdo.setHeight(u.arrowHeight),
                u.arrowN_sdo.setY(Math.round((u.h - u.arrowN_sdo.h) / 2) - 1)
            }, 350),
            u.line_do = new FWDVU3DCarDO("div"),
            u.line_do.screen.className = "fwdvu3dcar-menu-line",
            u.line_do.style().background = u.selectorLineColor,
            u.line_do.setAlpha(0),
            u.addChild(u.line_do),
            u.dumy_sdo = new FWDVU3DCarDO("div"),
            u.dumy_sdo.style().width = "100%",
            u.dumy_sdo.style().height = "100%",
            FWDVU3DCarUtils.isIE && (u.dumy_sdo.setBkColor("#FF0000"),
        ...
        u.onMouseOver = function(o) {
            u.isDisabled_bl || (!o.pointerType || o.pointerType == o.MSPOINTER_TYPE_MOUSE) && (FWDAnimation.killTweensOf(u.text_sdo),
        ...
        u.setSelectedState = function(e) {
            ...
            FWDAnimation.to(u.arrowN_sdo, .6, {
                alpha: 1,
                ease: Quart.easeOut
            })) : (u.bk_sdo.setCSSGradient(u.backgroundSelectedColor_str, u.backgroundNormalColor_str),
            u.text_sdo.style().color = u.textSelectedColor_str,
            u.arrowN_sdo.alpha = 1)
        }
        ,
        u.setNormalState = function(e) {
            ...
            FWDAnimation.to(u.arrowN_sdo, .6, {
                alpha: .4,
                ease: Quart.easeOut
            })) : (u.bk_sdo.setCSSGradient(u.backgroundNormalColor_str, u.backgroundSelectedColor_str),
            u.text_sdo.style().color = u.textNormalColor_str,
            u.arrowN_sdo.alpha = .4)
        }
        ,
    ...
    t.CLICK = "onClick",
    t.prototype = null,
    window.FWDVU3DCarMenuSelector = t
}(window),
function(e) {
    var t = function(e, o, r, s, n, i, a) {
        ...
        l.init = function() {
            l.mm_do = new FWDVU3DCarDO("div"),
            l.mm_do.setOverflow("visible"),
            l.main_do = new FWDVU3DCarDO("div"),
            ...
            l.bkCanvas = new FWDVU3DCarDO("canvas"),
            l.bkCanvasContext = l.bkCanvas.screen.getContext("2d"),
            l.fillCircleCanvas = new FWDVU3DCarDO("canvas"),
        ...
        l.setFWidth = function(e, t) {
            l.main_do.setX(Math.round(e - l.w) / 2),
            l.main_do.setY(Math.round(t - l.h) / 2),
            l.setWidth(e),
            l.setHeight(t)
        }
        ,
        l.positionAndResize = function() {
            "bottomleft" == l.preloaderPostion ? (l.setX(e.offsetPreloader),
            l.setY(e.sH - l.h - e.offsetPreloader)) : "bottomright" == l.preloaderPostion ? (l.setX(e.sW - l.w - e.offsetPreloader),
            l.setY(e.sH - l.h - e.offsetPreloader)) : "topright" == l.preloaderPostion ? (l.setX(e.sW - l.w - e.offsetPreloader),
            l.setY(e.offsetPreloader)) : "topleft" == l.preloaderPostion ? (l.setX(e.offsetPreloader),
            l.setY(e.offsetPreloader)) : "center" == l.preloaderPostion && (l.setX(Math.round(e.sW - l.w) / 2),
        ...
        l.startSlideshow = function() {
            null == l || self.isSlideShowRun || (self.isSlideShowRun = !0,
            FWDAnimation.killTweensOf(l.angle),
            FWDAnimation.to(l.angle, l.animDur, {
                n: 360,
                onUpdate: l.drawFill,
        ...
        l.stopSlideshow = function(e) {
            (self.isSlideShowRun || e) && (self.isSlideShowRun = !1,
            FWDAnimation.killTweensOf(l.angle),
            FWDAnimation.to(l.angle, .8, {
                n: 0,
                onUpdate: l.drawFill,
                ease: Expo.easeInOut
            }))
        ...
        l.startPreloader = function() {
            ...
            FWDAnimation.to(l.main_do.screen, l.animDur, {
                rotation: 360,
                repeat: 100
            })
        }
        ...
        l.stopPreloader = function() {
            ...
            FWDAnimation.to(l.main_do.screen, 1e-5, {
                rotation: 0
            })
        }
        ,
        l.show = function() {
            l.isShowed_bl || (l.setVisible(!0),
            FWDAnimation.killTweensOf(l.mm_do),
            FWDAnimation.to(l.mm_do, 1, {
                alpha: 1,
                delay: .2
            }),
            l.stopPreloader(),
        ...
        ,
        l.hide = function(e) {
            l.isShowed_bl && (FWDAnimation.killTweensOf(l.mm_do),
            e ? FWDAnimation.to(l.mm_do, .2, {
                alpha: 0,
...
function(t) {
    var o = function(e, r, s, n) {
        ...
        i.scrollbarHeight = 0,
        e.useVectorIcons || (i.scrollbarHeight = e.trackLeftImg.height,
        i.trackLeftWidth = e.trackLeftImg.width,
        i.handlerLeftWidth = e.handlerLeftNImg.width,
        i.handlerLeftSWidth = e.handlerLeftSImg.width),
        i.totalItems = r,
        i.curItemId = s,
        i.prevCurItemId,
        i.mouseX = 0,
        ...
        i.isPressed = !1,
        i.isMobile = FWDVU3DCarUtils.isMobile,
        i.hasPointerEvent = FWDVU3DCarUtils.hasPointerEvent,
        i.init = function() {
            i.screen.className = "fwdvu3dcar-scrollbar",
            e.isSkinWhite && (i.screen.className = "fwdvu3dcar-scrollbar white"),
        ...
        i.setupMainContainers = function() {
            ...
            i.setTrack(),
            i.setHandler(),
            1 < n.totalThumbs && (i.isMobile ? i.hasPointerEvent ? (i.scrollbarHandlerOverDO.screen.addEventListener("MSPointerOver", i.onScrollMouseOver),
            i.scrollbarHandlerOverDO.screen.addEventListener("MSPointerOut", i.onScrollMouseOut),
            i.scrollbarHandlerOverDO.screen.addEventListener("MSPointerDown", i.onScrollMouseDown)) : i.scrollbarHandlerOverDO.screen.addEventListener("touchstart", i.onScrollMouseDown) : (i.scrollbarHandlerOverDO.setButtonMode(!0),
            i.screen.addEventListener && (i.scrollbarHandlerOverDO.screen.addEventListener("mouseover", i.onScrollMouseOver),
        ...
        ,
        i.setTrack = function() {
            i.scrollbarTrackDO = new FWDVU3DCarDO("div"),
            i.addChild(i.scrollbarTrackDO),
            e.useVectorIcons ? (i.scrollbarTrackDO.screen.className = "fwdvu3dcar-scrollbar-track",
            e.isSkinWhite && (i.scrollbarTrackDO.screen.className = "fwdvu3dcar-scrollbar-track white"),
            setTimeout(function() {
                i.scrollbarHeight = parseInt(getComputedStyle(i.screen).getPropertyValue("height"))
            }, 5)) : (i.scrollbarTrackDO.screen.className = "fwdvu3dcar-scrollbar-track-",
            e.isSkinWhite && (i.scrollbarTrackDO.screen.className = "fwdvu3dcar-scrollbar-track- white"),
            i.scrollbarTrackDO.setWidth(i.trackWidth),
            i.scrollbarTrackDO.setHeight(i.scrollbarHeight),
            i.scrollbarTrackLeftDO = new FWDVU3DCarDO("img"),
            i.scrollbarTrackLeftDO.setScreen(i.trackLeftImg),
            i.scrollbarTrackDO.addChild(i.scrollbarTrackLeftDO),
            i.scrollbarTrackCenterDO = new FWDVU3DCarDO("div"),
            ...
            i.scrollbarTrackRightDO = new FWDVU3DCarDO("img"),
        ...
        i.setHandler = function() {
            i.scrollbarHandlerDO = new FWDVU3DCarDO("div"),
            i.addChild(i.scrollbarHandlerDO),
            e.useVectorIcons ? (i.handlerClass = "fwdvu3dcar-scrollbar-handler",
            e.isSkinWhite && (i.handlerClass += " white"),
            i.scrollbarHandlerDO.screen.className = i.handlerClass) : (i.scrollbarHandlerDO.screen.className = "fwdvu3dcar-scrollbar-handler-",
            i.scrollbarHandlerLeftNDO = new FWDVU3DCarDO("img"),
            i.scrollbarHandlerLeftNDO.setScreen(i.handlerLeftNImg),
            i.scrollbarHandlerDO.addChild(i.scrollbarHandlerLeftNDO),
            i.scrollbarHandlerCenterNDO = new FWDVU3DCarDO("div"),
            ...
            i.scrollbarHandlerRightNDO = new FWDVU3DCarDO("img"),
            ...
            i.scrollbarHandlerLeftSDO = new FWDVU3DCarDO("img"),
            ...
            i.scrollbarHandlerCenterSDO = new FWDVU3DCarDO("div"),
            ...
            i.scrollbarHandlerRightSDO = new FWDVU3DCarDO("img"),
            ...
            i.scrollbarHandlerTextDO = new FWDVU3DCarDO("div"),
            i.scrollbarHandlerTextDO.screen.className = "fwdvu3dcar-scrollbar-text",
            ...
            i.scrollbarHandlerOverDO = new FWDVU3DCarDO("div"),
            ...
            FWDVU3DCarUtils.isIE && (i.scrollbarHandlerOverDO.setBkColor("#000000"),
            i.scrollbarHandlerOverDO.setAlpha(.001))
        }
        ,
        ...
        i.resize = function(e, t) {
            e < t + i.scrollbarMaxWidth ? .8 * e - t < i.handlerWidth ? (i.resizeTrack(0),
            i.scrollbarHandlerDO.setY(500)) : (i.resizeTrack(Math.floor(e - t)),
            i.scrollbarHandlerDO.setY(0)) : i.getWidth() < i.scrollbarMaxWidth && (i.resizeTrack(Math.floor(i.scrollbarMaxWidth)),
            i.scrollbarHandlerDO.setY(0)),
        ...
        i.resizeTrack = function(t) {
            ...
            i.scrollbarTrackDO.setWidth(i.trackWidth),
            e.useVectorIcons || (i.scrollbarTrackCenterDO.setWidth(Math.floor(i.trackWidth - 2 * i.trackLeftWidth)),
        ...
        i.onScrollMouseOver = function() {
            i.scrollbarOver = !0,
            e.useVectorIcons ? i.scrollbarHandlerDO.screen.className = i.handlerClass + " selected" : (FWDAnimation.to(i.scrollbarHandlerLeftSDO, .8, {
                alpha: 1,
                ease: Expo.easeOut
            }),
            FWDAnimation.to(i.scrollbarHandlerCenterSDO, .8, {
                alpha: 1,
                ease: Expo.easeOut
            }),
            FWDAnimation.to(i.scrollbarHandlerRightSDO, .8, {
                alpha: 1,
                ease: Expo.easeOut
            })),
            FWDAnimation.to(i.scrollbarHandlerTextDO.screen, .8, {
                css: {
                    color: i.textColorSelected
                },
                ease: Expo.easeOut
            })
        }
        ...
        i.onScrollMouseOut = function() {
            i.scrollbarOver = !1;
            i.isPressed || (e.useVectorIcons ? i.scrollbarHandlerDO.screen.className = i.handlerClass : (FWDAnimation.to(i.scrollbarHandlerLeftSDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            }),
            FWDAnimation.to(i.scrollbarHandlerCenterSDO, .8, {
        ...
        i.onScrollMouseDown = function(o) {
            if (!n.isLoading) {
                ...
                i.isMobile ? i.hasPointerEvent ? (t.addEventListener("MSPointerMove", i.onScrollMove),
                t.addEventListener("MSPointerUp", i.onScrollMouseUp)) : (t.addEventListener("touchmove", i.onScrollMove, {
                    passive: !1
                }),
                t.addEventListener("touchend", i.onScrollMouseUp)) : i.screen.addEventListener ? t.addEventListener("mousemove", i.onScrollMove) : document.attachEvent("onmousemove", i.onScrollMove)
            }
        }
        ,
        i.onScrollMove = function(t) {
            ...
            i.prevCurItemId != i.curItemId && (i.dispatchEvent(o.MOVE, {
                id: i.curItemId
            }),
            i.scrollbarHandlerTextDO.setInnerHTML(i.curItemId + 1 + "/" + i.totalItems)),
        ...
        i.onScrollMouseUp = function() {
            i.isPressed = !1,
            i.isMobile ? i.hasPointerEvent ? (t.removeEventListener("MSPointerUp", i.onScrollMouseUp),
            t.removeEventListener("MSPointerMove", i.onScrollMove)) : (t.removeEventListener("touchend", i.onScrollMouseUp),
            t.removeEventListener("touchmove", i.onScrollMove)) : i.screen.addEventListener ? t.removeEventListener("mousemove", i.onScrollMove) : document.detachEvent("onmousemove", i.onScrollMove),
        ...
        i.gotoItem = function(e, t) {
            i.curItemId = e,
            i.prevCurItemId != i.curItemId && (t ? (FWDAnimation.killTweensOf(i.scrollbarHandlerDO),
            FWDAnimation.to(i.scrollbarHandlerDO, .8, {
                x: Math.floor(i.curItemId * (i.trackWidth - i.offset - i.handlerWidth) / (i.totalItems - 1)),
                ease: Expo.easeOut
    ...
    o.setPrototype = function() {
        o.prototype = new FWDVU3DCarDO("div")
    }
    ,
    o.MOVE = "onMove",
    o.prototype = null,
    t.FWDVU3DCarScrollbar = o
}(window),
function(e) {
    var t = function(e, o, r, s, n) {
        'use strict';
        ...
        i.nClass = s,
        i.sClass = n,
        i.nImg && (i.totalWidth = i.nImg.width,
        i.totalHeight = i.nImg.height),
        i.isShowed = !0,
        i.isMbl = FWDVU3DCarUtils.isMbl,
        i.hasPointerEvent_bl = FWDVU3DCarUtils.hasPointerEvent,
        i.init = function() {
            i.setupMainContainers()
        }
        ...
        i.setupMainContainers = function() {
            if (i.html)
                i.n_do = new FWDVU3DCarDO("div"),
                i.n_do.setInnerHTML(i.html),
                i.setNormalState(),
                i.addChild(i.n_do),
                setTimeout(function() {
                    i.setWidth(parseInt(getComputedStyle(i.n_do.screen).getPropertyValue("width"))),
                    i.setHeight(parseInt(getComputedStyle(i.n_do.screen).getPropertyValue("height")))
                }, 5);
            else {
                i.buttonsHolder_do = new FWDVU3DCarDO("div"),
                i.n_do = new FWDVU3DCarDO("img"),
                i.n_do.setScreen(i.nImg),
                i.buttonsHolder_do.addChild(i.n_do);
                var e = new Image;
                e.src = i.sPath,
                i.s_do = new FWDVU3DCarDO("img"),
                i.s_do.setScreen(e),
            ...
            i.setButtonMode(!0),
            i.isMbl ? i.hasPointerEvent_bl ? (i.screen.addEventListener("pointerup", i.onMouseUp),
            i.screen.addEventListener("pointerover", i.onMouseOver),
            i.screen.addEventListener("pointerout", i.onMouseOut)) : i.screen.addEventListener("touchend", i.onMouseUp) : (i.screen.addEventListener("mouseover", i.onMouseOver),
            i.screen.addEventListener("mouseout", i.onMouseOut),
            i.screen.addEventListener("mouseup", i.onMouseUp))
        ...
        i.onMouseOut = function(o) {
            if (!i.isDisabledForGood_bl && (!o.pointerType || o.pointerType == o.MSPOINTER_TYPE_MOUSE || "mouse" == o.pointerType)) {
                if (i.isDisabled_bl || i.isSelectedFinal_bl || i.isDisabled2)
                    return;
                i.dispatchEvent(t.MOUSE_OUT, {
                    e: o
                }),
        ...
        i.onMouseUp = function(o) {
            i.isDisabledForGood_bl || (o.preventDefault && o.preventDefault(),
            i.isDisabled_bl || 2 == o.button || i.dispatchEvent(t.CLICK, {
                e: o,
                inst: i.inst
            }))
        }
        ,
        i.setNormalState = function() {
            i.html ? i.n_do.screen.className = i.nClass : (FWDAnimation.killTweensOf(i.s_do),
            FWDAnimation.to(i.s_do, .5, {
                alpha: 0,
                ease: Expo.easeOut
            }))
        }
        ,
        i.setSelectedState = function() {
            i.html ? i.n_do.screen.className = i.nClass + " " + i.sClass : (FWDAnimation.killTweensOf(i.s_do),
            FWDAnimation.to(i.s_do, .5, {
                alpha: 1,
                delay: .1,
                ease: Expo.easeOut
        ...
        i.show = function(e) {
            ...
            e === void 0 && (e = .4),
            0 == e ? (i.setScale2(1),
            i.setVisible(!0)) : FWDAnimation.to(i, .8, {
                scale: 1,
                delay: e,
                onStart: function() {
                    i.setVisible(!0)
        ...
        ,
        i.hide = function(e) {
            (i.isShowed_bl || e) && (i.isShowed_bl = !1,
            FWDAnimation.killTweensOf(i),
            i.setVisible(!1),
            i.setScale2(0))
        }
        ...
        i.setHideDrag = function(e) {
            FWDAnimation.killTweensOf(i.n_do),
            e ? FWDAnimation.to(i.n_do, .4, {
                alpha: .3,
                delay: .4
            }) : FWDAnimation.to(i.n_do, .4, {
                alpha: 1
            })
        }
        ,
    ...
    t.setPrototype = function(e) {
        t.prototype = e ? new FWDVU3DCarDO3D("div") : new FWDVU3DCarDO("div")
    }
    ,
    t.CLICK = "onClick",
    t.MOUSE_OVER = "onMouseOver",
...
function(e) {
    var t = function(e, o) {
        ...
        r.isStopped = !0,
        o.useVectorIcons || (r.btnWidth = r.playButtonNImg.width,
        r.btnHeight = r.playButtonNImg.height),
        r.isMobile = FWDVU3DCarUtils.isMobile,
        r.hasPointerEvent = FWDVU3DCarUtils.hasPointerEvent,
        r.animDelayId_to,
        r.timeoutId,
        r.timerIntervalId,
        r.init = function() {
        ...
        r.setupMainContainers = function() {
            if (r.setButtonMode(!0),
            o.useVectorIcons) {
                var e = "fwdvu3dcar-slideshow-button";
                o.isSkinWhite && (e += " white"),
                r.screen.className = e,
                setTimeout(function() {
                    r.btnHeight = parseInt(getComputedStyle(r.screen).getPropertyValue("height")),
                    r.btnWidth = parseInt(getComputedStyle(r.screen).getPropertyValue("width")),
                    r.initAll()
                }, 5)
            } else
                r.initAll(),
                r.screen.className = "fwdvu3dcar-slideshow-button-"
        }
        ,
        r.initAll = function() {
            ...
            r.setTimerButton(),
            r.setPlayButton(),
            r.isMobile ? r.hasPointerEvent ? (r.screen.addEventListener("MSPointerOver", r.onMouseOver),
            r.screen.addEventListener("MSPointerOut", r.onMouseOut),
            r.screen.addEventListener("MSPointerUp", r.onClick)) : r.screen.addEventListener("touchend", r.onClick) : (r.screen.addEventListener("mouseover", r.onMouseOver),
        ...
        r.setTimerButton = function() {
            if (o.useVectorIcons) {
                var e = "fwdvu3dcar-slideshow-button-bk";
                o.isSkinWhite && (e += " white"),
                r.slpBk_do = new FWDVU3DCarDO("div"),
                r.slpBk_do.screen.className = e
            } else {
                r.slpBk_do = new FWDVU3DCarDO("img");
                var t = new Image;
                t.src = o.circleBK,
                r.slpBk_do.setScreen(t)
            }
            ...
            FWDVU3DCarPreloader.setPrototype(),
            r.slp_do = new FWDVU3DCarPreloader(r,"none",8,o.slideshowPreloaderBackgroundColor,o.slideshowPreloaderFillColor,2.5,r.delay / 1e3),
        ...
        r.setPauseButton = function() {
            if (o.useVectorIcons) {
                var e = "fwdvu3dcar-slideshow-pause-button";
                o.isSkinWhite && (e += " white"),
                r.pauseButtonDO = new FWDVU3DCarDO("div"),
                r.pauseButtonDO.setInnerHTML("<span class=\"fwdvu3dcar-icon fwdvu3dcar-icon-pause\"></span>"),
                r.pauseButtonDO.screen.className = e
            } else
                r.pauseButtonDO = new FWDVU3DCarDO("img"),
        ...
        r.setPlayButton = function() {
            if (r.playButtonDO = new FWDVU3DCarDO("div"),
            r.playButtonClass = "fwdvu3dcar-slideshow-play-button",
            o.isSkinWhite && (r.playButtonClass += " white"),
            o.useVectorIcons) {
                var e = "fwdvu3dcar-slideshow-play-button";
                o.isSkinWhite && (e += " white"),
                r.playButtonDO.setInnerHTML("<span class=\"fwdvu3dcar-icon fwdvu3dcar-icon-play-fill\"></span>"),
                r.playButtonDO.screen.className = e
            } else {
                r.playButtonNDO = new FWDVU3DCarDO("img"),
                r.playButtonNDO.setScreen(r.playButtonNImg),
                r.playButtonDO.addChild(r.playButtonNDO),
                r.playButtonSDO = new FWDVU3DCarDO("img");
                var t = new Image;
        ...
        r.onMouseOver = function() {
            ...
            o.useVectorIcons ? r.playButtonDO.screen.className = r.playButtonClass + " selected" : FWDAnimation.to(r.playButtonSDO, .8, {
                alpha: 1,
                ease: Expo.easeOut
            })) : (r.slp_do.hide2(),
            FWDAnimation.to(r.slpBk_do, .8, {
                alpha: 0,
                ease: Expo.easeOut
            }))
        }
        ...
        r.onMouseOut = function() {
            ...
            o.useVectorIcons ? r.playButtonDO.screen.className = r.playButtonClass : FWDAnimation.to(r.playButtonSDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            })) : (r.slp_do.show2(),
            FWDAnimation.to(r.slpBk_do, .8, {
        ...
        ,
        r.onClick = function() {
            r.isStopped ? (r.slp_do.resetSlideshow(),
            r.start(),
            r.pauseButtonDO.setAlpha(1),
            r.dispatchEvent(t.PLAY_CLICK)) : (r.stop(),
            r.pauseButtonDO.setAlpha(0),
        ...
        ,
        r.start = function() {
            r.isStopped && (r.isStopped = !1,
            r.playButtonDO.setAlpha(0),
            clearTimeout(r.timeoutId),
            !e.videoStarted && (r.timeoutId = setTimeout(r.onTimeHandler, r.delay),
            r.startSlideshow()))
        }
        ,
        r.stop = function() {
        ...
        ,
        r.pause = function() {
            r.isStopped || (clearTimeout(r.timeoutId),
            r.stopSlideshow())
        }
        ,
        r.resume = function() {
            r.isStopped || !e.videoStarted && (r.startSlideshow(),
            clearTimeout(r.timeoutId),
        ...
        r.hideSlideshow = function() {
            ...
            FWDAnimation.to(r.playButtonSDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            }),
            ...
            FWDAnimation.to(r.pauseButtonDO, .8, {
                alpha: 0,
                ease: Expo.easeOut
            }),
            r.slp_do.hide2()
...
function(e) {
    var t = function(e, o, r) {
        ...
        s.thumbScale = 1,
        s.isMobile = FWDVU3DCarUtils.isMobile,
        s.hasPointerEvent = FWDVU3DCarUtils.hasPointerEvent,
        s.init = function() {
            s.setupScreen()
        }
        ,
        s.setupScreen = function() {
            s.screen.className = "fwdvu3dcar-thumbnail",
            s.screen.id = "fwdvu3dcar_thumbnail_" + s.id,
            FWDVU3DCarUtils.isIOS ? (s.mainDO = new FWDVU3DCarDO3D("div","absolute","visible"),
            s.addChild(s.mainDO),
            s.mainDO.setZ(1)) : (s.mainDO = new FWDVU3DCarDO("div","absolute","visible"),
            s.addChild(s.mainDO)),
            s.mainDO.setWidth(s.thumbWidth),
            s.mainDO.setHeight(s.thumbHeight),
            s.setWidth(s.thumbWidth),
            s.setHeight(s.thumbHeight),
            o.transparentImages ? s.borderSize = 0 : (s.borderDO = new FWDVU3DCarDO("div"),
            s.borderDO.screen.className = "fwdvu3dcar-thumbnail-border",
            s.bgDO = new FWDVU3DCarDO("div"),
            s.bgDO.screen.className = "fwdvu3dcar-thumbnail-background",
            ...
            FWDVU3DCarUtils.isAndroid && (s.borderDO.setBackfaceVisibility(),
            s.bgDO.setBackfaceVisibility())),
            s.imageHolderDO = new FWDVU3DCarDO("div"),
            s.imageHolderDO.hasT3D = !1,
            s.imageHolderDO.screen.className = "fwdvu3dcar-image",
            s.mainDO.addChild(s.imageHolderDO),
            s.curDataListAr = r.curDataListAr,
            s.updateButtonMode(),
            FWDVU3DCarUtils.isAndroid && (s.setBackfaceVisibility(),
            s.mainDO.setBackfaceVisibility(),
            s.imageHolderDO.setBackfaceVisibility()),
        ...
        s.updateButtonMode = function() {
            ...
            r._d.useVideo || (e = !1),
            s.id == r.curId ? "none" == s.curDataListAr[s.id].type && "none" == t || e ? s.mainDO.style().cursor = null : !r.useDrag && s.mainDO.setButtonMode(!0) : !r.useDrag && s.mainDO.setButtonMode(!0)
        }
        ,
        s.addReflection = function() {
            if (s.imageDO) {
                ...
                s.reflCanvasDO = new FWDVU3DCarDO("canvas"),
                s.addChild(s.reflCanvasDO),
                s.reflCanvasDO.screen.width = r.thumbWidth,
                s.reflCanvasDO.screen.height = r.reflHeight;
                var n = s.reflCanvasDO.screen.getContext("2d");
                n.save(),
                n.translate(0, s.thumbHeight),
                n.scale(1, -1),
                o.transparentImages || (n.fillStyle = s.borderColor2,
                n.fillRect(0, 0, s.thumbWidth, s.thumbHeight)),
        ...
        s.updateText = function() {
            s.curDataListAr[s.id].emptyText || (s.textOffset = s.curDataListAr[s.id].textOffset,
        ...
        s.setTextHeight = function() {
            ...
            o.showFullCaption ? !r.showCaptionUnderThumbnail_bl && (s.textGradientDO.setY(s.thumbHeight - 2 * s.borderSize - s.textHeight - s.textDescriptionOffsetBottom),
            s.textDO.setY(s.thumbHeight - 2 * s.borderSize - s.textHeight - s.textDescriptionOffsetBottom)) : !r.showCaptionUnderThumbnail_bl && (s.textGradientDO.setY(s.thumbHeight - 2 * s.borderSize - s.textOffset),
            s.textDO.setY(s.thumbHeight - 2 * s.borderSize - s.textOffset)),
            FWDAnimation.to(s.textHolderDO, .8, {
                alpha: 1,
                ease: Expo.easeOut
            }),
            s.hasText = !0,
        ...
        s.removeText = function() {
            s.textHolderDO && FWDAnimation.to(s.textHolderDO, .6, {
                alpha: 0,
                ease: Expo.easeOut,
                onComplete: s.removeTextFinish
            })
        }
        ,
        ...
        s.showThumb3D = function() {
            var e = s.thumbWidth - 2 * s.borderSize
              , t = s.thumbHeight - 2 * s.borderSize;
            o.transparentImages ? (s.imageDO.setAlpha(0),
            FWDAnimation.to(s.imageDO, .8, {
                alpha: 1,
                ease: Quart.easeOut
            ...
            FWDAnimation.to(s.imageHolderDO, .8, {
                x: s.borderSize,
                y: s.borderSize,
                w: e,
                h: t,
            ...
            s.reflCanvasDO && (s.reflCanvasDO.setAlpha(0),
            FWDAnimation.to(s.reflCanvasDO, .8, {
                alpha: 1,
                ease: Expo.easeInOut
            }))
        }
        ...
        s.showThumb2D = function() {
            if (!FWDVU3DCarUtils.hasTransform2d) {
                ...
                s.imageDO && (s.imageDO.setWidth(r),
        ...
        s.showThumbIntro2D = function(e, t) {
            if (s.thumbScale = e,
            !FWDVU3DCarUtils.hasTransform2d) {
                ...
                s.borderDO && (s.borderDO.setWidth(o),
                s.borderDO.setHeight(r)),
                s.bgDO && (s.bgDO.setX(n),
                s.bgDO.setY(n),
                s.bgDO.setWidth(i),
                s.bgDO.setHeight(a)),
                ...
                FWDAnimation.to(s, .8, {
                    x: Math.floor(s.newX + (s.thumbWidth - o) / 2),
                    y: Math.floor(s.newY + (s.thumbHeight - r) / 2),
                    alpha: s.newAlpha,
                    delay: t,
                    ease: Expo.easeOut
                })
        ...
        s.setScale = function(e, t) {
            ...
            !FWDVU3DCarUtils.hasTransform2d) {
                ...
                s.bgDO && (s.bgDO.setX(n),
                s.bgDO.setY(n),
                s.bgDO.setWidth(o - 2 * n),
                s.bgDO.setHeight(r - 2 * n)),
                s.mainDO.setWidth(o),
                s.mainDO.setHeight(r),
                ...
                s.setHeight(r),
                s.setAlpha(t),
                s.imageDO && (s.imageDO.setWidth(o - 2 * n),
                s.imageDO.setHeight(r - 2 * n))
            } else
                s.setX(Math.floor(s.newX)),
                s.setY(Math.floor(s.newY)),
                s.setScale2(s.thumbScale),
                s.setAlpha(t)
        }
        ,
        s.update = function() {
            r.showRefl ? s.reflCanvasDO ? (s.reflCanvasDO.setAlpha(1),
            s.reflCanvasDO.setY(s.thumbHeight + r.reflDist)) : s.addReflection() : s.reflCanvasDO && s.reflCanvasDO.setAlpha(0)
        }
        ,
        s.hide = function(e) {
            ...
            FWDAnimation.to(s.imageHolderDO, .8, {
                x: parseInt(s.thumbWidth / 2),
                y: parseInt(s.thumbHeight / 2),
                w: 0,
                h: 0,
                delay: e,
                ease: Expo.easeInOut
            }),
            s.imageDO && (FWDAnimation.to(s.imageDO, .8, {
                x: -parseInt(t / 2),
                y: -parseInt(o / 2),
                delay: e,
                ease: Expo.easeInOut
            }),
            s.reflCanvasDO && FWDAnimation.to(s.reflCanvasDO, .8, {
                alpha: 0,
                delay: e,
                ease: Expo.easeInOut
            }))
        ...
        s.destroy = function() {
            ...
            s.isMobile ? s.hasPointerEvent ? s.mainDO.screen.removeEventListener("MSPointerUp", s.onMouseTouchHandler) : s.mainDO.screen.removeEventListener("touchend", s.onMouseTouchHandler) : s.mainDO.screen.removeEventListener("click", s.onMouseClickHandler),
            clearTimeout(s.setTextHeightId),
            s.imageDO && (FWDAnimation.killTweensOf(s.imageDO),
            s.imageDO.disposeImage(),
            s.imageDO.screen.onload = null,
            s.imageDO.screen.onerror = null,
            s.imageDO.destroy()),
            s.htmlContentDO && (FWDAnimation.killTweensOf(s.htmlContentDO),
            s.htmlContentDO.destroy(),
            s.htmlContentDO = null),
            s.bgDO && (FWDAnimation.killTweensOf(s.bgDO),
            s.bgDO.destroy(),
            s.bgDO = null),
            s.borderDO && (FWDAnimation.killTweensOf(s.borderDO),
            s.borderDO.destroy(),
            s.borderDO = null),
            s.htmlContentDO && (FWDAnimation.killTweensOf(s.htmlContentDO),
            s.htmlContentDO.destroy()),
            s.textGradientDO && (FWDAnimation.killTweensOf(s.textGradientDO),
            s.textGradientDO = null),
            s.textDO && (FWDAnimation.killTweensOf(s.textDO),
            s.textDO = null),
            s.textHolderDO && (FWDAnimation.killTweensOf(s.textHolderDO),
            s.textHolderDO = null),
    ...
    t.setPrototype = function() {
        t.prototype = new FWDVU3DCarDO3D("div","absolute","visible")
    }
    ,
    t.CLICK = "click",
    t.prototype = null,
...
function(t) {
    var o = function(e, r) {
        ...
        s.carouselYRot = e.carouselYRotation,
        ...
        s.centerImgXOffset = e.centerImgXOffset,
        ...
        s.init = function() {
            ...
            s.hasT3D = !1,
            s.hasT2D = !1,
            s.holderDO = new FWDVU3DCarDO3D("div","absolute","visible"),
            s.addChild(s.holderDO),
            s.holderDO.setWidth(s.stageWidth),
            s.holderDO.setOverflow("visible"),
            s.thumbsHolderDO = new FWDVU3DCarDO3D("div","absolute","visible"),
            s.holderDO.addChild(s.thumbsHolderDO),
            FWDVU3DCarUtils.isSafari && s.thumbsHolderDO.setZ(1e6),
            FWDVU3DCarUtils.isIEAndLessThen10 && (s.carRadiusX /= 1.5),
            s.thumbsHolderDO.setPreserve3D(),
            s.thumbsHolderDO.setAngleY(-s.carouselYRot),
            ...
            s.isMobile && (e.showScrollbarOnMobile && (s.showScrollbar = !1),
            e.showNextAndPrevButtonsOnMobile && (s.showNextAndPrevButtons = !1)),
            s.showCaption_bl && s.setupCaption(),
            s.setupVideo(),
            s.showCurrentCat(-1),
            s.setupControls(),
            s.hideControls(),
            s.isMobile || (s.addDragScreen(),
            setTimeout(function() {
        ...
        s.addDragScreen = function() {
            s.useDrag && (s.style().cursor = s.handC,
            r.mainDO.style().cursor = s.handC)
        }
        ,
        s.removeDragScreen = function() {
            s.style().cursor = null,
            r.mainDO.style().cursor = null
        }
        ,
        s.resizeHandler = function(e, t) {
            (s.prevStageW != r.stageWidth || s.prevStageH != r.stageHeight || t) && (s.stageWidth = r.stageWidth,
            s.stageHeight = r.stageHeight,
            ...
            s.thumbsHolderDO.setX(Math.floor(s.stageWidth / 2) + s.carXOffset),
            s.thumbsHolderDO.setY(Math.floor(s.stageHeight / 2)),
            s.isEvpFS && s.thumbsHolderDO.setY(-5e3),
            s.positionControls(),
            !e && (s.positionCaptionHolder(),
            setTimeout(s.positionCaptionHolder, 50)),
            s.positionVideo())
        }
        ,
        s.setupDisableDragScreen = function() {
            s.dsb_do || (s.dsb_do = new FWDVU3DCarDO3D("div"),
            s.dsb_do.setZ(100001),
            FWDVU3DCarUtils.isIE && (s.dsb_do.setBkColor("#00FF00"),
            s.dsb_do.setAlpha(1e-7)),
        ...
        ,
        s.showDsb = function() {
            s.isDsbShowed_bl || !s.dsb_do || (clearTimeout(s.hideDSBId_to),
            s.isDsbShowed_bl = !0,
            s.dsb_do.setVisible(!0),
            s.dsb_do.setWidth(s.stageWidth),
            s.dsb_do.setHeight(s.stageHeight))
        }
        ,
        s.hideDsb = function() {
            s.isDsbShowed_bl && s.dsb_do && (clearTimeout(s.hideDSBId_to),
            s.isDsbShowed_bl = !1,
            s.dsb_do.setVisible(!1),
            s.dsb_do.setWidth(0),
            s.dsb_do.setHeight(0))
        }
        ,
        s.onThumbMove = function(t) {
            if (s.textHolderDO && !s.disableThumbClick && s.hasCaption) {
                ...
                s.vmcX = e.screenX,
                s.vmcY = e.screenY,
                s.isTextSet && s.checkThumbOver()
            }
        }
        ,
        s.showCurrentCat = function(t) {
            if (s.showCaptionFirstTime = !0,
            s.hieVideoOnFrstTween = !0,
            t != s.dataListId && 0 <= t)
                return s.showBulletsNavigation && s.bulletsNavigationDO && s.bulletsNavigationDO.hideBullets(),
                s.allowToSwitchCat = !1,
                s.hideCurrentCat(),
                void (s.dataListId = t);
            if (s.thumbsAr = [],
            s.curDataListAr = s._d.dataListAr[s.dataListId],
            s.totalThumbs = s.curDataListAr.length,
            s.prevCaptionId = -1,
            0 == s.totalThumbs) {
                return void s.dispatchEvent(o.LOAD_ERROR, {
            ...
            s.showScrollbar && s.scrollbarDO && (s.scrollbarDO.totalItems = s.totalThumbs,
            s.scrollbarDO.curItemId = s.curId,
            s.scrollbarDO.gotoItem2()),
            s.showBulletsNavigation && s.bulletsNavigationDO && (s.bulletsNavigationDO.totalItems = s.totalThumbs,
            s.bulletsNavigationDO.curItemId = s.curId,
            s.bulletsNavigationDO.createBullets(),
            setTimeout(function() {
                s.positionControls()
            }, 400)),
            e.useVectorIcons && setTimeout(function() {
                s.positionControls()
            }, 400),
        ...
        s.hideCurrentCat = function() {
            ...
            s.evp && s.evp.stop(),
            s.hidePlayButton(!0),
            s.image && (s.image.onload = null,
            s.image.onerror = null),
            s.imageLeft && (s.imageLeft.onload = null,
            s.imageLeft.onerror = null),
            s.imageRight && (s.imageRight.onload = null,
            s.imageRight.onerror = null),
            s.hideThumbs(),
            s.hideControls(!0)
        }
        ,
        s.hideThumbs = function() {
            var e = -s.thumbHeight / 2, t = Math.max(s.totalThumbs - s.curId, s.curId), o, r;
            r = Math.floor(1e3 / t);
            for (var n = 0, a; n < s.totalThumbs; n++)
                a = s.thumbsAr[n],
                n == s.curId ? s.hideThumbsFinishedId = setTimeout(s.hideThumbsFinished, 500) : (o = Math.abs(t - Math.abs(n - s.curId) + 1) * r,
                FWDAnimation.to(a, .8, {
                    y: Math.floor(e),
                    alpha: 0,
                    ease: Expo.easeOut
        ...
        s.hideThumbsFinished = function() {
            ...
            for (var e = 0, t; e < s.totalThumbs; e++)
                ...
                FWDAnimation.to(t, .6, {
                    alpha: 0,
                    delay: .2,
                    onComplete: s.allThumbsAreTweened
                })) : t.setAlpha(0)
        }
        ,
        ...
        s.destroyCurrentCat = function() {
            for (var e = 0, t; e < s.totalThumbs; e++)
                ...
                s.thumbsHolderDO.removeChild(t),
                t.destroy(),
                t = null
        }
        ,
        s.startIntro = function() {
            ...
            var e = s.thumbsAr[s.curId]
              , t = s.carRadiusX * Math.sin(Math.PI / 2) - s.thumbWidth / 2
              , o = -s.thumbHeight / 2;
            e.setX(Math.floor(t)),
            e.setY(Math.floor(o)),
            e.setAlpha(0),
        ...
        s.setupCenterImg = function() {
            s.centerImage = new Image,
            s.centerImage.onerror = s.onCenterImageLoadErrorHandler,
            s.centerImage.onload = s.onCenterImageLoadHandler,
            s.centerImage.src = s.centerImgPath
        }
        ,
        s.onCenterImageLoadHandler = function() {
            s.centerImgDO = new FWDVU3DCarDO3D("div"),
            s.thumbsHolderDO.addChild(s.centerImgDO),
            s.centerImg = new FWDVU3DCarDO("img"),
            ...
            s.centerImgDO.setX(-Math.floor(s.centerImgDO.getWidth() / 2) + s.centerImgXOffset),
            s.centerImgDO.setY(-Math.floor(s.centerImgDO.getHeight() / 2)),
            s.centerImgDO.setZ(-s.carRadiusY),
            (FWDVU3DCarUtils.isIE || !FWDVU3DCarUtils.hasTransform3d) && s.centerImgDO.setZIndex(Math.floor(s.carRadiusX) + 1),
            s.centerImgDO.setScale3D(s.scale * s.centerImgDO.getWidth() / s.centerImgDO.screen.getBoundingClientRect().width),
            s.showCIWithNoDl || (s.centerImgDO.setAlpha(0),
            FWDAnimation.to(s.centerImgDO, .8, {
                alpha: 1,
                delay: .8
            }))
        }
        ...
        s.setupThumbs = function() {
            for (var e = 0, t; e < s.totalThumbs; e++)
                FWDVU3DCarThumb.setPrototype(),
                t = new FWDVU3DCarThumb(e,s._d,s),
                s.thumbsAr.push(t),
                t.addListener(FWDVU3DCarThumb.CLICK, s.onThumbClick);
            s.dumyThumbDO = new FWDVU3DCarDO3D("div"),
        ...
        s.positionDumyCaption = function() {
            ...
            e = Math.floor(e) - Math.floor(s.thumbHeight / 2),
            s.dumyThumbDO.setY(e)
        }
        ,
        s.onThumbClick = function(t) {
            s.disableThumbClick || s.isLoading || (s.curId = t.id,
            s.curId != s.prevCurId && s.goToThumb())
        }
        ,
        s.thumbClickHandler = function(n) {
            var a = FWDVU3DCarUtils.getViewportMouseCoordinates(n);
            if ((s.vmcX = a.screenX,
            s.vmcY = a.screenY,
            !FWDVU3DCar.rlShowed) && !(s.disableThumbClick || FWDAnimation.isTweening(s.mainThumbDO)) && !(r.menuDO && FWDVU3DCarUtils.hitTest(r.menuDO.screen, s.vmcX, s.vmcY)) && s.mainThumbDO && FWDVU3DCarUtils.hitTest(s.mainThumbDO.screen, s.vmcX, s.vmcY)) {
                if ("in" == s.captionPosition && s.hasCaption) {
                    if (!s.isOver && e.showCaptionOnTap && !e.showFullCaption)
                        return void s.onThumbOverHandler(!0);
                    var l = s.textHolderDO.screen.querySelectorAll(".fwdvu3dcar-title")[0];
                    if (l) {
                        l = l.children;
                        for (var d = 0, u; d < l.length; d++)
                            if (u = l[d],
                            "A" == u.tagName && FWDVU3DCarUtils.hitTest(u, s.vmcX, s.vmcY))
                                return
                    }
                    if (l = s.textHolderDO.screen.querySelectorAll(".fwdvu3dcar-desc")[0],
                    l) {
                        l = l.children;
                        for (var d = 0, u; d < l.length; d++)
                            if (u = l[d],
                ...
                var c = "none";
                s.curDataListAr[s.curId].secondObj && (c = s.curDataListAr[s.curId].secondObj.type);
                var h = s.curId;
                if ("none" != c) {
                    for (var d = 0, p; d < s.totalThumbs; d++) {
                        p = "none",
                        s.curDataListAr[d].secondObj && (p = s.curDataListAr[d].secondObj.type);
                        var m = s.curDataListAr[d].thumbVideoSrc;
                        d < s.curId && ("link" == p || "none" == p || m) && (h -= 1)
                    }
                    if (s.stopSlideshow(),
                    "link" == c)
                        t.open(s.curDataListAr[s.curId].secondObj.src, s.curDataListAr[s.curId].secondObj.target);
                    else {
                        if (m = s.curDataListAr[s.curId].thumbVideoSrc,
                        m)
                            return void s.dispatchEvent(o.LOAD_ERROR, {
                                text: "Please set use video to yes to play video/audio in the carousel thumbnails."
                            });
                        if (!e.useLightbox)
                            return void s.dispatchEvent(o.LOAD_ERROR, {
                                text: "Please set use lightbox to yes to use the lightbox."
                            });
                        s.dispatchEvent(o.THUMB_CLICK, {
                            playlistId: s.dataListId,
                            thumbId: h
                        })
                    }
                }
        ...
        s.checkThumbOver = function() {
            s.hasCaption && !e.showFullCaption && s.mainThumbDO && (!s.mainThumbDO || s.mainThumbDO.screen) && (FWDVU3DCarUtils.hitTest(s.mainThumbDO.screen, s.vmcX, s.vmcY) ? s.onThumbOverHandler(!0) : s.onThumbOutHandler(!0))
        }
        ,
        s.onThumbOverHandler = function(e) {
            s.isAnim || !s.isOver && (s.isOver = !0,
            "in" == s.captionPosition && (FWDAnimation.killTweensOf(s.textDO),
            e ? FWDAnimation.to(s.textDO, .7, {
                y: s.textHolderDO.h - s.textDO.getHeight(),
                ease: Expo.easeInOut
            }) : s.textDO.setY(-s.textDO.getHeight())))
        }
        ,
        s.onThumbOutHandler = function(t, o) {
            if (!s.isAnim && s.showCaption_bl && (s.isOver || o)) {
                var r;
                s.isOver = !1,
                "in" == s.captionPosition && (FWDAnimation.killTweensOf(s.textDO),
                r = e.showFullCaption ? s.textHolderDO.h - s.textDO.getHeight() : s.textHolderDO.h - s.captionOffset,
                t ? FWDAnimation.to(s.textDO, .7, {
                    y: r,
                    ease: Expo.easeInOut
                }) : s.textDO.setY(r))
            }
        ...
        s.setupCaption = function() {
            FWDVU3DCarUtils.isMAC ? (s.textHolderDO = new FWDVU3DCarDO3D("div"),
            s.textHolderDO.setZ(100000008)) : s.textHolderDO = new FWDVU3DCarDO("div"),
            s.addChild(s.textHolderDO),
            s.textDO = new FWDVU3DCarDO("div"),
            s.textDO.style().width = "100%",
            s.textDO.screen.className = "fwdvu3dcar-caption dark in",
            e.isSkinWhite && (s.textDO.screen.className = "fwdvu3dcar-caption white in"),
            s.textHolderDO.addChild(s.textDO),
            "out" == s.captionPosition && (s.textDO.screen.className = "fwdvu3dcar-caption dark out",
            e.isSkinWhite && (s.textDO.screen.className = "fwdvu3dcar-caption white out"),
        ...
        s.setCaption = function() {
            ...
            r.getCaptionHeight(),
            "in" == s.captionPosition && ("none" == s.curDataListAr[s.curId].type || s.useDrag ? s.useDrag ? s.textHolderDO.style().cursor = s.handC : s.textHolderDO.setButtonMode(!1) : s.textHolderDO.setButtonMode(!0),
            r.resizeHandler(!0)),
            s.positionCaptionHolder(),
            e = s.curDataListAr[s.curId],
            s.showCaptionFirstTime || !s.hadPrevCaption ? (s.hideCaption(),
            setTimeout(function() {
                s.showCaption(!0, !0)
            }, 50)) : s.showCaption(!0),
            s.checkThumbOver(),
        ...
        s.hideCaption = function(o, n) {
            if (s.hasCaption)
                if (FWDAnimation.killTweensOf(s.textHolderDO),
                s.captionShowed = !1,
                "in" != s.captionPosition)
                    FWDAnimation.killTweensOf(s.textDO),
                    o ? "motion" == e.captionAnimationType ? FWDAnimation.to(s.textDO, .8, {
                        y: -r.captionH - 6,
                        ease: Expo.easeInOut
                    }) : FWDAnimation.to(s.textHolderDO, .8, {
                        alpha: 0,
                        ease: Quint.easeOut
                    }) : "motion" == e.captionAnimationType ? s.textDO.setY(-r.captionH - 6) : s.textHolderDO.setAlpha(0);
                else if (!o)
                    "motion" == e.captionAnimationType ? s.textDO.setY(s.textHolderDO.getHeight() + 1) : s.textHolderDO.setAlpha(0);
                else if ("motion" == e.captionAnimationType)
                    FWDAnimation.to(s.textHolderDO, .25, {
                        alpha: 0,
                        ease: Quint.easeOut
                    });
                else {
                    var i = .25;
                    n && (i = .8),
                    FWDAnimation.to(s.textHolderDO, i, {
                        alpha: 0,
                        ease: Quint.easeOut
                    })
                }
        ...
        s.showCaption = function(t, o) {
            if (s.hasCaption && !s.captionShowed) {
                ...
                "in" != s.captionPosition)
                    FWDAnimation.killTweensOf(s.textDO),
                    t ? "motion" == e.captionAnimationType ? FWDAnimation.to(s.textDO, .8, {
                        y: 0,
                        ease: Expo.easeInOut
                    }) : FWDAnimation.to(s.textHolderDO, .8, {
                        alpha: 1,
                        ease: Quint.easeOut
                    }) : "motion" == e.captionAnimationType ? s.textDO.setY(0) : s.textHolderDO.setAlpha(1);
                else if (r = e.showFullCaption || FWDVU3DCarUtils.hitTest(s.mainThumbDO.screen, s.vmcX, s.vmcY) ? s.textHolderDO.h - s.textDO.getHeight() : s.textHolderDO.h - s.captionOffset,
                !t)
                    s.textDO.setY(r),
                    "motion" == e.captionAnimationType ? s.textHolderDO.setAlpha(1) : s.textHolderDO.setAlpha(1);
                else if ("motion" == e.captionAnimationType)
                    s.textHolderDO.setAlpha(1),
                    s.textDO.setY(s.textHolderDO.h + 1),
                    FWDAnimation.to(s.textDO, .8, {
                        y: r,
                        ease: Expo.easeInOut
                    });
                else {
        ...
        s.positionCaptionHolder = function() {
            if (s.textHolderDO && s.dumyThumbDO)
                if ("in" == s.captionPosition) {
                    ...
                    s.textHolderDO.setX(o + s.borderSize * s.scale),
                    s.textHolderDO.setY(Math.round(n + s.borderSize * s.scale)),
                    1 != s.scale && s.textHolderDO.setY(s.textHolderDO.y + 1),
                    s.textHolderDO.setWidth(e - 2 * (s.borderSize * s.scale));
                    ...
                    s.textHolderDO.setY(n),
                    s.textHolderDO.setHeight(300)
                }
        }
        ,
        ...
        s.onImageLoadHandlerCenter = function() {
            ...
            e.addImage(s.image),
            e.showThumb3D(),
            s.showCaption_bl && (s.isTextSet = !0,
            s.setCaption()),
            clearTimeout(s.textTimeoutId),
        ...
        s.loadThumbImageLeft = function() {
            0 > s.countLoadedThumbsLeft || (s.imagePath = s.curDataListAr[s.countLoadedThumbsLeft].thumbSrc,
        ...
        s.loadThumbImageRight = function() {
            s.countLoadedThumbsRight > s.totalThumbs - 1 || (s.imagePath = s.curDataListAr[s.countLoadedThumbsRight].thumbSrc,
        ...
        s.setupIntro3D = function() {
            for (var e = 0, t, o, n, a, l, d, u; e < s.totalThumbs; e++) {
                ...
                l = 0;
                var c = 0;
                if (c = e < s.curId ? e - s.curId + s.totalThumbs : e - s.curId,
                u.carAngle = 2 * (c / s.totalThumbs * Math.PI),
                t = s.carRadiusX * Math.cos(u.carAngle),
                o = s.carRadiusY * Math.cos(u.carAngle + Math.PI / 2),
                n = s.carRadiusY * Math.cos(u.carAngle) - s.carRadiusY,
                0 == n && (s.mainThumbDO = u),
                u.screen.style.pointerEvents = FWDVU3DCarUtils.isSafari && n < -s.carRadiusY ? "none" : "auto",
                e != s.curId) {
                    switch (s.topology) {
                    case "ring":
                        l = 360 * (c / s.totalThumbs);
                        break;
                    case "star":
                        l = 360 * (c / s.totalThumbs) + 90;
                        break;
                    default:
                        l = 0;
                    }
                ...
                u.newZ = n,
                0 == n && (s.mainThumbDO = u),
                a = 1 + (1 - s.thumbMinAlpha) * (n / (2 * s.carRadiusY)),
            ...
            (FWDVU3DCarUtils.isIE || !FWDVU3DCarUtils.hasTransform3d) && s.sortZ(),
        ...
        s.setIntroFinished = function() {
            ...
            s.addNavigation(),
            (FWDVU3DCarUtils.isIE || !FWDVU3DCarUtils.hasTransform3d) && (s.zSortingId = setInterval(s.sortZ, 16)),
            s._d.slideshowAutoplay && s.slideshowButtonDO && (s.slideshowButtonDO.onClick(),
            s.slideshowButtonDO.onMouseOut())
        }
        ,
        ...
        s.addNavigation = function() {
            s.removeNavigation(),
            s.useDrag && !s.isMobile ? s.setupMobileDrag() : e.useDragAndSwipeOnMobile && s.isMobile && (s.useDrag = !0,
            s.setupMobileDrag())
        }
        ,
        s.goToThumb = function() {
            s.introFinished && (s.isAnim = !0,
            r.removeInfoDO(),
            s.hideVideo(),
            s.showScrollbar && !s.scrollbarDO.isPressed && s.scrollbarDO.gotoItem(s.curId, !0),
            s.isPlaying && (s.slideshowButtonDO.stopSlideshow(!0),
            clearTimeout(s.slideshowTimeoutId),
            s.slideshowTimeoutId = setTimeout(s.startTimeAgain, 800)),
            s.mainThumbDO = s.thumbsAr[s.curId],
            s.mainThumbDO && s.prevCurId != s.curId && s.showCaption_bl && (s.isTextSet ? (s.isTextSet = !1,
            "in" == s.captionPosition ? (s.hideCaption(!0),
            clearTimeout(s.textTimeoutId),
            s.textTimeoutId = setTimeout(s.setCaption, 850)) : s.setCaption()) : "in" == s.captionPosition ? (clearTimeout(s.textTimeoutId),
            s.textTimeoutId = setTimeout(s.setCaption, 850)) : s.setCaption()),
            clearTimeout(s.thumbsTweenDone_to),
            ...
            s.dispatchEvent(o.THUMB_CHANGE, {
                id: s.curId
            }))
        }
        ,
        ...
        s.reorderCarousel = function() {
            if (s.thumbsAr[s.curId]) {
                var e = s.normAngle(s.thumbsAr[s.curId].carAngle * (180 / Math.PI)) % 360, t;
                0 <= e && 180 >= e ? t = -e : 180 < e && (t = 360 - e);
                for (var o = 0, r; o < s.totalThumbs; o++) {
                    r = s.thumbsAr[o],
                    s.useDrag || r.updateButtonMode();
                    var n = r.carAngle + t * (Math.PI / 180), a = 0, l = 0, d;
                    if (l = o < s.curId ? o - s.curId + s.totalThumbs : o - s.curId,
                    o != s.curId)
                        switch (s.topology) {
                        case "ring":
                    ...
                    a = Math.round(a) % 360,
                    d = s.normAngle(Math.round(r.getAngleX())) % 360,
        ...
        s.updateCarousel = function() {
            for (var e = 0, t, o, r, n, a; e < s.totalThumbs; e++)
                a = s.thumbsAr[e],
                t = s.carRadiusX * Math.cos(a.carAngle),
                o = s.carRadiusY * Math.cos(a.carAngle + Math.PI / 2),
                r = s.carRadiusY * Math.cos(a.carAngle) - s.carRadiusY,
                0 == r && (s.mainThumbDO = a),
                t -= Math.floor(s.thumbWidth / 2),
                o -= Math.floor(s.thumbHeight / 2),
                a.setX(t),
                a.setY(o),
                a.setZ(r),
                n = 1 + (1 - s.thumbMinAlpha) * (r / (2 * s.carRadiusY)),
                a.setAlpha(n),
                a.screen.style.pointerEvents = FWDVU3DCarUtils.isSafari && r < -s.carRadiusY ? "none" : "auto",
                a.newZ = Math.floor(r)
        }
        ,
        s.sortZ = function() {
            for (var e = 0, t, o; e < s.totalThumbs; e++)
                o = s.thumbsAr[e],
                t = Math.floor(o.newZ),
                o.setZIndex(t + Math.floor(2 * s.carRadiusX) + 1)
        }
        ,
        s.thumbsTweenDone = function() {
            var e = s.thumbsAr[s.curId];
            e && (e.setX(Math.round(e.x)),
        ...
        s.setupVideo = function() {
            ...
            e.useVideo && (s.vidHld_do = new FWDVU3DCarDO3D("div"),
            FWDVU3DCarUtils.isMAC ? s.vidHld_do.setZ(100000008) : (s.vidHld_do.hasT3D = !1,
            s.vidHld_do.hasT2D = !1),
            ...
            FWDVU3DCarSimpleButton.setPrototype(!0),
            s.playBtnDO = e.useVectorIcons ? new FWDVU3DCarSimpleButton(0,0,"<div class='table-fwdevp-button'><span class='table-cell-fwdevp-button fwdvu3dcar-icon fwdvu3dcar-icon-play'></span></div>","EVPLargePlayButtonNormalState","selected") : new FWDVU3DCarSimpleButton(s._d.largePlayNImg,s._d.largePlaySPath),
            FWDVU3DCarUtils.isMAC && s.playBtnDO.setZ(100000009),
        ...
        s.playBtnOnClick = function() {
            s.videoStarted = !0,
            s.positionVideo(),
            s.evp.largePlayButtonUpHandler()
        }
        ,
        s.hideVideo = function() {
            r.preloaderDO.hide(),
            s.videoStarted = !1,
            s.curDataListAr[s.curId] && (s.thumbVideoSrc = s.curDataListAr[s.curId].thumbVideoSrc);
            s.curDataListAr[s.curId] && e.useVideo && (clearTimeout(s.updateVideoTo),
            s.hidePassWindow(),
            s.hidePlayButton(!0),
            ...
            s.evp && (s.evp.notShowPlayBtnExternal = !0,
            s.evp._d.autoPlay_bl = !1,
            s.evp.pause(),
            !s.thumbVideoSrc && s.evp.goNormalScreen()),
            s.positionVideo(!0))
        }
        ,
        s.positionVideo = function(t) {
            function o() {
                var e = parseFloat(s.mainThumbDO.getRect().width).toFixed(3), t = parseFloat(s.mainThumbDO.getRect().height).toFixed(3), o;
                s.vidHld_do.setWidth(e - 2 * (s.borderSize * s.scale) + 1);
                var n = parseFloat(s.vidHld_do.getRect().width).toFixed(3)
                  , i = parseFloat(e).toFixed(3);
                i < n && (e += 1,
                o = -1),
                s.vidHld_do.setWidth(Math.round(e - 2 * (s.borderSize * s.scale))),
                s.vidHld_do.setHeight(t - 2 * (s.borderSize * s.scale));
                var a = parseFloat(s.vidHld_do.getRect().height).toFixed(3)
                  , l = parseFloat(t).toFixed(3);
                l < a && (t += 1,
                o = -1),
                s.centerThumbW = e,
                s.centerThumbH = t,
                ...
                s.videoStarted ? (s.vidHld_do.setX(Math.round(s.centerThumbX + s.borderSize * s.scale) + o),
                s.vidHld_do.setY(Math.round(s.centerThumbY + s.borderSize * s.scale))) : s.vidHld_do.setX(-5e3),
                s.isEvpFS ? (s.playBtnDO.setX(Math.round((r.vwSize.w - s.playBtnDO.w) / 2)),
                s.playBtnDO.setY(Math.round((r.vwSize.h - s.playBtnDO.w) / 2))) : (s.playBtnDO.setX(Math.round(s.centerThumbX + (s.vidHld_do.w - s.playBtnDO.w) / 2)),
                s.playBtnDO.setY(Math.round(s.centerThumbY + (s.vidHld_do.h - s.playBtnDO.h) / 2)))
            }
            return e.useVideo ? !s.thumbVideoSrc || t ? (s.playBtnDO.setX(-5e3),
            void s.vidHld_do.setX(-5e3)) : void (o(),
            setTimeout(function() {
            ...
            if (e.useVideo && s.thumbVideoSrc)
                if (!s.evpInst) {
                    function o() {
                        ...
                        s.evp ? (s.evp.addListener(FWDEVPlayer.READY, s.evpReady),
                        ...
                        s.evp.addListener(FWDEVPlayer.GO_NORMALSCREEN, s.evpNS)) : d = clearTimeout(d, 50)
                    }
                    s.isLoading = !0,
                    s.evpInst = !0,
                    FWDEVPUtils.hasTransform3d = FWDVU3DCarUtils.hasTransform3d,
                    FWDEVPUtils.hasTransform2d = FWDVU3DCarUtils.hasTransform2d;
                    ...
                    s.nextVideoAutoPlay && (s.playAudio(),
                    s.type != FWDVU3DCar.AUDIO && (s.slideshowButtonDO.pause(),
                    s.videoStarted = !0))
        }
        ,
        s.evpReady = function() {
        ...
        s.showLargePlayButton = function() {
            r.preloaderDO.hide(),
            s.videoStarted ? s.playBtnDO.show() : s.playBtnDO.show(.15)
        }
        ,
        ...
        s.evpPlayStart = function() {
            ...
            r.preloaderDO.hide(),
            s.evp.notShowLargePlayButton_bl = !1,
            s.videoStarted = !0,
            s.positionVideo()
        }
        ,
        s.playAudio = function() {
            if (s.evp && s.type == FWDVU3DCar.AUDIO && s.clicked) {
                if (FWDVU3DCarUtils.isIOS && !s.audioPlayed)
                    return;
                s.slideshowButtonDO.pause(),
                s.evp.play(),
                s.videoStarted = !0
        ...
        s.evpVolume = function(t) {
            s.isAnim || s.evp._d.autoPlay_bl || (s.volume = t.volume,
            s.type == FWDVU3DCar.YOUTUBE ? s.youtubePlayed = !0 : s.type == FWDVU3DCar.VIDEO ? s.videoPlayed = !0 : s.type == FWDVU3DCar.AUDIO && (s.audioPlayed = !0))
        }
        ,
        s.evpPlay = function() {
            return s.isAnim ? (s.evp.notShowPlayBtnExternal = !0,
            void s.evp.pause()) : void (s.clicked && (FWDVU3DCarUtils.isMAC && s.type == FWDVU3DCar.VIDEO && !s.videoPlayed ? s.evp.setupAPT() : (!FWDVU3DCarUtils.isIOS || (s.type != FWDVU3DCar.VIDEO || s.videoPlayed) && (s.type != FWDVU3DCar.VIMEO || s.vimeoPlayed) && (s.type != FWDVU3DCar.YOUTUBE || s.youtubePlayed)) && (!s.isMobile || s.videoPlayed) ? setTimeout(function() {
                s.evp.setVolume(s.volume, !0)
            }, 10) : s.evp.setupAPT()),
            !FWDVU3DCarUtils.isIOS && (s.audioPlayed = !0,
            s.videoPlayed = !0))
        }
        ,
        s.evpPlayComplete = function() {
            if (s.videoStarted = !1,
            s.nextVideoAutoPlay || !s.slideshowButtonDO.isStopped) {
                s.curId += 1,
                0 > s.curId ? s.curId = s.totalThumbs - 1 : s.curId > s.totalThumbs - 1 && (s.curId = 0);
                var e = s.curDataListAr[s.curId].type;
                e == FWDVU3DCar.VIDEO || e == FWDVU3DCar.YOUTUBE || e == FWDVU3DCar.VIMEO || e == FWDVU3DCar.AUDIO ? s.goToThumb() : !s.slideshowButtonDO.isStopped && s.goToThumb()
            }
        }
        ,
        s.evpStop = function() {
            ...
            s.hidePlayButton(),
            s.positionVideo(),
            "in" != s.captionPosition || s.isAnim || (s.hideCaption(),
            s.onThumbOutHandler(!0, !0))
        }
        ,
        s.evpPause = function() {
        ...
        ,
        s.evpFS = function() {
            s.so = FWDVU3DCarUtils.getScrollOffsets(),
            s.fsX = s.so.x,
            s.fsY = s.so.y,
            ...
            s.positionVideo(),
            s.resizeHandler(!1, !0),
            r.dispatchEvent(FWDVU3DCar.GO_FULLSCREEN)
        }
        ,
        s.evpNS = function(t) {
            s.so = FWDVU3DCarUtils.getScrollOffsets(),
            ...
            s.resizeHandler(!1, !0),
            r.menuDO && r.menuDO.position(),
            FWDVU3DCarUtils.isMAC && setTimeout(function() {
                s.resizeHandler(!1, !0),
                r.menuDO && r.menuDO.position()
            }, 800),
            r.dispatchEvent(FWDVU3DCar.GO_NORMALSCREEN)
        }
        ,
        ...
        s.updateEVPCursor = function(e) {
            s.evp && (!s.useDrag || s.isEvpFS || s.evp.isFullScreen_bl ? s.evp.dClk_do && (s.evp.dClk_do.style().cursor = s.defaultC) : (!e && (e = s.handC),
            s.evp.dClk_do && (s.evp.dClk_do.style().cursor = e)))
        }
        ,
        ...
        s.setupControls = function() {
            s.controlsDO = new FWDVU3DCarDO3D("div"),
            ...
            setTimeout(function() {
                s.controlsHeight = s.nextButtonDO.h,
                s.controlsDO.setHeight(s.controlsHeight),
                s.resizeHandler()
            }, 10)
        }
        ,
        s.showControls = function() {
            s.hideControls(),
            s.isControlsShowed = !0,
            FWDAnimation.to(s.controlsDO, .8, {
                alpha: 1,
                y: s.controlsY,
                ease: Expo.easeInOut
            })
        ...
        s.hideControls = function(e) {
            if (s.controlsDO) {
                ...
                s.showBulletsNavigation && (s.controlsDO = s.bulletsNavigationDO,
                t = s.controlsY),
                FWDAnimation.killTweensOf(s.controlsDO),
                e ? FWDAnimation.to(s.controlsDO, .8, {
                    alpha: 0,
                    y: t,
                    ease: Expo.easeOut
                }) : (s.controlsDO.setAlpha(0),
                s.controlsDO.setY(t))
            }
        }
        ,
        s.positionControls = function(t) {
            s.controlsWidth = 0;
            var o;
            s.isControlsShowed && (FWDAnimation.killTweensOf(s.controlsDO),
            s.controlsDO.setAlpha(1)),
            ...
            s.showScrollbar ? (s.scrollbarDO.resize(s.stageWidth - 2 * s.nextAndPrevButtonsOffsetX, s.controlsWidth),
            s.showScrollbar && s.scrollbarDO.trackWidth ? (s.showNextAndPrevButtons && s.scrollbarDO.setX(s.prevButtonDO.w + s.nextAndPrevButtonsOffsetX),
            o = s.scrollbarDO.x + s.scrollbarDO.getWidth() + s.nextAndPrevButtonsOffsetX) : o = 0) : (s.scrollbarDO.setX(-1e3),
            o = s.showNextAndPrevButtons ? s.nextButtonDO.w + s.nextAndPrevButtonsOffsetX : 0),
            s.showNextAndPrevButtons ? ((!s.showScrollbar || !s.scrollbarDO.trackWidth) && (s.showSlideshowButton && (s.controlsWidth += s.slideshowButtonDO.w),
            o = s.controlsWidth - s.nextButtonDO.w),
            s.nextButtonDO.setX(o)) : (s.nextButtonDO.setX(-200),
            s.prevButtonDO.setX(-200)),
            e.showSlideshowButton ? (s.showScrollbar && s.scrollbarDO.trackWidth ? o -= s.slideshowButtonDO.w + s.nextAndPrevButtonsOffsetX : (!s.showScrollbar || !s.scrollbarDO.trackWidth) && (o = Math.round((s.controlsWidth - s.slideshowButtonDO.w) / 2)),
            s.slideshowButtonDO.setX(o)) : s.slideshowButtonDO.setX(-200),
            s.showScrollbar ? (s.controlsDO.setX(Math.floor((s.stageWidth - (s.controlsWidth + s.scrollbarDO.getWidth())) / 2)),
            s.controlsDO.setWidth(s.controlsWidth + s.scrollbarDO.getWidth())) : (s.controlsDO.setX(Math.floor((s.stageWidth - s.controlsWidth) / 2)),
            s.controlsDO.setWidth(s.controlsWidth));
            var n;
            s.showBulletsNavigation ? (s.bulletsNavigationDO.setX(Math.floor((s.stageWidth - s.bulletsNavigationDO.w) / 2)),
            ...
            s.controlsDO.setX(Math.floor((s.stageWidth - s.controlsDO.w) / 2))) : s.bulletsNavigationDO.setX(-1e4),
            ...
            s.controlsY = n,
            FWDAnimation.killTweensOf(s.controlsDO),
            t ? FWDAnimation.to(s.controlsDO, .8, {
                y: s.controlsY,
                ease: Quint.easeOut
            }) : s.controlsDO.setY(s.controlsY)
        }
        ,
        s.setupBulletsNavigation = function() {
            FWDVU3DCarBulletsNavigation.setPrototype(),
            s.bulletsNavigationDO = new FWDVU3DCarBulletsNavigation(s._d,s.totalThumbs,s.curId),
            s.bulletsNavigationDO.addListener(FWDVU3DCarBulletsNavigation.BULLET_CLICK, s.bulletNavigationClick),
            s.addChild(s.bulletsNavigationDO)
        }
        ,
        s.bulletNavigationClick = function(t) {
            s.isLoading || (s.curId = t.id,
            s.goToThumb())
        }
        ,
        s.setupPrevButton = function() {
            FWDVU3DCarSimpleButton.setPrototype();
            var t = "fwdvu3dcar-button";
            e.isSkinWhite && (t = "fwdvu3dcar-button white"),
            s.prevButtonDO = e.useVectorIcons ? new FWDVU3DCarSimpleButton(0,0,"<span class=\"fwdvu3dcar-icon fwdvu3dcar-icon-prev\"></span>",t,"selected") : new FWDVU3DCarSimpleButton(s._d.prevButtonNImg,s._d.prevButtonSPath),
            s.prevButtonDO.screen.className = "fwdvu3dcar-prev-button",
            s.prevButtonDO.addListener(FWDVU3DCarSimpleButton.CLICK, s.prevButtonOnClickHandler),
            s.controlsDO.addChild(s.prevButtonDO)
        }
        ,
        s.prevButtonOnClickHandler = function() {
            s.isLoading || (0 < s.curId ? s.curId-- : s.curId = s.totalThumbs - 1,
            s.goToThumb())
        }
        ,
        s.setupNextButton = function() {
            ...
            var t = "fwdvu3dcar-button";
            e.isSkinWhite && (t = "fwdvu3dcar-button white"),
            s.nextButtonDO = e.useVectorIcons ? new FWDVU3DCarSimpleButton(0,0,"<span class=\"fwdvu3dcar-icon fwdvu3dcar-icon-next\"></span>",t,"selected") : new FWDVU3DCarSimpleButton(s._d.nextButtonNImg,s._d.nextButtonSPath),
            s.nextButtonDO.screen.className = "fwdvu3dcar-next-button",
            s.nextButtonDO.addListener(FWDVU3DCarSimpleButton.CLICK, s.nextButtonOnClickHandler),
        ...
        s.nextButtonOnClickHandler = function() {
            s.isLoading || (s.curId < s.totalThumbs - 1 ? s.curId++ : s.curId = 0,
            s.goToThumb())
        }
        ,
        s.setupSlideshowButton = function() {
            FWDVU3DCarSlideshowButton.setPrototype(),
            s.slideshowButtonDO = new FWDVU3DCarSlideshowButton(s,s._d),
            s.prevButtonDO.screen.className = "fwdvu3dcar-slideshow-button",
            s.slideshowButtonDO.addListener(FWDVU3DCarSlideshowButton.PLAY_CLICK, s.onSlideshowButtonPlayClickHandler),
            s.slideshowButtonDO.addListener(FWDVU3DCarSlideshowButton.PAUSE_CLICK, s.onSlideshowButtonPauseClickHandler),
            s.slideshowButtonDO.addListener(FWDVU3DCarSlideshowButton.TIME, s.onSlideshowButtonTime),
            ...
            s.showSlideshowButton || (s.slideshowButtonDO.setVisible(!1),
            s.controlsWidth -= s.slideshowButtonDO.getWidth())
        }
        ,
        ...
        s.startSlideshow = function() {
            s.isPlaying || (s.isPlaying = !0,
            s.slideshowButtonDO.start(),
            s.slideshowButtonDO.onMouseOut())
        }
        ,
        s.stopSlideshow = function() {
            s.isPlaying && (s.isPlaying = !1,
            clearTimeout(s.slideshowTimeoutId),
            s.slideshowButtonDO.stop(),
            s.slideshowButtonDO.onMouseOut())
        }
        ,
        s.onSlideshowButtonTime = function() {
            s.isLoading || (s.curId == s.totalThumbs - 1 ? s.curId = 0 : s.curId++,
            s.goToThumb())
        }
        ,
        ...
        s.setupScrollbar = function() {
            FWDVU3DCarScrollbar.setPrototype(),
            s.scrollbarDO = new FWDVU3DCarScrollbar(s._d,s.totalThumbs,s.curId,s),
            s.scrollbarDO.addListener(FWDVU3DCarScrollbar.MOVE, s.onScrollbarMove),
        ...
        s.addMouseWheelSupport = function() {
            s.prt.mainDO.screen.addEventListener("mousewheel", s.mouseWheelHandler),
            s.prt.mainDO.screen.addEventListener("DOMMouseScroll", s.mouseWheelHandler)
        }
        ,
        ...
        s.setupMobileDrag = function() {
            1 >= s.totalThumbs || (s.hasPointerEvent ? s.prt.mainDO.screen.addEventListener("pointerdown", s.mobileDragStartHandler) : s.isMobile ? s.prt.mainDO.screen.addEventListener("touchstart", s.mobileDragStartHandler) : s.prt.mainDO.screen.addEventListener("mousedown", s.mobileDragStartHandler))
        }
        ,
        s.mobileDragStartHandler = function(o) {
            if (!(r.menuDO && r.menuDO.isShowed_bl || s.isLoading) && s.introFinished && s.allowToSwitchCat && !s.isLoading) {
                ...
                s.vmcX = e.screenX,
                s.vmcY = e.screenY,
                FWDVU3DCarUtils.hitTest(s.controlsDO.screen, s.vmcX, s.vmcY) || FWDVU3DCarUtils.hitTest(s.bulletsNavigationDO.screen, s.vmcX, s.vmcY) || s.evp && s.evp.controller_do && (FWDVU3DCarUtils.hitTest(s.evp.controller_do.mainHolder_do.screen, e.screenX, e.screenY) || FWDVU3DCarUtils.hitTest(s.playBtnDO.screen, e.screenX, e.screenY) || s.evp.apt && FWDVU3DCarUtils.hitTest(s.evp.apt.screen, e.screenX, e.screenY)) || s.isEvpFSDL || (s.mouseY = s.lastPressedY = e.screenY,
                s.lastDragNumber = 100,
                s.dragCurId = s.curId,
                s.useDrag && (s.style().cursor = s.grabC,
                r.mainDO.style().cursor = s.grabC,
                "in" == s.captionPosition && s.textHolderDO && (s.textHolderDO.style().cursor = s.grabC),
                s.updateEVPCursor(s.grabC)),
                s.hasPointerEvent ? (t.addEventListener("pointerup", s.mobileDragEndHandler),
                t.addEventListener("pointermove", s.mobileDragMoveHandler)) : s.isMobile ? (t.addEventListener("touchend", s.mobileDragEndHandler),
                t.addEventListener("touchmove", s.mobileDragMoveHandler, {
                    passive: !1
                })) : (t.addEventListener("mouseup", s.mobileDragEndHandler),
                t.addEventListener("mousemove", s.mobileDragMoveHandler)))
            }
        }
        ,
        s.mobileDragMoveHandler = function(t) {
            t.preventDefault && t.preventDefault();
            var e = FWDVU3DCarUtils.getViewportMouseCoordinates(t);
            if (Math.abs(s.lastPressedY - e.screenY) && (s.disableThumbClick = !0,
            s.showDsb()),
            s.useDrag) {
                s.curDragNumber = parseInt((s.mouseY - s.lastPressedY) / 100);
                var o = "none";
                0 < s.mouseY - s.lastPressedY ? o = "minus" : 0 > s.mouseY - s.lastPressedY && (o = "plus"),
                "plus" == o ? -1 == s.curId ? s.curId = s.totalThumbs - 1 : s.lastDragNumber != s.curDragNumber && (--s.curId,
                s.lastPressedY = e.screenY) : "minus" == o && (s.curId == s.totalThumbs ? s.curId = 0 : s.lastDragNumber != s.curDragNumber && (s.curId++,
                s.lastPressedY = e.screenY)),
                s.updateEVPCursor(s.handC)
            }
            s.mouseY = e.screenY,
            s.curId != s.prevCurId && s.goToThumb(),
            s.lastDragNumber = s.curDragNumber
        }
        ,
        s.mobileDragEndHandler = function() {
            ...
            s.useDrag && !s.isMobile && (s.style().cursor = s.handC,
            r.mainDO.style().cursor = s.handC,
            "in" == s.captionPosition && s.textHolderDO && (s.textHolderDO.style().cursor = s.handC)),
            s.hasPointerEvent ? (t.removeEventListener("pointerup", s.mobileDragEndHandler),
            t.removeEventListener("pointermove", s.mobileDragMoveHandler)) : s.isMobile ? (t.removeEventListener("touchend", s.mobileDragEndHandler),
            t.removeEventListener("touchmove", s.mobileDragMoveHandler)) : (t.removeEventListener("mouseup", s.mobileDragEndHandler),
            t.removeEventListener("mousemove", s.mobileDragMoveHandler))
        }
        ,
        s.removeMobileDrag = function() {
            s.hasPointerEvent ? (s.prt.mainDO.screen.removeEventListener("pointerdown", s.mobileDragStartHandler),
            t.removeEventListener("pointerup", s.mobileDragEndHandler),
            t.removeEventListener("pointermove", s.mobileDragMoveHandler)) : s.isMobile ? t.addEventListener && (s.prt.mainDO.screen.removeEventListener("touchstart", s.mobileDragStartTest),
            t.removeEventListener("touchmove", s.mobileDragMoveTest),
            t.removeEventListener("touchmove", s.mobileDragMoveHandler),
            t.removeEventListener("touchend", s.mobileDragEndTest)) : (s.prt.mainDO.screen.removeEventListener("mousedown", s.mobileDragStartHandler),
        ...
        s.addKeyboardSupport = function() {
            ...
            document.addEventListener("keyup", s.onKeyUpHandler)
        }
        ,
        s.onKeyDownHandler = function(t) {
            if (s.introFinished && s.allowToSwitchCat && !s.isLoading && !FWDVU3DCar.rlShowed && !(s.showScrollbar && s.scrollbarDO.isPressed) && !(r.lightboxDO && r.lightboxDO.isShowed_bl) && !(s.evp && s.evp.isPlaying_bl || s.isEvpFS) && !(0 > r.stageContainer.getBoundingClientRect().top + r.stageHeight))
                if (document.removeEventListener("keydown", s.onKeyDownHandler),
                39 == t.keyCode) {
                    if (s.curId < s.totalThumbs - 1 ? s.curId++ : s.curId = 0,
                    s.goToThumb(),
                    t.preventDefault)
                        t.preventDefault();
                    else
                    ...
                    if (0 < s.curId ? s.curId-- : s.curId = s.totalThumbs - 1,
                    s.goToThumb(),
                    t.preventDefault)
                        t.preventDefault();
                    else
        ...
        s.update = function(t) {
            s.updated = !0;
            var e = t.carRadiusX;
            FWDVU3DCarUtils.isIEAndLessThen10 && (newCarRadY /= 1.5),
            FWDAnimation.to(s, .8, {
                carRadiusX: e,
                ease: Quart.easeOut
            }),
            FWDAnimation.to(s, .8, {
                carRadiusY: t.carRadiusY,
                ease: Quart.easeOut
            }),
            s.carXOffset = t.carXOffset,
            s.carouselYRot = t.carouselYRot,
            ...
            var o = Math.floor(s.stageWidth / 2) + s.carXOffset;
            FWDAnimation.to(s.thumbsHolderDO, .8, {
                x: o,
                angleY: -s.carouselYRot,
                ease: Quart.easeOut
            });
            for (var r = 0; r < s.totalThumbs; r++)
                s.thumbsAr[r].update();
            s.goToThumb()
        }
        ,
    ...
    o.setPrototype = function() {
        o.prototype = new FWDVU3DCarDO3D("div","relative","visible")
    }
    ,
...
function(e) {
    var t = function(e, o) {
        ...
        ,
        r.start = function() {
            r.isStopped_bl || (r.timeOutId = setTimeout(r.onTimeHanlder, r.delay),
    ...
    t.setProtptype = function() {
        t.prototype = new FWDVU3DCarEventDispatcher
    }
    ,
    t.START = "start",
    t.STOP = "stop",
...
function(e) {
    ...
    function o() {
        for (var e = ["transform", "msTransform", "WebkitTransform", "MozTransform", "OTransform", "KhtmlTransform"], t; t = e.shift(); )
            if ("undefined" != typeof r.dumy.style[t])
                return !0;
        try {
            document.documentElement.removeChild(r.dumy)
        } catch (t) {}
    ...
    r.splitAndTrim = function(e, t) {
        for (var o = e.split(","), s = o.length, n = 0; n < s; n++)
            t && (o[n] = r.trim(o[n]));
        return o
    }
    ,
    ...
    r.randomizeArray = function(e) {
        for (var t = [], o = e.concat(), r = o.length, s = 0, n; s < r; s++)
    ...
    r.getChildren = function(t, e) {
        for (var o = [], r = t.firstChild; null != r; r = r.nextSibling)
            e ? o.push(r) : 1 === r.nodeType && o.push(r);
        return o
    }
    ,
    r.getChildrenFromAttribute = function(t, e, o) {
        for (var s = [], n = t.firstChild; null != n; n = n.nextSibling)
            o && r.hasAttribute(n, e) ? s.push(n) : 1 === n.nodeType && r.hasAttribute(n, e) && s.push(n);
    ...
    r.getChildFromNodeListFromAttribute = function(t, e, o) {
        for (var s = t.firstChild; null != s; s = s.nextSibling) {
            if (o && r.hasAttribute(s, e))
                return s;
            if (1 === s.nodeType && r.hasAttribute(s, e))
                return s
        }
    }
    ,
    ...
    r.isMobile = function() {
        if (r.hasPointerEvent && 1 < navigator.msMaxTouchPoints || r.hasPointerEvent && 1 < navigator.maxTouchPoints)
            return !0;
        var t = ["android", "webos", "iphone", "ipad", "blackberry", "kfsowi"];
        for (var o in t)
            if (-1 != (navigator.userAgent + "").toLowerCase().indexOf((t[o] + "").toLowerCase()))
                return !0;
    ...
    r.checkIfHasTransofrms = function() {
        r.isReadyMethodCalled_bl || (document.documentElement.appendChild(r.dumy),
        r.hasTransform3d = t(),
        r.hasTransform2d = o(),
    ...
    r.getHashParam = function(e) {
        ...
        if (-1 != o) {
            t = t.substr(o + 1);
            for (var s = t.split("&"), n = s.length, a = [], r; n--; )
                r = s[n].split("="),
                r[0] == e && a.push(r[1]);
            if (0 != a.length)
...
window.FWDAnimation || (((_fwd_fwdScope = "undefined" != typeof fwd_module && fwd_module.exports && "undefined" != typeof fwd_global ? fwd_global : this || window)._fwd_fwdQueue || (_fwd_fwdScope._fwd_fwdQueue = [])).push(function() {
    ...
    function d(g, b, O, i, r, y) {
        var v = {}, c = [], d = y || g[0], m, T, x, I, P, H, k, B;
        for (T in r = "string" == typeof r ? "," + r + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,",
        null == b && (b = 1),
        g[0])
            c.push(T);
        if (1 < g.length) {
        ...
        for (w.length = C.length = S.length = 0,
        m = c.length; -1 < --m; )
            T = c[m],
            _[T] = -1 !== r.indexOf("," + T + ","),
            v[T] = function(d, c, e, i) {
                var r = [], p, m, g, b, _, f;
                if (i)
                    for (m = (d = [i].concat(d)).length; -1 < --m; )
                        "string" == typeof (f = d[m][c]) && "=" === f.charAt(1) && (d[m][c] = i[c] + +(f.charAt(0) + f.substr(2)));
                if (0 > (p = d.length - 2))
                    return r[0] = new u(d[0][c],0,0,d[-1 > p ? 0 : 1][c]),
                    r;
                for (m = 0; m < p; m++)
                    g = d[m][c],
                    b = d[m + 1][c],
                    ...
                    w[m] = (w[m] || 0) + (b - g) * (b - g),
                    C[m] = (C[m] || 0) + (_ - b) * (_ - b));
                return r[m] = new u(d[m][c],0,0,d[m + 1][c]),
                r
            }(g, T, _[T], y);
        for (m = w.length; -1 < --m; )
            w[m] = Math.sqrt(w[m]),
        ...
        if (!i) {
            for (m = c.length; -1 < --m; )
                if (_[T])
                    for (H = (x = v[c[m]]).length - 1,
                    I = 0; I < H; I++)
                        P = x[I + 1].da / C[I] + x[I].da / w[I] || 0,
                        S[I] = (S[I] || 0) + P * P;
            for (m = S.length; -1 < --m; )
                S[m] = Math.sqrt(S[m])
        }
        ...
        I = O ? 4 : 1; -1 < --m; )
            (function(b, t, e, i, r) {
                for (var s = b.length - 1, g = 0, O = b[0].a, T = 0, I, P, H, k, B, L, A, M, E, W, R, F; T < s; T++)
                    I = (k = b[g]).a,
                    P = k.d,
                    H = b[g + 1].d,
                    A = r ? (W = w[T],
                    F = .25 * (((R = C[T]) + W) * t) / (!i && S[T] || .5),
                    P - ((B = P - (P - I) * (i ? .5 * t : 0 === W ? 0 : F / W)) + (((L = P + (H - P) * (i ? .5 * t : 0 === R ? 0 : F / R)) - B) * (3 * W / (W + R) + .5) / 4 || 0))) : P - ((B = P - .5 * ((P - I) * t)) + (L = P + .5 * ((H - P) * t))) / 2,
                    B += A,
                    L += A,
                    k.c = M = B,
                    k.b = 0 == T ? O = k.a + .6 * (k.c - k.a) : O,
                    k.da = P - I,
                    k.ca = M - I,
                    k.ba = O - I,
                    e ? (E = D(I, O, M, P),
                    b.splice(g, 1, E[0], E[1], E[2], E[3]),
                    g += 4) : g++,
                    O = L;
                (k = b[g]).b = O,
                k.c = O + .4 * (k.d - O),
            ...
            k && (x.splice(0, I),
            x.splice(x.length - I, I));
        return v
    }
    var o, w, C, S, _, r, y, e;
    _fwd_fwdScope.FWDFWD_fwdDefine("FWDAnimation", ["core.FWDAnimation", "core.FWDSimpleTimeline", "FWDTweenLite"], function(O, d, D) {
        function g(o) {
        ...
        function a(o, t, e) {
            ...
            for (n in i)
                a = i[n],
                o[n] = "function" == typeof a ? a(e, t[e]) : a[e % a.length];
            delete o.cycle
        }
        function o(u, t, c, h) {
            t = !1 !== t,
            c = !1 !== c;
            for (var m = p(h = !1 !== h), a = t && c && h, o = m.length, g, b; -1 < --o; )
                b = m[o],
                (a || b instanceof d || (g = b.target === b.vars.onComplete) && c || t && !g) && b.paused(u)
        }
        ...
        e.updateTo = function(o, t) {
            var e = this.ratio, r = this.vars.immediateRender || o.immediateRender, s;
            for (s in t && this._startTime < this._timeline._time && (this._startTime = this._timeline._time,
            this._uncache(!1),
            ...
            if (this._initted || r)
                ...
                this._notifyPluginsOfEnabled && this._firstPT && D._onPluginEvent("_onDisable", this),
        ...
        e.render = function(b, O, e) {
            ...
            var v = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time, _ = this._totalTime, c = this._cycle, d = this._duration, m = this._rawPrevTime, g, D, w, T, C, S, x, I, P;
            if (v - 1e-7 <= b ? (this._totalTime = v,
            ...
            0 === d && (!this._initted && this.vars.lazy && !e || (this._startTime === this._timeline._duration && (b = 0),
            (0 > m || 0 >= b && -1e-7 <= b || m === y && "isPause" !== this.data) && m !== b && (e = !0,
            y < m && (D = "onReverseComplete")),
            this._rawPrevTime = I = !O || b || m === b ? b : y))) : 1e-7 > b ? (this._totalTime = this._time = this._cycle = 0,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== _ || 0 === d && 0 < m) && (D = "onReverseComplete",
            g = this._reversed),
            0 > b && (this._active = !1,
            0 === d && (!this._initted && this.vars.lazy && !e || (0 <= m && (e = !0),
            this._rawPrevTime = I = !O || b || m === b ? b : y))),
            this._initted || (e = !0)) : (this._totalTime = this._time = b,
            0 !== this._repeat && (T = d + this._repeatDelay,
            ...
            this._easeType ? (C = this._time / d,
            (1 === (S = this._easeType) || 3 === S && .5 <= C) && (C = 1 - C),
            3 === S && (C *= 2),
            1 === (x = this._easePower) ? C *= C : 2 === x ? C *= C * C : 3 === x ? C *= C * C * C : 4 === x && (C *= C * C * C * C),
            this.ratio = 1 === S ? 1 - C : 2 === S ? C : .5 > this._time / d ? C / 2 : 1 - C / 2) : this.ratio = this._ease.getRatio(this._time / d)),
            p !== this._time || e || c !== this._cycle) {
                ...
                0 === _ && (2 === this._initted && 0 < b && this._init(),
                ...
                w = this._firstPT; w; )
                    w.f ? w.t[w.p](w.c * this.ratio + w.s) : (P = w.c * this.ratio + w.s,
                    "x" == w.p ? w.t.setX(P) : "y" == w.p ? w.t.setY(P) : "z" == w.p ? w.t.setZ(P) : "angleX" == w.p ? w.t.setAngleX(P) : "angleY" == w.p ? w.t.setAngleY(P) : "angleZ" == w.p ? w.t.setAngleZ(P) : "w" == w.p ? w.t.setWidth(P) : "h" == w.p ? w.t.setHeight(P) : "alpha" == w.p ? w.t.setAlpha(P) : "scale" == w.p ? w.t.setScale2(P) : w.t[w.p] = P),
                    w = w._next;
                this._onUpdate && (0 > b && this._startAt && this._startTime && this._startAt.render(b, O, e),
                O || this._totalTime === _ && !D || this._callback("onUpdate")),
                this._cycle !== c && (O || this._gc || this.vars.onRepeat && this._callback("onRepeat")),
                D && (this._gc && !e || (0 > b && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(b, O, e),
                g && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                this._active = !1),
                !O && this.vars[D] && this._callback(D),
                0 === d && this._rawPrevTime === y && I !== y && (this._rawPrevTime = 0)))
            } else
                _ !== this._totalTime && this._onUpdate && (O || this._callback("onUpdate"))
        }
        ,
        O.to = function(o, t, e) {
            return new O(o,t,e)
        ...
        O.fromTo = function(o, t, e, s) {
            return s.startAt = e,
            s.immediateRender = 0 != s.immediateRender && 0 != e.immediateRender,
            new O(o,t,s)
        }
        ,
        O.staggerTo = O.allTo = function(m, b, y, i, T, s, n) {
            function C() {
                y.onComplete && y.onComplete.apply(y.onCompleteScope || this, arguments),
                T.apply(n || y.callbackScope || this, s || t)
            }
            i = i || 0;
            var o = 0, S = [], _ = y.cycle, c = y.startAt && y.startAt.cycle, x, I, P, H;
            for (w(m) || ("string" == typeof m && (m = D.selector(m) || m),
            v(m) && (m = g(m))),
            m = m || [],
            0 > i && ((m = g(m)).reverse(),
            i *= -1),
            ...
            P = 0; P <= x; P++) {
                ...
                delete I.duration)),
                c) {
                    for (H in c = I.startAt = {},
                    y.startAt)
                        c[H] = y.startAt[H];
                    a(I.startAt, m, P)
                }
                I.delay = o + (I.delay || 0),
                P === x && T && (I.onComplete = C),
                S[P] = new O(m[P],b,I),
                o += i
            }
            return S
        ...
        ,
        O.staggerFrom = O.allFrom = function(o, t, e, i, r, s, n) {
            return e.runBackwards = !0,
            e.immediateRender = 0 != e.immediateRender,
            O.staggerTo(o, t, e, i, r, s, n)
        }
        ,
        O.staggerFromTo = O.allFromTo = function(l, t, e, i, r, s, n, a) {
            return i.startAt = e,
            i.immediateRender = 0 != i.immediateRender && 0 != e.immediateRender,
            O.staggerTo(l, t, i, r, s, n, a)
        }
        ,
        ...
        ;
        var c = function(o, t) {
            for (var e = [], n = 0, a = o._first; a; )
                a instanceof D ? e[n++] = a : (t && (e[n++] = a),
                n = (e = e.concat(c(a, t))).length),
                a = a._next;
            return e
        }
          , p = O.getAllTweens = function(e) {
            return c(O._rootTimeline, e).concat(c(O._rootFramesTimeline, e))
        }
        ;
        return O.killAll = function(u, t, c, m) {
            null == t && (t = !0),
            null == c && (c = !0);
            for (var r = p(0 != m), a = r.length, o = t && c && m, l = 0, g, b; l < a; l++)
                b = r[l],
                (o || b instanceof d || (g = b.target === b.vars.onComplete) && c || t && !g) && (u ? b.totalTime(b._reversed ? 0 : b.totalDuration()) : b._enabled(!1, !1))
        }
        ,
        O.killChildTweensOf = function(d, u) {
            if (null != d) {
                var e = l.tweenLookup, o, c, h, p, m;
                if ("string" == typeof d && (d = D.selector(d) || d),
                v(d) && (d = g(d)),
                w(d))
                    for (p = d.length; -1 < --p; )
                        O.killChildTweensOf(d[p], u);
                else {
                    for (h in o = [],
                    e)
                        for (c = e[h].target.parentNode; c; )
                            c === d && (o = o.concat(e[h].tweens)),
                            c = c.parentNode;
                    for (m = o.length,
                    p = 0; p < m; p++)
                        u && o[p].totalTime(o[p].totalDuration()),
                        o[p]._enabled(!1, !1)
                }
            }
        }
        ...
        O.globalTimeScale = function(o) {
            var r = O._rootTimeline
              , s = D.ticker.time;
            return arguments.length ? (o = o || y,
            r._startTime = s - (s - r._startTime) * r._timeScale / o,
            r = O._rootFramesTimeline,
            s = D.ticker.frame,
            r._startTime = s - (s - r._startTime) * r._timeScale / o,
            r._timeScale = O._rootTimeline._timeScale = o) : r._timeScale
        }
        ,
        ...
        e.time = function(o, r) {
            ...
            this._yoyo && 0 != (1 & this._cycle) ? o = this._duration - o + this._cycle * (this._duration + this._repeatDelay) : 0 !== this._repeat && (o += this._cycle * (this._duration + this._repeatDelay)),
            this.totalTime(o, r)) : this._time
        }
        ,
    ...
    y = _fwd_fwdScope.FWDFWD_fwdDefine.plugin({
        ...
        init: function(c, t, m) {
            ...
            var i = t.values || [], h = {}, g = i[0], b = t.autoRotate || m.vars.orientToBezier, _, f, O, y, v, D;
            for (_ in this._autoRotate = b ? b instanceof Array ? b : [["x", "y", "rotation", !0 !== b && +b || 0]] : null,
            g)
                this._props.push(_);
            for (O = this._props.length; -1 < --O; )
                ...
                v || h[_] !== i[0][_] && (v = h);
            if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? d(i, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, v) : function(b, O, y) {
                var i = {}, c = "cubic" === (O = O || "soft") ? 3 : 2, d = "soft" === O, m = [], g, v, D, w, T, C, S, x, I, P, H;
                if (d && y && (b = [y].concat(b)),
                null == b || b.length < 1 + c)
                ...
                for (C = m.length; -1 < --C; ) {
                    ...
                    x = b.length,
                    S = 0; S < x; S++)
                        g = null == y ? b[S][I] : "string" == typeof (H = b[S][I]) && "=" === H.charAt(1) ? y[I] + +(H.charAt(0) + H.substr(2)) : +H,
                        d && 1 < S && S < x - 1 && (T[P++] = (g + T[P - 2]) / 2),
                        T[P++] = g;
                    for (x = P - c + 1,
                    S = P = 0; S < x; S += c)
                        g = T[S],
                        ...
                        D = T[S + 2],
                        w = 2 == c ? 0 : T[S + 3],
                        T[P++] = H = 3 == c ? new u(g,v,D,w) : new u(g,(2 * v + g) / 3,(2 * v + D) / 3,D);
                    T.length = P
                }
                return i
            }(i, t.type, h),
            this._segCount = this._beziers[_].length,
            this._timeRes && (D = function(d, t) {
                var c = [], a = [], o = 0, m = 0, g = (t = t >> 0 || 6) - 1, b = [], u = [], _, f, O, y;
                for (_ in d)
                    !function(c, t, e) {
                        for (var i = c.length, m, g, b, O, y, v, D, w, T, C, S; -1 < --i; )
                            ...
                            m = g = 0,
                            w = 1; w <= e; w++)
                                m = g - (g = ((D = 1 / e * w) * D * O + 3 * (T = 1 - D) * (D * y + T * v)) * D),
                                t[S = i * e + w - 1] = (t[S] || 0) + m * m
                    }(d[_], c, t);
                for (O = c.length,
                f = 0; f < O; f++)
                    o += Math.sqrt(c[f]),
            ...
            b = this._autoRotate)
                ...
                b[0]instanceof Array || (this._autoRotate = b = [b]),
                O = b.length; -1 < --O; ) {
                    for (y = 0; 3 > y; y++)
                        _ = b[O][y],
                        this._func[_] = "function" == typeof c[_] && c[_.indexOf("set") || "function" != typeof c["get" + _.substr(3)] ? _ : "get" + _.substr(3)];
                    _ = b[O][2],
                    this._initialRotations[O] = (this._func[_] ? this._func[_].call(this._target) : this._target[_]) || 0,
                    this._overwriteProps.push(_)
                }
            return this._startRatio = m.vars.runBackwards ? 1 : 0,
            !0
        },
        set: function(b) {
            var O = this._segCount, f = this._func, u = this._target, p = b !== this._startRatio, _, D, C, S, I, P, H, k, B;
            if (this._timeRes) {
                if (k = this._lengths,
                B = this._curSeg,
                b *= this._length,
                ...
                b > this._s2 && w < B.length - 1) {
                    ...
                    for (; 0 < w && (this._s1 = B[--w]) >= b; )
                        ;
                    0 === w && b < this._s1 ? this._s1 = 0 : w++,
                    this._s2 = B[w],
                    this._si = w
                }
                I = (w + (b - this._s1) / (this._s2 - this._s1)) * this._prec || 0
            } else
                I = (b - (_ = 0 > b ? 0 : 1 <= b ? O - 1 : O * b >> 0) * (1 / O)) * O;
            for (D = 1 - I,
            w = this._props.length; -1 < --w; )
                C = this._props[w],
                P = (I * I * (S = this._beziers[C][_]).da + 3 * D * (I * S.ca + D * S.ba)) * I + S.a,
                this._mod[C] && (P = this._mod[C](P, u)),
                f[C] ? u[C](P) : "x" == C ? u.setX(P) : "y" == C ? u.setY(P) : "z" == C ? u.setZ(P) : "angleX" == C ? u.setAngleX(P) : "angleY" == C ? u.setAngleY(P) : "angleZ" == C ? u.setAngleZ(P) : "w" == C ? u.setWidth(P) : "h" == C ? u.setHeight(P) : "alpha" == C ? u.setAlpha(P) : "scale" == C ? u.setScale2(P) : u[C] = P;
            if (this._autoRotate)
                for (var L = this._autoRotate, w = L.length, A, M, E, W, R, F, N; -1 < --w; )
                    ...
                    A = A[_],
                    M = S.a + (S.b - S.a) * I,
                    M += ((W = S.b + (S.c - S.b) * I) - M) * I,
                    W += (S.c + (S.d - S.c) * I - W) * I,
                    E = A.a + (A.b - A.a) * I,
                    E += ((R = A.b + (A.c - A.b) * I) - E) * I,
                    R += (A.c + (A.d - A.c) * I - R) * I,
                    P = p ? Math.atan2(R - E, W - M) * N + F : this._initialRotations[w],
                    this._mod[C] && (P = this._mod[C](P, u)),
                    f[C] ? u[C](P) : u[C] = P)
        }
    }),
    ...
    y._cssRegister = function() {
        ...
        e._registerComplexSpecialProp("bezier", {
            parser: function(d, t, c, b, r, _) {
                ...
                _ = new y;
                var O = t.values, h = O.length - 1, f = [], u = {}, p, v, D;
                if (0 > h)
                    return r;
                for (p = 0; p <= h; p++)
                    D = i(d, O[p], b, r, _, h !== p),
                ...
                !u.autoRotate || u.autoRotate instanceof Array || (p = !0 === u.autoRotate ? 0 : +u.autoRotate,
                u.autoRotate = null == D.end.left ? null != D.end.x && [["x", "y", "rotation", p, !1]] : [["left", "top", "rotation", p, !1]]),
                u.autoRotate && (b._transform || b._enableTransforms(!1),
                D.autoRotate = b._target._fwdTransform,
                D.proxy.rotation = D.autoRotate.rotation || 0,
                b._overwriteProps.push("rotation")),
    ...
    ,
    e._mod = function(o) {
        for (var t = this._overwriteProps, s = t.length, n; -1 < --s; )
            (n = o[t[s]]) && "function" == typeof n && (this._mod[t[s]] = n)
    }
    ,
    e._kill = function(o) {
        var t = this._props, s, n;
        for (s in this._beziers)
            if (s in o)
                for (delete this._beziers[s],
                delete this._func[s],
                n = t.length; -1 < --n; )
                    t[n] === s && t.splice(n, 1);
        if (t = this._autoRotate)
            for (n = t.length; -1 < --n; )
                o[t[n][2]] && t.splice(n, 1);
        return this._super._kill.call(this, o)
    }
    ,
    _fwd_fwdScope.FWDFWD_fwdDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "FWDTweenLite"], function(L, V) {
        function B(o, t) {
            return t.toUpperCase()
        }
        function n(e) {
            return he.createElementNS ? he.createElementNS("http://www.w3.org/1999/xhtml", e) : he.createElement(e)
        }
        function a(e) {
        ...
        function j(o, n) {
            var a = (n = n || K).style, s, l;
            if (void 0 !== a[o])
                return o;
            for (o = o.charAt(0).toUpperCase() + o.substr(1),
            s = ["O", "Moz", "ms", "Ms", "Webkit"],
            l = 5; -1 < --l && void 0 === a[s[l] + o]; )
                ;
            return 0 <= l ? (ge = "-" + (be = 3 === l ? "ms" : s[l]).toLowerCase() + "-",
            be + o) : null
        }
        function g(o, t) {
            var l = {}, n, d, c;
            if (t = t || _e(o, null)) {
                if (n = t.length)
                    for (; -1 < --n; )
                        -1 !== (c = t[n]).indexOf("-transform") && Ue !== c || (l[c.replace(u, B)] = t.getPropertyValue(c));
                else
                    for (n in t)
                        -1 !== n.indexOf("Transform") && Xe !== n || (l[n] = t[n]);
            } else if (t = o.currentStyle || o.style)
                for (n in t)
                    "string" == typeof n && void 0 === l[n] && (l[n.replace(u, B)] = t[n]);
            return me || (l.opacity = a(o)),
            d = tt(o, t, !1),
            ...
            l.y = d.y,
            Ge && (l.z = d.z,
            l.rotationX = d.rotationX,
            l.rotationY = d.rotationY,
            l.scaleZ = d.scaleZ),
            l.filters && delete l.filters,
            l
        }
        function y(d, t, e, i, r) {
            var s = {}, l = d.style, u, c, h;
            for (c in e)
                "cssText" !== c && "length" !== c && isNaN(c) && (t[c] !== (u = e[c]) || r && r[c]) && -1 === c.indexOf("Origin") && ("number" != typeof u && "string" != typeof u || (s[c] = "auto" !== u || "left" !== c && "top" !== c ? "" !== u && "auto" !== u && "none" !== u || "string" != typeof t[c] || "" === t[c].replace(b, "") ? u : 0 : ye(d, c),
                void 0 !== l[c] && (h = new We(l,c,l[c],h))));
            if (i)
                for (c in i)
                    "className" !== c && (s[c] = i[c]);
            return {
        ...
        function e(o, r) {
            return "function" == typeof o && (o = o(Ae, Le)),
            "string" == typeof o && "=" === o.charAt(1) ? parseInt(o.charAt(0) + "1", 10) * parseFloat(o.substr(2)) : parseFloat(o) - parseFloat(r) || 0
        }
        function k(o, r) {
            return "function" == typeof o && (o = o(Ae, Le)),
        ...
        function o(d, u, e, i) {
            var r, c, h, p, m;
            return "function" == typeof d && (d = d(Ae, Le)),
            1e-6 > (p = null == d ? u : "number" == typeof d ? d : (r = 360,
            c = d.split("_"),
            h = ((m = "=" === d.charAt(1)) ? parseInt(d.charAt(0) + "1", 10) * parseFloat(c[0].substr(2)) : parseFloat(c[0])) * (-1 === d.indexOf("rad") ? 1 : Q) - (m ? 0 : u),
            c.length && (i && (i[e] = u + h),
            -1 !== d.indexOf("short") && (h %= r) !== h % 180 && (h = 0 > h ? h + r : h - r),
            -1 !== d.indexOf("_cw") && 0 > h ? h = (h + 3599999999640) % r - (0 | h / r) * r : -1 !== d.indexOf("ccw") && 0 < h && (h = (h - 3599999999640) % r - (0 | h / r) * r)),
            u + h)) && -1e-6 < p && (p = 0),
            p
        }
        function v(o, r, e) {
            return 0 | 255 * (1 > 6 * (o = 0 > o ? o + 1 : 1 < o ? o - 1 : o) ? r + 6 * ((e - r) * o) : .5 > o ? e : 2 > 3 * o ? r + 6 * ((e - r) * (2 / 3 - o)) : r) + .5
        }
        function _(l, t) {
            for (var e = l.match(Se) || [], s = 0, d = e.length ? "" : l, u = 0, c, h; u < e.length; u++)
                c = e[u],
                s += (h = l.substr(s, l.indexOf(c, s) - s)).length + c.length,
                3 === (c = Ce(c, t)).length && c.push(1),
                d += h + (t ? "hsla(" + c[0] + "," + c[1] + "%," + c[2] + "%," + c[3] : "rgba(" + c.join(",")) + ")";
            return d + l.substr(s)
        }
        function r(r, t, s, n) {
            if (null == r)
                ...
                ;
            var a = t ? (r.match(Se) || [""])[0] : "", l = r.split(a).join("").match(X) || [], d = r.substr(0, r.indexOf(l[0])), h = ")" === r.charAt(r.length - 1) ? ")" : "", u = -1 === r.indexOf(" ") ? "," : " ", p = l.length, m = 0 < p ? l[0].replace(ue, "") : "", e;
            return p ? e = t ? function(o) {
                var c, g, b, _;
                if ("number" == typeof o)
                    o += m;
                else if (n && Z.test(o)) {
                    for (_ = o.replace(Z, "|").split("|"),
                    b = 0; b < _.length; b++)
                        _[b] = e(_[b]);
                    return _.join(",")
                }
                if (c = (o.match(Se) || [a])[0],
                b = (g = o.split(c).join("").match(X) || []).length,
                p > b--)
                    for (; ++b < p; )
                        g[b] = s ? g[0 | (b - 1) / 2] : l[b];
            ...
            : function(o) {
                ...
                if ("number" == typeof o)
                    ...
                    for (c = o.replace(Z, "|").split("|"),
                    g = 0; g < c.length; g++)
                        c[g] = e(c[g]);
                    return c.join(",")
                }
                if (g = (a = o.match(X) || []).length,
                p > g--)
                    for (; ++g < p; )
                        a[g] = s ? a[0 | (g - 1) / 2] : l[g];
                return d + a.join(u) + h
        ...
        function q(o, t, e) {
            var n = he.createElementNS("http://www.w3.org/2000/svg", o), s;
            for (s in e)
                n.setAttributeNS(null, s.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(), e[s]);
            return t.appendChild(n),
            n
        }
        function $(b, t, O, i, r, s) {
            var n = b._fwdTransform, D = et(b, !0), w, T, C, S, I, P, H, k, B, L, A, M, E, W;
            n && (E = n.xOrigin,
            W = n.yOrigin),
            (!i || 2 > (w = i.split(" ")).length) && (H = b.getBBox(),
            w = [(-1 === (t = we(t).split(" "))[0].indexOf("%") ? parseFloat(t[0]) : parseFloat(t[0]) / 100 * H.width) + H.x, (-1 === t[1].indexOf("%") ? parseFloat(t[1]) : parseFloat(t[1]) / 100 * H.height) + H.y]),
            O.xOrigin = S = parseFloat(w[0]),
            O.yOrigin = I = parseFloat(w[1]),
            i && D !== Je && (P = D[0],
            H = D[1],
            k = D[2],
            B = D[3],
            L = D[4],
            T = S * (B / (M = P * B - H * k)) + I * (-k / M) + (k * (A = D[5]) - B * L) / M,
            C = S * (-H / M) + I * (P / M) - (P * A - H * L) / M,
            S = O.xOrigin = w[0] = T,
            I = O.yOrigin = w[1] = C),
            n && (s && (O.xOffset = n.xOffset,
            O.yOffset = n.yOffset,
            n = O),
            r || !1 !== r && !1 !== ne.defaultSmoothOrigin ? (T = S - E,
            C = I - W,
            n.xOffset += T * D[0] + C * D[2] - T,
            n.yOffset += T * D[1] + C * D[3] - C) : n.xOffset = n.yOffset = 0),
            s || b.setAttribute("data-svg-origin", w.join(" "))
        }
        function ee(a) {
            var t = this.data, r = -t.rotation * U, s = r + t.skewX * U, n = (0 | Math.cos(r) * t.scaleX * 100000) / 100000, o = (0 | Math.sin(r) * t.scaleX * 100000) / 100000, O = (0 | Math.sin(s) * -t.scaleY * 100000) / 100000, D = (0 | Math.cos(s) * t.scaleY * 100000) / 100000, f = this.t.style, u = this.t.currentStyle, p, C;
            if (u) {
                C = o,
                o = -O,
                O = -C,
                ...
                if (null != t.ox && (H += (T = (t.oxp ? .01 * (S * t.ox) : t.ox) - S / 2) - (T * n + (L = (t.oyp ? .01 * (_ * t.oy) : t.oy) - _ / 2) * o),
                k += L - (T * O + L * D)),
                ...
                0 !== a && 1 !== a || 1 == n && 0 === o && 0 === O && 1 == D && (c && -1 === d.indexOf("Dx=0, Dy=0") || I.test(p) && 100 !== parseFloat(RegExp.$1) || -1 === p.indexOf(p.indexOf("Alpha")) && f.removeAttribute("filter")),
                !c) {
                    var B = 8 > Be ? 1 : -1, T = t.ieOffsetX || 0, L = t.ieOffsetY || 0, A, M, E;
                    for (t.ieOffsetX = Math.round((S - ((0 > n ? -n : n) * S + (0 > o ? -o : o) * _)) / 2 + H),
                    t.ieOffsetY = Math.round((_ - ((0 > D ? -D : D) * _ + (0 > O ? -O : O) * S)) / 2 + k),
                    Ne = 0; 4 > Ne; Ne++)
                        E = (C = -1 === (A = u[M = De[Ne]]).indexOf("px") ? Oe(this.t, M, parseFloat(A), A.replace(ce, "")) || 0 : parseFloat(A)) === t[M] ? 2 > Ne ? T - t.ieOffsetX : L - t.ieOffsetY : 2 > Ne ? -t.ieOffsetX : -t.ieOffsetY,
                        f[M] = (t[M] = Math.round(C - E * (0 === Ne || 2 === Ne ? 1 : B))) + "px"
                }
            }
        }
        function te(o) {
            var t = this.t, n = t.filter || fe(this.data, "filter") || "", i = 0 | this.s + this.c * o, s;
            100 == i && (s = -1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (t.removeAttribute("filter"),
            !fe(this.data, "filter")) : (t.filter = n.replace(f, ""),
            !0)),
            s || (this.xn1 && (t.filter = n = n || "alpha(opacity=" + i + ")"),
            -1 === n.indexOf("pacity") ? 0 == i && this.xn1 || (t.filter = n + " alpha(opacity=" + i + ")") : t.filter = n.replace(I, "opacity=" + i))
        }
        function oe(o) {
            if (this.t._fwdClassPT = this,
            1 === o || 0 === o) {
                this.t.setAttribute("class", 0 === o ? this.b : this.e);
                for (var t = this.data, r = this.t.style; t; )
                    t.v ? r[t.p] = t.v : ct(r, t.p),
                    t = t._next;
        ...
        function re(l) {
            if ((1 === l || 0 === l) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var t = this.t.style, a = ie.transform.parse, o, d, u, c, h;
                if ("all" === this.e)
                    c = !(t.cssText = "");
                else
                    for (u = (o = this.e.split(" ").join("").split(",")).length; -1 < --u; )
                        d = o[u],
                        ie[d] && (ie[d].parse === a ? c = !0 : d = "transformOrigin" === d ? Ze : ie[d].p),
                        ct(t, d);
                c && (ct(t, Xe),
                (h = this.t._fwdTransform) && (h.svg && (this.t.removeAttribute("data-svg-origin"),
        ...
        var ne = function() {
            ...
            this.setRatio = ne.prototype.setRatio
        }, W = _fwd_fwdScope.FWDFWD_fwdDefine.globals, ie = {}, h = ne.prototype = new L("css"), m, ae, le, de;
        ...
        var ue = /(?:\-|\.|\b)(\d|\.|e\-)+/g, z = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, X = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, b = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, ce = /(?:\d|\-|\+|=|#|\.)*/g, I = /opacity *= *([^)]*)/i, f = /alpha\(opacity *=.+?\)/i, l = /([A-Z])/g, u = /-([a-z])/gi, N = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, Z = /,(?=[^\)]*(?:\(|$))/gi, U = Math.PI / 180, Q = 180 / Math.PI, G = {}, he = document, K = n("div"), p = n("img"), J = ne._internals = {
            _specialProps: ie
        }, pe = navigator.userAgent, me = (Me = pe.indexOf("Android"),
        Ee = n("a"),
        Pe = -1 !== pe.indexOf("Safari") && -1 === pe.indexOf("Chrome") && (-1 === Me || 3 < +pe.substr(Me + 8, 1)),
        ke = Pe && 6 > +pe.substr(pe.indexOf("Version/") + 8, 1),
        He = -1 !== pe.indexOf("Firefox"),
        (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(pe) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(pe)) && (Be = parseFloat(RegExp.$1)),
        !!Ee && (Ee.style.cssText = "top:1px;opacity:.55;",
        /^0.55/.test(Ee.style.opacity))), ge = "", be = "", _e = he.defaultView ? he.defaultView.getComputedStyle : function() {}
        , fe = ne.getStyle = function(o, t, e, d, r) {
            var s;
            return me || "opacity" !== t ? (!d && o.style[t] ? s = o.style[t] : (e = e || _e(o)) ? s = e[t] || e.getPropertyValue(t) || e.getPropertyValue(t.replace(l, "-$1").toLowerCase()) : o.currentStyle && (s = o.currentStyle[t]),
            null == r || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : r) : a(o)
        }
        , Oe = J.convertToPixels = function(d, t, e, c, r) {
            ...
            if ("auto" === c || !e)
                return 0;
            var s = /(?:Left|Right|Width)/i.test(t), l = d, m = K.style, g = 0 > e, u = 1 === e, p, b, _;
            if (g && (e = -e),
            u && (e *= 100),
            "%" === c && -1 !== t.indexOf("border"))
                p = e / 100 * (s ? d.clientWidth : d.clientHeight);
            else {
                if (m.cssText = "border:0 solid red;position:" + fe(d, "position") + ";line-height:0;",
                "%" !== c && l.appendChild && "v" !== c.charAt(0) && "rem" !== c)
                    m[s ? "borderLeftWidth" : "borderTopWidth"] = e + c;
                else {
                    if (b = (l = d.parentNode || he.body)._fwdCache,
                    _ = V.ticker.frame,
                    b && s && b.time === _)
                        return b.width * e / 100;
                    m[s ? "width" : "height"] = e + c
                }
                l.appendChild(K),
                p = parseFloat(K[s ? "offsetWidth" : "offsetHeight"]),
                l.removeChild(K),
                s && "%" === c && !1 !== ne.cacheWidths && ((b = l._fwdCache = l._fwdCache || {}).time = _,
                b.width = 100 * (p / e)),
        ...
        , ye = J.calculateOffset = function(o, t, e) {
            if ("absolute" !== fe(o, "position", e))
                return 0;
            var n = "left" === t ? "Left" : "Top"
              , r = fe(o, "margin" + n, e);
            return o["offset" + n] - (Oe(o, t, parseFloat(r), r.replace(ce, "")) || 0)
        }
        , ve = {
            width: ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, De = ["marginLeft", "marginRight", "marginTop", "marginBottom"], we = function(o, a) {
            if ("contain" === o || "auto" === o || "auto auto" === o)
                return o + " ";
            null != o && "" !== o || (o = "0 0");
            var e = o.split(" "), l = -1 === o.indexOf("left") ? -1 === o.indexOf("right") ? e[0] : "100%" : "0%", d = -1 === o.indexOf("top") ? -1 === o.indexOf("bottom") ? e[1] : "100%" : "0%", u;
            if (3 < e.length && !a) {
                for (e = o.split(", ").join(",").split(","),
                o = [],
                u = 0; u < e.length; u++)
                    o.push(we(e[u]));
                return o.join(",")
            }
            return null == d ? d = "center" === l ? "50%" : "0" : "center" === d && (d = "50%"),
            ...
            if (!d)
                ...
                e = [d >> 16, 255 & d >> 8, 255 & d];
            else {
                if ("," === d.charAt(d.length - 1) && (d = d.substr(0, d.length - 1)),
                Te[d])
                    e = Te[d];
                else if ("#" === d.charAt(0))
                    4 === d.length && (d = "#" + (m = d.charAt(1)) + m + (g = d.charAt(2)) + g + (b = d.charAt(3)) + b),
                    e = [(d = parseInt(d.substr(1), 16)) >> 16, 255 & d >> 8, 255 & d];
                else if (!("hsl" === d.substr(0, 3)))
                    e = d.match(ue) || Te.transparent;
                else if (!(e = C = d.match(ue),
                c))
                    _ = +e[0] % 360 / 360,
                    O = +e[1] / 100,
                    m = 2 * (y = +e[2] / 100) - (g = .5 >= y ? y * (O + 1) : y + O - y * O),
                    3 < e.length && (e[3] = +d[3]),
                    e[0] = v(_ + 1 / 3, m, g),
                    e[1] = v(_, m, g),
                    e[2] = v(_ - 1 / 3, m, g);
            ...
            return c && !C && (m = e[0] / 255,
            g = e[1] / 255,
            b = e[2] / 255,
            y = ((D = Math.max(m, g, b)) + (w = Math.min(m, g, b))) / 2,
            D === w ? _ = O = 0 : (T = D - w,
            O = .5 < y ? T / (2 - D - w) : T / (D + w),
            _ = D === m ? (g - b) / T + (g < b ? 6 : 0) : D === g ? (b - m) / T + 2 : (m - g) / T + 4,
            _ *= 60),
            e[0] = 0 | _ + .5,
            e[1] = 0 | 100 * O + .5,
            e[2] = 0 | 100 * y + .5),
        ...
        , Se = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b", xe, Ie, Pe, He, ke, Be, Le, Ae, Me, Ee;
        for (h in Te)
            Se += "|" + h + "\\b";
        Se = new RegExp(Se + ")","gi"),
        ne.colorStringFilter = function(o) {
            var t = o[0] + o[1], r;
            Se.test(t) && (r = -1 !== t.indexOf("hsl(") || -1 !== t.indexOf("hsla("),
            o[0] = _(o[0], r),
            o[1] = _(o[1], r)),
            Se.lastIndex = 0
        }
        ...
        J._setPluginRatio = function(d) {
            ...
            for (var t = this.data, a = t.proxy, o = t.firstMPT, u, c, h, p, m; o; )
                u = a[o.v],
                o.r ? u = Math.round(u) : 1e-6 > u && -1e-6 < u && (u = 0),
                o.t[o.p] = u,
                o = o._next;
            if (t.autoRotate && (t.autoRotate.rotation = t.mod ? t.mod(a.rotation, this.t) : a.rotation),
            1 === d || 0 === d)
                for (o = t.firstMPT,
                m = 1 === d ? "e" : "b"; o; ) {
                    if (!(c = o.t).type)
        ...
        var We = function(o, t, e, n, r) {
          ...
          , Re = (J._parseToProxy = function(m, t, e, i, g, s) {
            var n = i, u = {}, p = {}, b = e._transform, c = G, d, _, O, y, v;
            ...
            n._prev && (n._prev._next = null))); i && i !== n; ) {
                if (1 >= i.type && (p[_ = i.p] = i.s + i.c,
                u[_] = i.s,
                s || (y = new We(i,"s",_,y,i.r),
                i.c = 0),
                1 === i.type))
                    for (d = i.l; 0 < --d; )
                        O = "xn" + d,
                        p[_ = i.p + "_" + O] = i.data[O],
                        u[_] = i[O],
                        s || (y = new We(i,O,_,y,i.rxp[O]));
                i = i._next
            }
            return {
                proxy: u,
        ...
        J.CSSPropTween = function(d, t, e, i, r, s, n, a, o, l, u) {
          ...
          , Fe = ne.parseComplex = function(D, t, C, S, I, s, n, H, o, l) {
            ...
            S += "",
            I && Se.test(S + C) && (S = [C, S],
            ne.colorStringFilter(S),
            C = S[0],
            S = S[1]);
            var h = C.split(", ").join(",").split(" "), B = S.split(", ").join(",").split(" "), L = h.length, A = !1 !== xe, k, M, E, W, R, F, N, V, Y, X, U, G, j;
            for (-1 === S.indexOf(",") && -1 === C.indexOf(",") || (h = h.join(" ").replace(Z, ", ").split(" "),
            B = B.join(" ").replace(Z, ", ").split(" "),
            L = h.length),
            L !== B.length && (L = (h = (s || "").split(" ")).length),
            n.plugin = o,
            n.setRatio = l,
            k = Se.lastIndex = 0; k < L; k++)
                if (W = h[k],
                R = B[k],
                (V = parseFloat(W)) || 0 === V)
                    n.appendXtra("", V, e(R, V), R.replace(z, ""), A && -1 !== R.indexOf("px"), !0);
                else if (I && Se.test(W))
                    G = ")" + ((G = R.indexOf(")") + 1) ? R.substr(G) : ""),
                    j = -1 !== R.indexOf("hsl") && me,
                    W = Ce(W, j),
                    R = Ce(R, j),
                    (Y = 6 < W.length + R.length) && !me && 0 === R[3] ? (n["xs" + n.l] += n.l ? " transparent" : "transparent",
                    n.e = n.e.split(B[k]).join("transparent")) : (me || (Y = !1),
                    j ? n.appendXtra(Y ? "hsla(" : "hsl(", W[0], e(R[0], W[0]), ",", !1, !0).appendXtra("", W[1], e(R[1], W[1]), "%,", !1).appendXtra("", W[2], e(R[2], W[2]), Y ? "%," : "%" + G, !1) : n.appendXtra(Y ? "rgba(" : "rgb(", W[0], R[0] - W[0], ",", !0, !0).appendXtra("", W[1], R[1] - W[1], ",", !0).appendXtra("", W[2], R[2] - W[2], Y ? "," : G, !0),
                    Y && (W = 4 > W.length ? 1 : W[3],
                    n.appendXtra("", W, (4 > R.length ? 1 : R[3]) - W, G, !1))),
                    Se.lastIndex = 0;
                else if (F = W.match(ue)) {
                    if (!(N = R.match(z)) || N.length !== F.length)
                        return n;
                    for (M = E = 0; M < F.length; M++)
                        U = F[M],
                        X = W.indexOf(U, E),
                        n.appendXtra(W.substr(E, X - E), +U, e(N[M], U), "", A && "px" === W.substr(X + U.length, 2), 0 === M),
                        E = X + U.length;
                    n["xs" + n.l] += W.substr(E)
                } else
                    n["xs" + n.l] += n.l || n["xs" + n.l] ? " " + R : R;
            if (-1 !== S.indexOf("=") && n.data) {
                for (G = n.xs0 + n.data.s,
                k = 1; k < n.l; k++)
                    G += n["xs" + k] + n.data["xn" + k];
                n.e = G + n["xs" + k]
            }
            return n.l || (n.type = -1,
            n.xs0 = n.e),
          ...
          , Ne = 9;
        for ((h = Re.prototype).l = h.pr = 0; 0 < --Ne; )
            h["xn" + Ne] = 0,
            h["xs" + Ne] = "";
        h.xs0 = "",
        ...
        h.appendXtra = function(l, t, e, i, r, s) {
            ...
            n.rxp["xn" + a] = r,
            n["xn" + a] = t,
            n.plugin || (n.xfirst = new Re(n,"xn" + a,t,e,n.xfirst || n,0,n.n,r,n.pr),
            n.xfirst.xs0 = 0)) : (n.data = {
                s: t + e
            },
            n.rxp = {},
            n.s = t,
        ...
        var Ve = J._registerComplexSpecialProp = function(o, t, a) {
            ...
            var l = o.split(","), s = t.defaultValue, n;
            for (a = a || [s],
            n = 0; n < l.length; n++)
                t.prefix = 0 === n && t.prefix,
                t.defaultValue = a[n] || s,
                new R(l[n],t)
        }
          , Ye = J._registerPluginProp = function(e) {
            var d;
            ie[e] || (d = e.charAt(0).toUpperCase() + e.substr(1) + "Plugin",
            Ve(e, {
                parser: function(l, t, e, i, r, s, n) {
                    var a = W.com.fwd.plugins[d];
                    return a ? (a._cssRegister(),
                    ie[e].parse(l, t, e, i, r, s, n)) : (E("Error: " + d + " js file not loaded."),
                    r)
                }
            }))
        }
        ...
        (h = R.prototype).parseComplex = function(d, t, c, m, r, s) {
            var n = this.keyword, p, g, b, _, O, y;
            if (this.multi && (Z.test(c) || Z.test(t) ? (g = t.replace(Z, "|").split("|"),
            b = c.replace(Z, "|").split("|")) : n && (g = [t],
            b = [c])),
            b) {
                for (_ = b.length > g.length ? b.length : g.length,
                p = 0; p < _; p++)
                    t = g[p] = g[p] || this.dflt,
                    c = b[p] = b[p] || this.dflt,
        ...
        ,
        ne.useSVGTransformAttr = Pe || He;
        var ze = ["scaleX", "scaleY", "scaleZ", "x", "y", "z", "skewX", "skewY", "rotation", "rotationX", "rotationY", "perspective", "xPercent", "yPercent"], Xe = j("transform"), Ue = ge + "transform", Ze = j("transformOrigin"), Ge = null !== j("perspective"), je = J.Transform = function() {
            this.perspective = parseFloat(ne.defaultTransformPerspective) || 0,
            this.force3D = !1 !== ne.defaultForce3D && Ge && (ne.defaultForce3D || "auto")
        }
        , Ke = window.SVGElement, qe = he.documentElement, Qe = (ut = Be || /Android/i.test(pe) && !window.chrome,
        he.createElementNS && !ut && (it = q("svg", qe),
        lt = (at = q("rect", it, {
            width: 100,
            height: 50,
            x: 100
        ...
        ut), $e = function(e) {
        ...
        }, Je = [1, 0, 0, 1, 0, 0], et = function(d, t) {
            var e = d._fwdTransform || new je, l = d.style, u, c, h, p, m, g;
            if (Xe ? c = fe(d, Ue, null, !0) : d.currentStyle && (c = (c = d.currentStyle.filter.match(/(M11|M12|M21|M22)=[\d\-\.e]+/gi)) && 4 === c.length ? [c[0].substr(4), +c[2].substr(4), +c[1].substr(4), c[3].substr(4), e.x || 0, e.y || 0].join(",") : ""),
            (u = !c || "none" === c || "matrix(1, 0, 0, 1, 0, 0)" === c) && Xe && ((g = "none" === _e(d).display) || !d.parentNode) && (g && (p = l.display,
            l.display = "block"),
            d.parentNode || (m = 1,
            qe.appendChild(d)),
            u = !(c = fe(d, Ue, null, !0)) || "none" === c || "matrix(1, 0, 0, 1, 0, 0)" === c,
            p ? l.display = p : g && ct(l, "display"),
            m && qe.removeChild(d)),
            (e.svg || d.getBBox && $e(d)) && (u && -1 !== (l[Xe] + "").indexOf("matrix") && (c = l[Xe],
            u = 0),
            h = d.getAttribute("transform"),
            u && h && (-1 === h.indexOf("matrix") ? -1 !== h.indexOf("translate") && (c = "matrix(1,0,0,1," + h.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")",
            u = 0) : (c = h,
            u = 0))),
            u)
                return Je;
            ...
            Ne = h.length; -1 < --Ne; )
                p = +h[Ne],
                h[Ne] = (m = p - (p |= 0)) ? (0 | 1e5 * m + (0 > m ? -.5 : .5)) / 1e5 + p : p;
            return t && 6 < h.length ? [h[0], h[1], h[4], h[5], h[12], h[13]] : h
        }, tt = J.getTransform = function(H, t, e, i) {
            if (H._fwdTransform && e && !i)
                return H._fwdTransform;
            var r = e && H._fwdTransform || new je, I = 0 > r.scaleX, B = Ge && (parseFloat(fe(H, Ze, t, !1, "0 0 0").split(" ")[2]) || r.zOrigin) || 0, L = parseFloat(ne.defaultTransformPerspective) || 0, E, W, N, Y, U, Z, G, j, K, q, J, ee, te, oe, re, se, ie, ae, le, de, ue, ce, he, pe, me, ge, be, _e, Oe, ye, ve, De;
            if (r.svg = H.getBBox && $e(H),
            r.svg && ($(H, fe(H, Ze, t, !1, "50% 50%") + "", r, H.getAttribute("data-svg-origin")),
            rt = ne.useSVGTransformAttr || Qe),
            (E = et(H)) !== Je)
                for (W in 16 === E.length ? (G = E[0],
                j = E[1],
                K = E[2],
                q = E[3],
                J = E[4],
                ...
                ue = E[11],
                ce = Math.atan2(te, ie),
                r.zOrigin && (ae = re * (de = -r.zOrigin) - E[12],
                le = se * de - E[13],
                de = ie * de + r.zOrigin - E[14]),
                r.rotationX = ce * Q,
                ce && (he = J * (ge = Math.cos(-ce)) + re * (be = Math.sin(-ce)),
                pe = ee * ge + se * be,
                me = te * ge + ie * be,
                re = J * -be + re * ge,
                se = ee * -be + se * ge,
                ...
                ce = Math.atan2(-K, ie),
                r.rotationY = ce * Q,
                ce && (pe = j * (ge = Math.cos(-ce)) - se * (be = Math.sin(-ce)),
                me = K * ge - ie * be,
                se = j * be + se * ge,
                ie = K * be + ie * ge,
                ue = q * be + ue * ge,
                ...
                ce = Math.atan2(j, G),
                r.rotation = ce * Q,
                ce && (G = G * (ge = Math.cos(-ce)) + J * (be = Math.sin(-ce)),
                pe = j * ge + ee * be,
                ee = j * -be + ee * ge,
                te = K * -be + te * ge,
                j = pe),
                r.rotationX && 359.9 < Math.abs(r.rotationX) + Math.abs(r.rotation) && (r.rotationX = r.rotation = 0,
                r.rotationY = 180 - r.rotationY),
                r.scaleX = (0 | 1e5 * Math.sqrt(G * G + j * j) + .5) / 1e5,
                r.scaleY = (0 | 1e5 * Math.sqrt(ee * ee + se * se) + .5) / 1e5,
                r.scaleZ = (0 | 1e5 * Math.sqrt(te * te + ie * ie) + .5) / 1e5,
                r.rotationX || r.rotationY ? r.skewX = 0 : (r.skewX = J || ee ? Math.atan2(J, ee) * Q + r.rotation : r.skewX || 0,
                90 < Math.abs(r.skewX) && 270 > Math.abs(r.skewX) && (I ? (r.scaleX *= -1,
                r.skewX += 0 >= r.rotation ? 180 : -180,
                r.rotation += 0 >= r.rotation ? 180 : -180) : (r.scaleY *= -1,
                r.skewX += 0 >= r.skewX ? 180 : -180))),
                r.perspective = ue ? 1 / (0 > ue ? -ue : ue) : 0,
                r.x = ae,
                r.y = le,
                r.z = de,
                r.svg && (r.x -= r.xOrigin - (r.xOrigin * G - r.yOrigin * J),
                r.y -= r.yOrigin - (r.yOrigin * j - r.xOrigin * ee))) : Ge && !i && E.length && r.x === E[4] && r.y === E[5] && (r.rotationX || r.rotationY) || (Oe = (_e = 6 <= E.length) ? E[0] : 1,
                ye = E[1] || 0,
                ve = E[2] || 0,
                De = _e ? E[3] : 1,
                r.x = E[4] || 0,
                ...
                90 < Math.abs(Z) && 270 > Math.abs(Z) && (I ? (N *= -1,
                Z += 0 >= U ? 180 : -180,
                U += 0 >= U ? 180 : -180) : (Y *= -1,
                Z += 0 >= Z ? 180 : -180)),
                r.scaleX = N,
                ...
                r.rotation = U,
                r.skewX = Z,
                Ge && (r.rotationX = r.rotationY = r.z = 0,
                r.perspective = L,
                r.scaleZ = 1),
                r.svg && (r.x -= r.xOrigin - (r.xOrigin * Oe + r.yOrigin * ve),
                r.y -= r.yOrigin - (r.xOrigin * ye + r.yOrigin * De))),
                r.zOrigin = B,
                r)
                    2e-5 > r[W] && -2e-5 < r[W] && (r[W] = 0);
            return e && (H._fwdTransform = r).svg && (rt && H.style[Xe] ? V.delayedCall(.001, function() {
                ct(H.style, Xe)
            }) : !rt && H.getAttribute("transform") && V.delayedCall(.001, function() {
                H.removeAttribute("transform")
            })),
            r
        }
        , ot = J.set3DTransformRatio = J.setTransformRatio = function(H) {
            var t = this.data, P = this.t.style, O = t.rotation, B = t.rotationX, L = t.rotationY, S = t.scaleX, E = t.scaleY, W = t.scaleZ, R = t.x, V = t.y, Y = t.z, Z = t.svg, X = t.perspective, G = t.force3D, N, j, K, q, Q, $, J, ee, te, oe, re, se, ne, ie, ae, le, de, ue, ce, he, pe, me, ge;
            if (!((1 !== H && 0 !== H || "auto" !== G || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && G || Y || X || L || B || 1 !== W) || rt && Z || !Ge)
                O || t.skewX || Z ? (O *= U,
                me = t.skewX * U,
                ge = 1e5,
                N = Math.cos(O) * S,
                ...
                j = Math.sin(O - me) * -E,
                Q = Math.cos(O - me) * E,
                me && "simple" === t.skewType && (de = Math.tan(me - t.skewY * U),
                j *= de = Math.sqrt(1 + de * de),
                Q *= de,
                t.skewY && (de = Math.tan(t.skewY * U),
                N *= de = Math.sqrt(1 + de * de),
                q *= de)),
                Z && (R += t.xOrigin - (t.xOrigin * N + t.yOrigin * j) + t.xOffset,
                V += t.yOrigin - (t.xOrigin * q + t.yOrigin * Q) + t.yOffset,
                rt && (t.xPercent || t.yPercent) && (ie = this.t.getBBox(),
                R += .01 * t.xPercent * ie.width,
                V += .01 * t.yPercent * ie.height),
                R < (ie = 1e-6) && -ie < R && (R = 0),
                V < ie && -ie < V && (V = 0)),
                ce = (0 | N * ge) / ge + "," + (0 | q * ge) / ge + "," + (0 | j * ge) / ge + "," + (0 | Q * ge) / ge + "," + R + "," + V + ")",
                Z && rt ? this.t.setAttribute("transform", "matrix(" + ce) : P[Xe] = (t.xPercent || t.yPercent ? "translate(" + t.xPercent + "%," + t.yPercent + "%) matrix(" : "matrix(") + ce) : P[Xe] = (t.xPercent || t.yPercent ? "translate(" + t.xPercent + "%," + t.yPercent + "%) matrix(" : "matrix(") + S + ",0,0," + E + "," + R + "," + V + ")";
            else {
                if (He && (S < (ie = 1e-4) && -ie < S && (S = W = 2e-5),
                E < ie && -ie < E && (E = W = 2e-5),
                !X || t.z || t.rotationX || t.rotationY || (X = 0)),
                O || t.skewX)
                    O *= U,
                    ae = N = Math.cos(O),
                    le = q = Math.sin(O),
                    ...
                    ae = Math.cos(O),
                    le = Math.sin(O),
                    "simple" === t.skewType && (de = Math.tan((t.skewX - t.skewY) * U),
                    ...
                    if (!(L || B || 1 !== W || X || Z))
                        return void (P[Xe] = (t.xPercent || t.yPercent ? "translate(" + t.xPercent + "%," + t.yPercent + "%) translate3d(" : "translate3d(") + R + "px," + V + "px," + Y + "px)" + (1 !== S || 1 !== E ? " scale(" + S + "," + E + ")" : ""));
                    N = Q = 1,
                    j = q = 0
                }
                te = 1,
                ...
                pe = "0",
                (O = L * U) && (ae = Math.cos(O),
                oe = se * (J = -(le = Math.sin(O))),
                K = N * le,
                $ = q * le,
                se *= te = ae,
                N *= ae,
                q *= ae),
                (O = B * U) && (de = j * (ae = Math.cos(O)) + K * (le = Math.sin(O)),
                ue = Q * ae + $ * le,
                ee = te * le,
                re = se * le,
                K = j * -le + K * ae,
                ...
                V < ie && -ie < V && (V = pe),
                Y < ie && -ie < Y && (Y = 0)),
                ce = t.xPercent || t.yPercent ? "translate(" + t.xPercent + "%," + t.yPercent + "%) matrix3d(" : "matrix3d(",
                ce += (N < ie && -ie < N ? pe : N) + he + (q < ie && -ie < q ? pe : q) + he + (J < ie && -ie < J ? pe : J),
                ce += he + (oe < ie && -ie < oe ? pe : oe) + he + (j < ie && -ie < j ? pe : j) + he + (Q < ie && -ie < Q ? pe : Q),
                B || L || 1 !== W ? (ce += he + (ee < ie && -ie < ee ? pe : ee) + he + (re < ie && -ie < re ? pe : re) + he + (K < ie && -ie < K ? pe : K),
                ce += he + ($ < ie && -ie < $ ? pe : $) + he + (te < ie && -ie < te ? pe : te) + he + (se < ie && -ie < se ? pe : se) + he) : ce += ",0,0,0,0,1,0,",
                ce += R + he + V + he + Y + he + (X ? 1 + -Y / X : 1) + ")",
                P[Xe] = ce
            }
        }
        , rt, it, at, lt, ut;
        ...
        Ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(O, t, e, i, r, D, n) {
                if (i._lastParsedTransform === n)
                    return r;
                var a;
                "function" == typeof (i._lastParsedTransform = n)[e] && (a = n[e],
                n[e] = t);
                var T = O._fwdTransform, g = O.style, y = ze.length, C = n, S = {}, w = tt(O, le, !0, C.parseTransform), b = C.transform && ("function" == typeof C.transform ? C.transform(Ae, Le) : C.transform), x, I, H, B, L, M, E, W, R;
                if (i._transform = w,
                b && "string" == typeof b && Xe)
                    (I = K.style)[Xe] = b,
                    I.display = "block",
                    I.position = "absolute",
                    he.body.appendChild(K),
                    x = tt(K, null, !1),
                    w.svg && (M = w.xOrigin,
                    E = w.yOrigin,
                    x.x -= w.xOffset,
                    x.y -= w.yOffset,
                    (C.transformOrigin || C.svgOrigin) && (b = {},
                    $(O, we(C.transformOrigin), b, C.svgOrigin, C.smoothOrigin, !0),
                    M = b.xOrigin,
                    E = b.yOrigin,
                    x.x -= b.xOffset - w.xOffset,
                    x.y -= b.yOffset - w.yOffset),
                    (M || E) && (W = et(K, !0),
                    x.x -= M - (M * W[0] + E * W[2]),
                    x.y -= E - (M * W[1] + E * W[3]))),
                    he.body.removeChild(K),
                    ...
                    null != (L = C.directionalRotation))
                        if ("object" == typeof L)
                            ...
                            C.rotation = L;
                    "string" == typeof C.x && -1 !== C.x.indexOf("%") && (x.x = 0,
                    x.xPercent = k(C.x, w.xPercent)),
                    "string" == typeof C.y && -1 !== C.y.indexOf("%") && (x.y = 0,
                    x.yPercent = k(C.y, w.yPercent)),
                    x.rotation = o("rotation"in C ? C.rotation : "shortRotation"in C ? C.shortRotation + "_short" : "rotationZ"in C ? C.rotationZ : w.rotation - w.skewY, w.rotation - w.skewY, "rotation", S),
                    Ge && (x.rotationX = o("rotationX"in C ? C.rotationX : "shortRotationX"in C ? C.shortRotationX + "_short" : w.rotationX || 0, w.rotationX, "rotationX", S),
                    ...
                    (x.skewY = o(C.skewY, w.skewY)) && (x.skewX += x.skewY,
                    x.rotation += x.skewY)
                }
                for (Ge && null != C.force3D && (w.force3D = C.force3D,
                B = !0),
                w.skewType = C.skewType || w.skewType || ne.defaultSkewType,
                (H = w.force3D || w.z || w.rotationX || w.rotationY || x.z || x.rotationX || x.rotationY || x.perspective) || null == C.scale || (x.scaleZ = 1); -1 < --y; )
                    (1e-6 < (b = x[R = ze[y]] - w[R]) || -1e-6 > b || null != C[R] || null != G[R]) && (B = !0,
                    r = new Re(w,R,w[R],b,r),
                    R in S && (r.e = S[R]),
                    r.xs0 = 0,
                    r.plugin = D,
                    i._overwriteProps.push(r.n));
                return b = C.transformOrigin,
                w.svg && (b || C.svgOrigin) && (M = w.xOffset,
                E = w.yOffset,
                ...
                M === w.xOffset && E === w.yOffset || (r = A(w, "xOffset", T ? M : w.xOffset, w.xOffset, r, "transformOrigin"),
                r = A(w, "yOffset", T ? E : w.yOffset, w.yOffset, r, "transformOrigin")),
                b = rt ? null : "0px 0px"),
                (b || Ge && H && w.zOrigin) && (Xe ? (B = !0,
                R = Ze,
                ...
                r.xs0 = r.e = w.zOrigin) : r.xs0 = r.e = b) : we(b + "", w)),
        ...
        Ve("borderRadius", {
            ...
            parser: function(n, t, O, i, r) {
                t = this.format(t);
                for (var D = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], y = n.style, v = parseFloat(n.offsetWidth), C = parseFloat(n.offsetHeight), w = t.split(" "), T = 0, S, x, I, P, H, k, B, L, A, M, E, W; T < D.length; T++)
                    this.p.indexOf("border") && (D[T] = j(D[T])),
                    -1 !== (I = x = fe(n, D[T], le, !1, "0px")).indexOf(" ") && (I = (x = I.split(" "))[0],
                    x = x[1]),
                    P = S = w[T],
                    H = parseFloat(I),
                    L = I.substr((H + "").length),
                    "" === (B = (A = "=" === P.charAt(1)) ? (k = parseInt(P.charAt(0) + "1", 10),
                    P = P.substr(2),
                    k *= parseFloat(P),
                    P.substr((k + "").length - (0 > k ? 1 : 0)) || "") : (k = parseFloat(P),
                    P.substr((k + "").length))) && (B = ae[O] || L),
                    B !== L && (M = Oe(n, "borderLeft", H, L),
                    E = Oe(n, "borderTop", H, L),
                    x = "%" === B ? (I = 100 * (M / v) + "%",
                    100 * (E / C) + "%") : "em" === B ? (I = M / (W = Oe(n, "borderLeft", 1, "em")) + "em",
                    E / W + "em") : (I = M + "px",
                    E + "px"),
                    A && (P = parseFloat(I) + k + B,
                    S = parseFloat(x) + k + B)),
                    r = Fe(y, D[T], I + " " + x, P + " " + S, !1, "0px", r);
                return r
            },
            prefix: !0,
        ...
        Ve("backgroundPosition", {
            ...
            parser: function(m, t, e, i, r, s) {
                var n = le || _e(m, null), g = this.format((n ? Be ? n.getPropertyValue("background-position-x") + " " + n.getPropertyValue("background-position-y") : n.getPropertyValue("background-position") : m.currentStyle.backgroundPositionX + " " + m.currentStyle.backgroundPositionY) || "0 0"), b = this.format(t), d, _, O, y, v, D;
                if (-1 !== g.indexOf("%") != (-1 !== b.indexOf("%")) && 2 > b.split(",").length && (D = fe(m, "backgroundImage").replace(/(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, "")) && "none" !== D) {
                    for (d = g.split(" "),
                    _ = b.split(" "),
                    p.setAttribute("src", D),
                    O = 2; -1 < --O; )
                        (y = -1 !== (g = d[O]).indexOf("%")) != (-1 !== _[O].indexOf("%")) && (v = 0 === O ? m.offsetWidth - p.width : m.offsetHeight - p.height,
                        d[O] = y ? parseFloat(g) / 100 * v + "px" : 100 * (parseFloat(g) / v) + "%");
                    g = d.join(" ")
                }
        ...
        Ve("clip", {
            ...
            parser: function(d, t, u, i, r, s) {
                var n, c, h;
                return t = 9 > Be ? (c = d.currentStyle,
                h = 8 > Be ? " " : ",",
                n = "rect(" + c.clipTop + h + c.clipRight + h + c.clipBottom + h + c.clipLeft + ")",
                this.format(t).split(",").join(h)) : (n = this.format(fe(d, this.p, le, !1, this.dflt)),
                this.format(t)),
        ...
        Ve("border", {
            ...
            parser: function(d, t, e, i, r, s) {
                var n = fe(d, "borderTopWidth", le, !1, "0px")
                  ...
                  , o = u[0].replace(ce, "");
                return "px" !== o && (n = parseFloat(n) / Oe(d, "borderTopWidth", 1, o) + o),
        ...
        Ve("opacity,alpha,autoAlpha", {
            defaultValue: "1",
            parser: function(d, t, u, i, r, c) {
                var n = parseFloat(fe(d, "opacity", le, !1, "1"))
                  , h = d.style
                  , o = "autoAlpha" === u;
                return "string" == typeof t && "=" === t.charAt(1) && (t = ("-" === t.charAt(0) ? -1 : 1) * parseFloat(t.substr(2)) + n),
                o && 1 === n && "hidden" === fe(d, "visibility", le) && 0 !== t && (n = 0),
                me ? r = new Re(h,"opacity",n,t - n,r) : ((r = new Re(h,"opacity",100 * n,100 * (t - n),r)).xn1 = o ? 1 : 0,
                h.zoom = 1,
                r.type = 2,
                ...
                r.plugin = c,
                r.setRatio = te),
                o && ((r = new Re(h,"visibility",0,0,r,-1,null,!1,0,0 === n ? "hidden" : "inherit",0 === t ? "hidden" : "inherit")).xs0 = "inherit",
                i._overwriteProps.push(r.n),
        ...
        var ct = function(o, t) {
            t && (o.removeProperty ? ("ms" !== t.substr(0, 2) && "webkit" !== t.substr(0, 6) || (t = "-" + t),
            o.removeProperty(t.replace(l, "-$1").toLowerCase())) : o.removeAttribute(t))
        };
        for (Ve("className", {
            parser: function(d, t, e, i, r, c, n) {
                var a = d.getAttribute("class") || "", p = d.style.cssText, b, _, O, v, D;
                if ((r = i._classNamePT = new Re(d,e,0,0,r,2)).setRatio = oe,
                r.pr = -11,
                m = !0,
                r.b = a,
                _ = g(d, le),
                ...
                return (d._fwdClassPT = r).e = "=" === t.charAt(1) ? a.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : "") : t,
        ...
        Ve("clearProps", {
            parser: function(o, t, e, n, r) {
                return (r = new Re(o,e,0,0,r,2)).setRatio = re,
                r.e = t,
                r.pr = -10,
                r.data = n._tween,
                m = !0,
        ...
        h._onInitTween = function(d, t, c, i) {
            ...
            xe = t.autoRound,
            m = !1,
            ae = t.suffixMap || ne.suffixMap,
            le = _e(d, ""),
            de = this._overwriteProps;
            var r = d.style, b, _, O, v, D, w, T, C, S;
            if (Ie && "" === r.zIndex && ("auto" !== (b = fe(d, "zIndex", le)) && "" !== b || this._addLazySet(r, "zIndex", 0)),
            "string" == typeof t && (v = r.cssText,
            b = g(d, le),
            r.cssText = v + ";" + t,
            b = y(d, b, g(d)).difs,
            ...
            this._transformType) {
                ...
                ke && this._addLazySet(r, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (S ? "visible" : "hidden"))) : r.zoom = 1,
                O = _; O && O._next; )
                    O = O._next;
                C = new Re(d,"transform",0,0,null,2),
                this._linkCSSP(C, null, O),
                C.setRatio = Xe ? ot : ee,
                C.data = this._transform || tt(d, le, !0),
                C.tween = c,
                C.pr = -1,
                de.pop()
            }
            if (m) {
                for (; _; ) {
                    ...
                    O = v; O && O.pr > _.pr; )
                        O = O._next;
                    (_._prev = O ? O._prev : D) ? _._prev._next = _ : v = _,
                    (_._next = O) ? O._prev = _ : D = _,
                    _ = w
                }
                this._firstPT = v
            }
        ...
        h.parse = function(d, t, e, m) {
            var r = d.style, c, g, b, O, y, v, D, w, T, C;
            for (c in t)
                "function" == typeof (v = t[c]) && (v = v(Ae, Le)),
                (g = ie[c]) ? e = g.parse(d, v, c, this, e, m, t) : (y = fe(d, c, le) + "",
                T = "string" == typeof v,
                "color" === c || "fill" === c || "stroke" === c || -1 !== c.indexOf("Color") || T && /^(rgb|hsl)/.test(v) ? (T || (v = (3 < (v = Ce(v)).length ? "rgba(" : "rgb(") + v.join(",") + ")"),
                e = Fe(r, c, y, v, !0, "transparent", e, 0, m)) : T && /[\s,\(]/i.test(v) ? e = Fe(r, c, y, v, !0, null, e, 0, m) : (D = (b = parseFloat(y)) || 0 === b ? y.substr((b + "").length) : "",
                "" !== y && "auto" !== y || (D = "width" === c || "height" === c ? (b = function(o, t, e) {
                    if ("svg" === (o.nodeName + "").toLowerCase())
                        return (e || _e(o))[t] || 0;
                    if (o.getBBox && $e(o))
                        return o.getBBox()[t] || 0;
                    var a = parseFloat("width" === t ? o.offsetWidth : o.offsetHeight)
                      , l = ve[t]
                      , s = l.length;
                    for (e = e || _e(o, null); -1 < --s; )
                        a -= parseFloat(fe(o, "padding" + l[s], e, !0)) || 0,
                        a -= parseFloat(fe(o, "border" + l[s] + "Width", e, !0)) || 0;
                    return a
                }(d, c, le),
                "px") : "left" === c || "top" === c ? (b = ye(d, c, le),
                "px") : (b = "opacity" === c ? 1 : 0,
                "")),
                "" === (w = (C = T && "=" === v.charAt(1)) ? (O = parseInt(v.charAt(0) + "1", 10),
                v = v.substr(2),
                O *= parseFloat(v),
                v.replace(ce, "")) : (O = parseFloat(v),
                T ? v.replace(ce, "") : "")) && (w = c in ae ? ae[c] : D),
                v = O || 0 === O ? (C ? O + b : O) + w : t[c],
                D !== w && "" !== w && (O || 0 === O) && b && (b = Oe(d, c, b, D),
                "%" === w ? (b /= Oe(d, c, 100, "%") / 100,
                !0 !== t.strictUnits && (y = b + "%")) : "em" === w || "rem" === w || "vw" === w || "vh" === w ? b /= Oe(d, c, 1, w) : "px" !== w && (O = Oe(d, c, O, w),
                w = "px"),
                C && (!O && 0 !== O || (v = O + b + w))),
                C && (O += b),
                (b || 0 === b) && (O || 0 === O) ? (e = new Re(r,c,b,O - b,e,0,c,!1 !== xe && ("px" === w || "zIndex" === c),0,y,v)).xs0 = w : void 0 !== r[c] && (v || "NaN" != v + "" && null != v) ? (e = new Re(r,c,O || b || 0,0,e,-1,c,!1,0,y,v)).xs0 = "none" !== v || "display" !== c && -1 === c.indexOf("Style") ? v : y : E("invalid " + c + " tween value: " + t[c]))),
                m && e && !e.plugin && (e.plugin = m);
            return e
        }
        ,
        h.setRatio = function(o) {
            var t = this._firstPT, n, a, l;
            if (!(1 !== o || this._tween._time !== this._tween._duration && 0 !== this._tween._time))
                ...
                for (; t; ) {
                    if (!(n = t.c * o + t.s,
                    t.r ? n = Math.round(n) : 1e-6 > n && -1e-6 < n && (n = 0),
                    t.type))
                        t.t[t.p] = n + t.xs0;
                    else if (!(1 === t.type))
                        -1 === t.type ? t.t[t.p] = t.xs0 : t.setRatio && t.setRatio(o);
                    else if (2 === (l = t.l))
                ...
                for (; t; )
                    2 === t.type ? t.setRatio(o) : t.t[t.p] = t.b,
                    t = t._next
        }
        ,
        h._enableTransforms = function(e) {
            this._transform = this._transform || tt(this._target, le, !0),
            this._transformType = this._transform.svg && rt || !e && 3 !== this._transformType ? 2 : 3
        }
        ,
        ...
        h._linkCSSP = function(o, t, e, s) {
            return o && (t && (t._prev = o),
            o._next && (o._next._prev = o._prev),
            o._prev ? o._prev._next = o._next : this._firstPT === o && (this._firstPT = o._next,
            s = !0),
        ...
        h._mod = function(o) {
            for (var t = this._firstPT; t; )
                "function" == typeof o[t.p] && o[t.p] === Math.round && (t.r = 1),
                t = t._next
        }
        ,
        h._kill = function(o) {
            ...
            if (o.autoAlpha || o.alpha) {
                ...
                o)
                    t[a] = o[a];
                t.opacity = 1,
                t.autoAlpha && (t.visibility = 1)
            }
            for (o.className && (n = this._classNamePT) && ((l = n.xfirst) && l._prev ? this._linkCSSP(l._prev, n._next, l._prev._prev) : l === this._firstPT && (this._firstPT = n._next),
            n._next && this._linkCSSP(n._next, n._next._next, l._prev),
            this._classNamePT = null),
            n = this._firstPT; n; )
                n.plugin && n.plugin !== a && n.plugin._kill && (n.plugin._kill(o),
                a = n.plugin),
                n = n._next;
            return L.prototype._kill.call(this, t)
        }
        ;
        var ht = function(o, t, e) {
            var i, l, d, u;
            if (o.slice)
                for (l = o.length; -1 < --l; )
                    ht(o[l], t, e);
            else
                for (l = (i = o.childNodes).length; -1 < --l; )
                    u = (d = i[l]).type,
                    d.style && (t.push(g(d)),
                    e && e.push(d)),
                    (1 === u || 9 === u || 11 === u) && d.childNodes.length && ht(d, t, e)
        };
        return ne.cascadeTo = function(d, c, e) {
            var i = V.to(d, c, e), o = [i], l = [], h = [], m = [], u = V._internals.reservedProps, p, g, b, _;
            for (d = i._targets || i.target,
            ht(d, l, m),
            i.render(c, !0, !0),
            ht(d, h),
            i.render(0, !0, !0),
    ...
    _fwd_fwdScope.FWDFWD_fwdDefine("easing.Back", ["easing.Ease"], function(b) {
        function d(o, t) {
        ...
        function m(o, t, e) {
            this.t = o,
            this.v = t,
            e && (((this.next = e).prev = this).c = e.v - t,
            this.gap = e.t - o)
        }
        function e(o, t) {
        ...
        var i = _fwd_fwdScope.FWDGlobals || _fwd_fwdScope, a = i.com.fwd, o = 2 * Math.PI, l = Math.PI / 2, h = a._class, g = b.register || function() {}
        , u = t("Back", e("BackOut", function(e) {
        ...
        })), p = h("easing.SlowMo", function(o, r, s) {
            r = r || 0 === r ? r : .7,
            null == o ? o = .7 : 1 < o && (o = 1),
            this._p = 1 === o ? 0 : r,
            this._p1 = (1 - o) / 2,
            ...
            this._calcEnd = !0 === s
        }, !0), _ = p.prototype = new b, f, O, y;
        return _.constructor = p,
        _.getRatio = function(o) {
            var r = o + (.5 - o) * this._p;
            return o < this._p1 ? this._calcEnd ? 1 - (o = 1 - o / this._p1) * o : r - (o = 1 - o / this._p1) * o * o * o * r : o > this._p3 ? this._calcEnd ? 1 - (o = (o - this._p3) / this._p1) * o : r + (o - r) * (o = (o - this._p3) / this._p1) * o * o * o : this._calcEnd ? 1 : r
        }
        ,
        p.ease = new p(.7,.7),
        _.config = p.config = function(o, t, e) {
            return new p(o,t,e)
        }
        ,
        (_ = (f = h("easing.SteppedEase", function(e) {
            e = e || 1,
            this._p1 = 1 / e,
            this._p2 = e + 1
        }, !0)).prototype = new b).constructor = f,
        _.getRatio = function(e) {
            return 0 > e ? e = 0 : 1 <= e && (e = .999999999),
            (this._p2 * e >> 0) * this._p1
        }
        ,
        _.config = f.config = function(e) {
            return new f(e)
        }
        ,
        (_ = (O = h("easing.RoughEase", function(g) {
            for (var O = (g = g || {}).taper || "none", o = [], l = 0, y = 0 | (g.points || 20), f = y, v = !1 !== g.randomize, p = !0 === g.clamp, _ = g.template instanceof b ? g.template : null, c = "number" == typeof g.strength ? .4 * g.strength : .4, d, D, w, T, C, S; -1 < --f; )
                d = v ? Math.random() : 1 / y * f,
                D = _ ? _.getRatio(d) : d,
                w = "none" === O ? c : "out" === O ? (T = 1 - d) * T * c : "in" === O ? d * d * c : .5 > d ? .5 * ((T = 2 * d) * T) * c : .5 * ((T = 2 * (1 - d)) * T) * c,
                v ? D += Math.random() * w - .5 * w : f % 2 ? D += .5 * w : D -= .5 * w,
                p && (1 < D ? D = 1 : 0 > D && (D = 0)),
                o[l++] = {
                    x: d,
                    y: D
        ...
        }, !0)).prototype = new b).constructor = O,
        _.getRatio = function(o) {
            var t = this._prev;
            if (o > t.t) {
                for (; t.next && o >= t.t; )
        ...
        ,
        O.ease = new O,
        t("Bounce", d("BounceOut", function(e) {
            return e < 1 / 2.75 ? 7.5625 * e * e : e < 2 / 2.75 ? 7.5625 * (e -= 1.5 / 2.75) * e + .75 : e < 2.5 / 2.75 ? 7.5625 * (e -= 2.25 / 2.75) * e + .9375 : 7.5625 * (e -= 2.625 / 2.75) * e + .984375
        }), d("BounceIn", function(e) {
            return (e = 1 - e) < 1 / 2.75 ? 1 - 7.5625 * e * e : e < 2 / 2.75 ? 1 - (7.5625 * (e -= 1.5 / 2.75) * e + .75) : e < 2.5 / 2.75 ? 1 - (7.5625 * (e -= 2.25 / 2.75) * e + .9375) : 1 - (7.5625 * (e -= 2.625 / 2.75) * e + .984375)
        }), d("BounceInOut", function(o) {
            var r = .5 > o;
            return (o = r ? 1 - 2 * o : 2 * o - 1) < 1 / 2.75 ? o *= 7.5625 * o : o = o < 2 / 2.75 ? 7.5625 * (o -= 1.5 / 2.75) * o + .75 : o < 2.5 / 2.75 ? 7.5625 * (o -= 2.25 / 2.75) * o + .9375 : 7.5625 * (o -= 2.625 / 2.75) * o + .984375,
            r ? .5 * (1 - o) : .5 * o + .5
        })),
        ...
        t("Elastic", (y = function(n, t, a) {
            var i = h("easing." + n, function(r, t) {
                this._p1 = 1 <= r ? r : 1,
                this._p2 = (t || a) / (1 > r ? r : 1),
...
function(ee, _) {
    ...
    if (!d.FWDTweenLite) {
        var m = function(o) {
            for (var t = o.split("."), e = d, s = 0; s < t.length; s++)
                e[t[s]] = e = e[t[s]] || {};
            return e
        }, y = m("com.fwd"), te = 1e-10, u = function(o) {
            for (var t = [], e = o.length, s = 0; s !== e; t.push(o[s++]))
                ;
            return t
        }, v = function() {}, oe = (s = Object.prototype.toString,
        x = s.call([]),
        function(e) {
            return null != e && (e instanceof Array || "object" == typeof e && !!e.push && s.call(e) === x)
        }
        ), r = {}, l = function(e, s, h, t) {
            this.sc = r[e] ? r[e].sc : [],
            (r[e] = this).gsClass = null,
            this.func = h;
            var u = [];
            this.check = function(p) {
                for (var g = s.length, b = g, f, O, y, v, D; -1 < --g; )
                    (f = r[s[g]] || new l(s[g],[])).gsClass ? (u[g] = f.gsClass,
                    b--) : p && f.sc.push(this);
                if (0 === b && h) {
                    if (y = (O = ("com.fwd." + e).split(".")).pop(),
                    v = m(O.join("."))[y] = this.gsClass = h.apply(h, u),
                    t)
                        if (d[y] = c[y] = v,
                        !(D = "undefined" != typeof fwd_module && fwd_module.exports) && "function" == typeof define && define.amd)
                            define((ee.FWDAMDPath ? ee.FWDAMDPath + "/" : "") + e.split(".").pop(), [], function() {
                                return v
                            });
                        else if (D)
                            if (e === _)
                                for (g in fwd_module.exports = c[_] = v,
                                c)
                                    v[g] = c[g];
                            else
                                c[_] && (c[_][y] = v);
        ...
        , p, s, x;
        w.globals = d;
        var re = [0, 0, 1, 1], se = T("easing.Ease", function(o, t, e, s) {
            this._func = o,
            this._type = e || 0,
            this._power = s || 0,
            this._params = t ? re.concat(t) : re
        }, !0), b = se.map = {}, n = se.register = function(d, t, e, i) {
            for (var r = t.split(","), l = r.length, u = (e || "easeIn,easeOut,easeInOut").split(","), c, p, m, g; -1 < --l; )
                for (p = r[l],
                c = i ? T("easing." + p, null, !0) : y.easing[p] || {},
                m = u.length; -1 < --m; )
                    g = u[m],
                    b[p + "." + g] = b[g + p] = c[g] = d.getRatio ? d : d[g] || new d
        }
        , a;
        for ((a = se.prototype)._calcEnd = !1,
        a.getRatio = function(o) {
            if (this._func)
                return this._params[0] = o,
                this._func.apply(null, this._params);
            var t = this._type
              , e = this._power
              , s = 1 === t ? 1 - o : 2 === t ? o : .5 > o ? 2 * o : 2 * (1 - o);
            return 1 === e ? s *= s : 2 === e ? s *= s * s : 3 === e ? s *= s * s * s : 4 === e && (s *= s * s * s * s),
            1 === t ? 1 - s : 2 === t ? s : .5 > o ? s / 2 : 1 - s / 2
        }
        ,
        ae = (le = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; -1 < --ae; )
            a = le[ae] + ",Power" + ae,
            n(new se(null,null,1,ae), a, "easeOut", !0),
            n(new se(null,null,2,ae), a, "easeIn" + (0 === ae ? ",easeNone" : "")),
            n(new se(null,null,3,ae), a, "easeInOut");
        b.linear = y.easing.Linear.easeIn,
        b.swing = y.easing.Quad.easeInOut;
        ...
        (a = P.prototype).addEventListener = function(d, t, e, i, r) {
            r = r || 0;
            var u = this._listeners[d], c = 0, h, m;
            for (this !== f || p || f.wake(),
            null == u && (this._listeners[d] = u = []),
            m = u.length; -1 < --m; )
                (h = u[m]).c === t && h.s === e ? u.splice(m, 1) : 0 === c && h.pr < r && (c = m + 1);
            u.splice(c, 0, {
                c: t,
                s: e,
                up: i,
        ...
        a.removeEventListener = function(o, t) {
            var e = this._listeners[o], r;
            if (e)
                for (r = e.length; -1 < --r; )
                    if (e[r].c === t)
                        return void e.splice(r, 1)
        }
        ,
        a.dispatchEvent = function(o) {
            var t = this._listeners[o], n, a, l;
            if (t)
                for (1 < (n = t.length) && (t = t.slice(0)),
                a = this._eventTarget; -1 < --n; )
                    (l = t[n]) && (l.up ? l.c.call(l.s || a, {
                        type: o,
                        target: a
                    }) : l.c.call(l.s || a))
        }
        ;
        for (var O = ee.requestAnimationFrame, ne = ee.cancelAnimationFrame, ie = Date.now || function() {
            return new Date().getTime()
        }
        , S = ie(), ae = (le = ["ms", "moz", "webkit", "o"]).length, le; -1 < --ae && !O; )
            O = ee[le[ae] + "RequestAnimationFrame"],
            ne = ee[le[ae] + "CancelAnimationFrame"] || ee[le[ae] + "CancelRequestAnimationFrame"];
        T("Ticker", function(r, t) {
            var d = this, c = ie(), e = !1 !== t && O && "auto", h = 500, m = 33, g = function(o) {
                var t = ie() - S, r, s;
                h < t && (c += t - m),
                S += t,
                d.time = (S - c) / 1e3,
            ...
            ,
            d.wake = function(o) {
                null === y ? o ? c += -S + (S = ie()) : 10 < d.frame && (S = ie() - h + 5) : d.sleep(),
                _ = 0 === b ? v : e && O ? O : function(e) {
            ...
            ,
            d.fps = function(e) {
                return arguments.length ? void (D = 1 / ((b = e) || 60),
                w = this.time + D,
                d.wake()) : b
            }
            ,
            d.useRAF = function(o) {
                return arguments.length ? void (d.sleep(),
                e = o,
                d.fps(b)) : e
            }
            ,
        ...
        var de = T("core.FWDAnimation", function(o, t) {
            ...
            U && (p || f.wake(),
            (r = this.vars.useFrames ? Z : U).add(this, r._time),
        ...
        a.reverse = function(o, t) {
            return null != o && this.seek(o || this.totalDuration(), t),
        ...
        ,
        a.isActive = function() {
            var o = this._timeline, e = this._startTime, r;
        ...
        ,
        a.kill = function(o, t) {
            return this._kill(o, t),
            this
        }
        ,
        a._uncache = function(o) {
            for (var t = o ? this : this.timeline; t; )
                t._dirty = !0,
                t = t.timeline;
            return this
        }
        ...
        a._swapSelfInParams = function(o) {
            for (var t = o.length, r = o.concat(); -1 < --t; )
                "{self}" === o[t] && (r[t] = this);
            return r
        }
        ,
        ...
        a.eventCallback = function(o, t, e, n) {
            if ("on" === (o || "").substr(0, 2)) {
                ...
                if (1 === arguments.length)
                    return r[o];
                null == t ? delete r[o] : (r[o] = t,
                r[o + "Params"] = oe(e) && -1 !== e.join("").indexOf("{self}") ? this._swapSelfInParams(e) : e,
                r[o + "Scope"] = n),
        ...
        a.time = function(o, t) {
            return arguments.length ? (this._dirty && this.totalDuration(),
            this.totalTime(o > this._duration ? this._duration : o, t)) : this._time
        }
        ,
        a.totalTime = function(o, n, e) {
            ...
            if (this._timeline) {
                if (0 > o && !e && (o += this.totalDuration()),
                this._timeline.smoothChildTiming) {
                    this._dirty && this.totalDuration();
                    var i = this._totalDuration
                      , r = this._timeline;
                    if (i < o && !e && (o = i),
                    this._startTime = (this._paused ? this._pauseTime : r._time) - (this._reversed ? i - o : o) / this._timeScale,
                ...
                this._totalTime === o && 0 !== this._duration || (z.length && he(),
                this.render(o, n, !1),
                z.length && he())
            }
            return this
        ...
        a.timeScale = function(o) {
            return arguments.length ? (o = o || te,
            this._timeline && this._timeline.smoothChildTiming && (s = (r = this._pauseTime) || 0 === r ? r : this._timeline.totalTime(),
            this._startTime = s - (s - this._startTime) * this._timeScale / o),
            this._timeScale = o,
        ...
        a.paused = function(o) {
            if (!arguments.length)
                return this._paused;
            var t = this._timeline, r, s;
            return o != this._paused && t && (p || o || f.wake(),
            s = (r = t.rawTime()) - this._pauseTime,
            !o && t.smoothChildTiming && (this._startTime += s,
            this._uncache(!1)),
            this._pauseTime = o ? r : null,
            this._paused = o,
            this._active = this.isActive(),
            !o && 0 != s && this._initted && this.duration() && (r = t.smoothChildTiming ? this._totalTime : (r - this._startTime) / this._timeScale,
            this.render(r, r === this._totalTime, !0))),
        ...
        a._sortChildren = !1,
        a.add = a.insert = function(o, t) {
            var e, r;
            if (o._startTime = +(t || 0) + o._delay,
            ...
            e = this._last,
            this._sortChildren)
                for (r = o._startTime; e && e._startTime > r; )
                    e = e._prev;
            return e ? (o._next = e._next,
            e._next = o) : (o._next = this._first,
            this._first = o),
        ...
        a._remove = function(o, t) {
            return o.timeline === this && (t || o._enabled(!1, !0),
        ...
        a.render = function(o, t, e) {
            ...
            for (this._totalTime = this._time = this._rawPrevTime = o; n; )
                i = n._next,
                (n._active || o >= n._startTime && !n._paused) && (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (o - n._startTime) * n._timeScale, t, e) : n.render((o - n._startTime) * n._timeScale, t, e)),
                n = i
        }
        ,
        a.rawTime = function() {
        ...
        ;
        var F = T("FWDTweenLite", function(l, d, e) {
            if (de.call(this, d, e),
            this.render = F.prototype.render,
            null == l)
                throw "Cannot tween a null target.";
            this.target = l = "string" == typeof l && F.selector(l) || l;
            var i = l.jquery || l.length && l !== ee && l[0] && (l[0] === ee || l[0].nodeType && l[0].style && !l.nodeType), a = this.vars.overwrite, c, h, p;
            if (this._overwrite = a = null == a ? q[F.defaultOverwrite] : "number" == typeof a ? a >> 0 : q[a],
            (i || l instanceof Array || l.push && oe(l)) && "number" != typeof l[0])
                for (this._targets = p = u(l),
                this._propLookup = [],
                this._siblings = [],
                c = 0; c < p.length; c++)
                    (h = p[c]) ? "string" == typeof h ? "string" == typeof (h = p[c--] = F.selector(h)) && p.splice(c + 1, 1) : h.length && h !== ee && h[0] && (h[0] === ee || h[0].nodeType && h[0].style && !h.nodeType) ? (p.splice(c--, 1),
                    this._targets = p = p.concat(u(h))) : (this._siblings[c] = G(h, this, !1),
                    1 === a && 1 < this._siblings[c].length && K(h, this, null, 1, this._siblings[c])) : p.splice(c--, 1);
            else
                this._propLookup = {},
                this._siblings = G(l, this, !1),
                1 === a && 1 < this._siblings.length && K(l, this, null, 1, this._siblings);
            (this.vars.immediateRender || 0 === d && 0 === this._delay && !1 !== this.vars.immediateRender) && (this._time = -te,
        ...
        var z = []
          ...
          , Y = function(d, m, g, i) {
            var r = [d, m], u = 0, b = "", O = 0, y, v, D, w, T, C, S;
            for (r.start = d,
            g && (g(r),
            d = r[0],
            m = r[1]),
            ...
            w = 0; w < T; w++)
                ...
                S === y[w] || y.length <= w ? b += S : (b && (r.push(b),
                b = ""),
                D = parseFloat(y[w]),
                r.push(D),
                r._firstPT = {
                ...
                u += S.length;
            return (b += m.substr(u)) && r.push(b),
            r.setRatio = N,
            r
        }
          , E = function(d, t, e, i, c, s, n, a, o) {
            "function" == typeof i && (i = i(o || 0, d));
            var l = "get" === e ? d[t] : e, m = typeof d[t], u = "string" == typeof i && "=" === i.charAt(1), p = {
                t: d,
                p: t,
                s: l,
                f: "function" == m,
            ...
            if ("number" != m && ("function" == m && "get" === e && (g = t.indexOf("set") || "function" != typeof d["get" + t.substr(3)] ? t : "get" + t.substr(3),
            p.s = l = n ? d[g](n) : d[g]()),
            "string" == typeof l && (n || isNaN(l)) ? (p.fp = n,
            p = {
          ...
          , $ = 30
          , he = B.lazyRender = function() {
            var o = z.length, r;
            for (X = {}; -1 < --o; )
                (r = z[o]) && !1 !== r._lazy && (r.render(r._lazy[0], r._lazy[1], !0),
                r._lazy = !1);
            z.length = 0
        }
        ;
        ...
        setTimeout(he, 1),
        de._updateRoot = F.render = function() {
            var o, r, s;
            if (z.length && he(),
            U.render((f.time - U._startTime) * U._timeScale, !1, !1),
            Z.render((f.frame - Z._startTime) * Z._timeScale, !1, !1),
            z.length && he(),
            f.frame >= $) {
                for (s in $ = f.frame + (parseInt(F.autoSleep, 10) || 120),
                L) {
                    for (o = (r = L[s].tweens).length; -1 < --o; )
                        r[o]._gc && r.splice(o, 1);
        ...
        var G = function(o, t, e) {
            var i = o._fwdTweenID, a, l;
            if (L[i || (o._fwdTweenID = i = "t" + j++)] || (L[i] = {
                target: o,
                tweens: []
            }),
            t && ((a = L[i].tweens)[l = a.length] = t,
            e))
                for (; -1 < --l; )
                    a[l] === t && a.splice(l, 1);
            return L[i].tweens
          ...
          , H = function(o, t, e, i) {
            var r = o.vars.onOverwrite, l, d;
            return r && (l = r(o, t, e, i)),
            (r = F.onOverwrite) && (d = r(o, t, e, i)),
            !1 !== l && !1 !== d
        }
          , K = function(d, t, e, i, r) {
            ...
            if (1 === i || 4 <= i) {
                ...
                p = 0; p < m; p++)
                    if ((c = r[p]) !== t)
                        c._gc || c._kill(null, d, t) && (s = !0);
                    else if (5 === i)
                        break;
                return s
            }
            for (var g = t._startTime + te, h = [], b = 0, f = 0 === t._duration, p = r.length, O; -1 < --p; )
                (c = r[p]) === t || c._gc || c._paused || (c._timeline === t._timeline ? c._startTime <= g && c._startTime + c.totalDuration() / c._timeScale > g && ((f || !c._initted) && 2e-10 >= g - c._startTime || (h[b++] = c)) : (O = O || J(t, 0, f),
                0 === J(c, O, f) && (h[b++] = c)));
            for (p = b; -1 < --p; )
                if (c = h[p],
                2 === i && c._kill(e, d, t) && (s = !0),
                2 !== i || !c._firstPT && c._initted) {
                    if (2 !== i && !H(c, t))
                        continue;
                    c._enabled(!1, !1) && (s = !0)
                }
        ...
        a._init = function() {
            var d = this.vars, a = this._overwrittenProps, o = this._duration, l = !!d.immediateRender, u = d.ease, c, p, m, g, _, O;
            if (d.startAt) {
                for (g in this._startAt && (this._startAt.render(-1, !0),
                this._startAt.kill()),
                _ = {},
                d.startAt)
                    _[g] = d.startAt[g];
                ...
                _.immediateRender = !0,
                _.lazy = l && !1 !== d.lazy,
                _.startAt = _.delay = null,
                this._startAt = F.to(this.target, 0, _),
                l)
                    if (0 < this._time)
                        this._startAt = null;
                    else if (0 !== o)
                ...
                if (this._startAt)
                    ...
                    for (g in 0 !== this._time && (l = !1),
                    m = {},
                    d)
                        ce[g] && "autoCSS" !== g || (m[g] = d[g]);
                    if (!(m.overwrite = 0,
                    m.data = "isFromStart",
                    m.lazy = l && !1 !== d.lazy,
                    m.immediateRender = l,
                    this._startAt = F.to(this.target, 0, m),
                    l))
                        this._startAt._init(),
            ...
            if (this._ease = u = u ? u instanceof se ? u : "function" == typeof u ? new se(u,d.easeParams) : b[u] || F.defaultEase : F.defaultEase,
            ...
            this._targets)
                ...
                c = 0; c < O; c++)
                    this._initProps(this._targets[c], this._propLookup[c] = {}, this._siblings[c], a ? a[c] : null, c) && (p = !0);
            else
                p = this._initProps(this.target, this._propLookup, this._siblings, a, 0);
            if (p && F._onPluginEvent("_onInitAllProps", this),
        ...
        a._initProps = function(d, t, e, i, r) {
            ...
            if (null == d)
                return !1;
            for (s in X[d._fwdTweenID] && he(),
            this.vars.css || d.style && d !== ee && d.nodeType && W.css && !1 !== this.vars.autoCSS && function(o, t) {
                var e = {}, r;
                for (r in o)
                    ce[r] || r in t && "transform" !== r && "x" !== r && "y" !== r && "width" !== r && "height" !== r && "className" !== r && "border" !== r || !(!W[r] || W[r] && W[r]._autoCSS) || (e[r] = o[r],
                    delete o[r]);
                o.css = e
            }(this.vars, d),
            this.vars)
                if (g = this.vars[s],
                ce[s])
                    g && (g instanceof Array || g.push && oe(g)) && -1 !== g.join("").indexOf("{self}") && (this.vars[s] = g = this._swapSelfInParams(g, this));
                    ...
                    u = p._overwriteProps.length; -1 < --u; )
                    ...
                    t[s] = E.call(this, d, s, "get", g, s, 0, null, this.vars.stringFilter, r);
            return i && this._kill(i, d) ? this._initProps(d, t, e, i, r) : 1 < this._overwrite && this._firstPT && 1 < e.length && K(d, this, t, this._overwrite, e) ? (this._kill(t, d),
            this._initProps(d, t, e, i, r)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (X[d._fwdTweenID] = !0),
            c)
        }
        ,
        a.render = function(d, c, e) {
            var m = this._time, g = this._duration, u = this._rawPrevTime, p, b, _, f, O, y, v;
            if (g - 1e-7 <= d ? (this._totalTime = this._time = g,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1,
            this._reversed || (p = !0,
            b = "onComplete",
            e = e || this._timeline.autoRemoveChildren),
            0 === g && (!this._initted && this.vars.lazy && !e || (this._startTime === this._timeline._duration && (d = 0),
            (0 > u || 0 >= d && -1e-7 <= d || u === te && "isPause" !== this.data) && u !== d && (e = !0,
            te < u && (b = "onReverseComplete")),
            this._rawPrevTime = f = !c || d || u === d ? d : te))) : 1e-7 > d ? (this._totalTime = this._time = 0,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== m || 0 === g && 0 < u) && (b = "onReverseComplete",
            p = this._reversed),
            0 > d && (this._active = !1,
            0 === g && (!this._initted && this.vars.lazy && !e || (0 <= u && (u !== te || "isPause" !== this.data) && (e = !0),
            this._rawPrevTime = f = !c || d || u === d ? d : te))),
            this._initted || (e = !0)) : (this._totalTime = this._time = d,
            this._easeType ? (O = d / g,
            (1 === (y = this._easeType) || 3 === y && .5 <= O) && (O = 1 - O),
            3 === y && (O *= 2),
            1 === (v = this._easePower) ? O *= O : 2 === v ? O *= O * O : 3 === v ? O *= O * O * O : 4 === v && (O *= O * O * O * O),
            this.ratio = 1 === y ? 1 - O : 2 === y ? O : .5 > d / g ? O / 2 : 1 - O / 2) : this.ratio = this._ease.getRatio(d / g)),
            this._time !== m || e) {
                if (!this._initted) {
                    if (this._init(),
                    !this._initted || this._gc)
                        return;
                    if (!e && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration))
                        return this._time = this._totalTime = m,
                        this._rawPrevTime = u,
                        z.push(this),
                        void (this._lazy = [d, c]);
                ...
                0 === m && (this._startAt && (0 <= d ? this._startAt.render(d, c, e) : b = b || "_dummyGS"),
                this.vars.onStart && (0 === this._time && 0 !== g || c || this._callback("onStart"))),
                _ = this._firstPT; _; )
                    _.f ? _.t[_.p](_.c * this.ratio + _.s) : _.t[_.p] = _.c * this.ratio + _.s,
                    _ = _._next;
                this._onUpdate && (0 > d && this._startAt && -1e-4 !== d && this._startAt.render(d, c, e),
                c || (this._time !== m || p || e) && this._callback("onUpdate")),
                b && (this._gc && !e || (0 > d && this._startAt && !this._onUpdate && -1e-4 !== d && this._startAt.render(d, c, e),
                p && (this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                this._active = !1),
        ...
        a._kill = function(d, c, m) {
            if ("all" === d && (d = null),
            null == d && (null == c || c === this.target))
                return this._lazy = !1,
                this._enabled(!1, !1);
            c = "string" == typeof c ? F.selector(c) || c : c || this._targets || this.target;
            var i = m && this._time && m._startTime === this._startTime && this._timeline === m._timeline, p, g, b, _, O, y, v, w, T;
            if ((oe(c) || D(c)) && "number" != typeof c[0])
                for (p = c.length; -1 < --p; )
                    this._kill(d, c[p], m) && (y = !0);
            else {
                if (this._targets) {
                    for (p = this._targets.length; -1 < --p; )
                        if (c === this._targets[p]) {
                            O = this._propLookup[p] || {},
                            this._overwrittenProps = this._overwrittenProps || [],
                            g = this._overwrittenProps[p] = d ? this._overwrittenProps[p] || {} : "all";
                            break
                        }
                } else {
                    if (c !== this.target)
                        return !1;
                    O = this._propLookup,
                    g = this._overwrittenProps = d ? this._overwrittenProps || {} : "all"
                }
                if (O) {
                    if (v = d || O,
                    w = d !== g && "all" !== g && d !== O && ("object" != typeof d || !d._tempKill),
                    m && (F.onOverwrite || this.vars.onOverwrite)) {
                        for (b in v)
                            O[b] && (T = T || []).push(b);
                        if ((T || !d) && !H(this, m, c, T))
                            return !1
                    ...
                    for (b in v)
                        (_ = O[b]) && (i && (_.f ? _.t[_.p](_.s) : _.t[_.p] = _.s,
                        y = !0),
                        _.pg && _.t._kill(v) && (y = !0),
                        _.pg && 0 !== _.t._overwriteProps.length || (_._prev ? _._prev._next = _._next : _ === this._firstPT && (this._firstPT = _._next),
                        _._next && (_._next._prev = _._prev),
        ...
        a.invalidate = function() {
            ...
            this.vars.immediateRender && (this._time = -te,
            this.render(Math.min(0, -this._delay))),
            this
        }
        ,
        a._enabled = function(o, t) {
            if (p || f.wake(),
            o && this._gc) {
                var e = this._targets, r;
                if (e)
                    for (r = e.length; -1 < --r; )
                        this._siblings[r] = G(e[r], this, !0);
                else
                    this._siblings = G(this.target, this, !0)
            }
            return de.prototype._enabled.call(this, o, t),
            this._notifyPluginsOfEnabled && this._firstPT && F._onPluginEvent(o ? "_onEnable" : "_onDisable", this)
        }
        ,
        F.to = function(o, t, e) {
            return new F(o,t,e)
        ...
        F.getTweensOf = function(o, a) {
            if (null == o)
                return [];
            var e, l, d, u;
            if (o = "string" == typeof o && F.selector(o) || o,
            (oe(o) || D(o)) && "number" != typeof o[0]) {
                for (e = o.length,
                l = []; -1 < --e; )
                    l = l.concat(F.getTweensOf(o[e], a));
                for (e = l.length; -1 < --e; )
                    for (u = l[e],
                    d = e; -1 < --d; )
                        u === l[d] && l.splice(e, 1)
            } else
                for (e = (l = G(o).concat()).length; -1 < --e; )
                    (l[e]._gc || a && !l[e].isActive()) && l.splice(e, 1);
            return l
        }
        ,
        F.killTweensOf = F.killDelayedCallsTo = function(o, t, n) {
            "object" == typeof t && (n = t,
            t = !1);
            for (var a = F.getTweensOf(o, t), r = a.length; -1 < --r; )
                a[r]._kill(n, o)
        }
        ;
        var pe = T("plugins.TweenPlugin", function(o, t) {
            this._overwriteProps = (o || "").split(","),
            this._propName = this._overwriteProps[0],
            this._priority = t || 0,
            this._super = pe.prototype
        }, !0);
        if (a = pe.prototype,
        pe.version = "1.19.0",
        pe.API = 2,
        ...
        a.setRatio = N,
        a._kill = function(o) {
            var t = this._overwriteProps, s = this._firstPT, n;
            if (null != o[this._propName])
                this._overwriteProps = [];
            else
                for (n = t.length; -1 < --n; )
                    null != o[t[n]] && t.splice(n, 1);
            for (; s; )
                null != o[s.n] && (s._next && (s._next._prev = s._prev),
        ...
        a._mod = a._roundProps = function(o) {
            for (var t = this._firstPT, r; t; )
                (r = o[this._propName] || null != t.n && o[t.n.split(this._propName + "_").join("")]) && "function" == typeof r && (2 === t.f ? t.t._applyPT.m = r : t.m = r),
                t = t._next
        }
        ,
        F._onPluginEvent = function(l, t) {
            var e = t._firstPT, d, u, c, h, p;
            if ("_onInitAllProps" === l) {
                for (; e; ) {
                    for (p = e._next,
                    u = c; u && u.pr > e.pr; )
                        u = u._next;
                    (e._prev = u ? u._prev : h) ? e._prev._next = e : c = e,
                    (e._next = u) ? u._prev = e : h = e,
                    e = p
                }
                e = t._firstPT = c
            }
        ...
        pe.activate = function(o) {
            for (var t = o.length; -1 < --t; )
                o[t].API === pe.API && (W[new o[t]()._propName] = o[t]);
            return !0
        }
        ,
        w.plugin = function(l) {
            ...
            var t = l.propName, i = l.priority || 0, r = l.overwriteProps, s = {
                init: "_onInitTween",
                set: "setRatio",
                kill: "_kill",
                round: "_mod",
            ...
            }, n = T("plugins." + t.charAt(0).toUpperCase() + t.substr(1) + "Plugin", function() {
                pe.call(this, t, i),
                this._overwriteProps = r || []
            }, !0 === l.fwd_global), a = n.prototype = new pe(t), o;
            for (o in (a.constructor = n).API = l.API,
            s)
                "function" == typeof l[o] && (a[s[o]] = l[o]);
        ...
        le = ee._fwd_fwdQueue) {
            for (ae = 0; ae < le.length; ae++)
                le[ae]();
            for (a in r)
                r[a].func || ee.console.log("FWDAnimation encountered missing dependency: " + a)
        }
        p = !1
    }
